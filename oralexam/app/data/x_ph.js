...
cram:[
 ...
 {n:'01', t:'这张卡的位置',
  ...
  warn:'<b>出处先说清：这本书从头到尾没有定义过 pH，也没有任何一节讲缓冲液</b>（全书 <i>pufr</i> 零命中）。书只是到处在用它。所以下面凡是标<b>「通用知识」</b>的地方，被问出处就直说「这是标准定义，不是这本书上的」。<b>书真正印出来的数，我都标了页码。</b>'},
 ...
 {n:'04', t:'书给的那个范围',
  ...
  note:'p116 原文：<i>Díky hodnotě fyziologického pH (7,0–7,4) je většina aminokyselin i ostatních organických kyselin a jejich derivátů v organismu <b>disociována na anionty</b> (kap. 2.1.2).</i> —— <b>400 dpi 原图核过。</b><br><br><b>这句话是全书讲 pH 最关键的一句</b>，因为它把命名法挂在了 pH 上：succinate 而不是 succinic acid、pyruvate 而不是 pyruvic acid、glutamate 而不是 glutamic acid。<b>他要是问「为什么书里全用 -ate 结尾」，答案就是这一句。</b><span class="pg">p116</span>',
 ...
 {n:'08', t:'书自己的滴定曲线（三个数，原图核过）',
  big:'Obr. 2.1 甘氨酸：<b>pK<sub>A1</sub> = 2,4 · pK<sub>A2</sub> = 9,8 · pI = 6,1</b>',
  ...
  note:'<b>⚠ 这三个数是新查出来的。</b>OCR 读不出图上的标注，所以卡 <code>aa</code> 上把它们标成「数字待核 · 通用值 2.3 / 9.6 / 6.0」。<b>回 400 dpi 原图看过了，书上印的是 2,4 / 9,8 / 6,1</b>，三个数还互相自洽：<code>(2,4 + 9,8) ÷ 2 = 6,1</code>。<br><b>考场上报书上的数</b>，因为老师脑子里是这本书。被问「别的书写 2.3 和 9.6」就说两套数在实验误差范围内，而<b>这本书的三个数自洽</b>。<span class="pg">p023</span><br><br><b>图上还有两条正文没有的信息</b>（LOGIC §16：图注带正文没有的锚点）：<br>① 横轴写的是 <b><i>spotřeba OH⁻, mmol</i></b>（消耗的 OH⁻，0 到 2）——<b>所以这是用碱去滴一个已经完全质子化的甘氨酸</b>，不是相反方向。<br>② <b>pI 那条虚线正好在横轴 1 mmol 处穿过曲线</b>，也就是第一个质子刚放完、第二个还一个没放的那一点。<b>这就是「半当量」这三个字的字面意思。</b>',
  warn:'p023 正文把 –NH₃⁺ 叫 <i>kvartérní amoniová skupina</i>（<b>季铵基</b>）。<b>这是书的笔误，它是伯铵</b>（季铵没有质子可放，根本不会有 pK<sub>a</sub>）。<b>别跟着说 quaternary。</b>说 “the protonated amino group” 最稳。'},
 ...
 {n:'14', t:'书自己印的 pH 最适（一张表 ＋ 两个磷酸酶）',
  big:'Tab. 5.1 把 pH 最适<b>当成酶的一项基本性质</b>列出来，跟出处和专一性并排',
  ...
  tbl:{head:['酶','书写的出处','pH 最适','页'],
   rows:[
    ['<b>pepsin</b>','žaludek（胃）','<b>1,5–2,5</b>','p116 Tab. 5.1'],
    ['<b>trypsin</b>','tenké střevo（小肠）','<b>7,5–8,5</b>','p116 Tab. 5.1'],
    ['<b>α-chymotrypsin</b>','tenké střevo（小肠）','<b>7,8</b>','p116 Tab. 5.1'],
    ['<b>kathepsin B</b>（cathepsin B，组织蛋白酶 B；书归在半胱氨酸蛋白酶、溶酶体那一类）','胃（<i>intracelulárně</i>，细胞内）','<b>5–6</b>','p116 Tab. 5.1'],
    ['<b>papain</b>','papaya（植物）','<b>8</b>','p116 Tab. 5.1'],
    ['<b>碱性磷酸酶</b>','—','<b>7–8</b>','p091'],
    ['<b>酸性磷酸酶</b>','—','<b>5</b>','p091']
   ]},
  note:'<b>整张表 400 dpi 原图核过</b>，列头就写着 <i>pH optimum</i>。<span class="pg">p091 p116</span><br><br><b>p059 顶上还有一张没有编号的图</b>：两条钟形曲线，纵轴 <i>Relativní aktivita</i>、横轴 pH，一条标 <b>Trypsin</b>（横轴 6·8·10，峰在 7 上下），一条标 <b>Pepsin</b>（横轴 2·4·6，峰在 2 上下）。<b>他把这张图摆过来问「这是什么」，答「pH-活性曲线，峰就是 pH 最适」。</b><br><br><b>这张表最值钱的用法，是拿来对付「pH 最适等于工作环境吗」那一刀</b>：<b>pepsin 对上了</b>（胃里就是强酸），<b>papain 对不上</b>（木瓜的酶，最适 8），<b>kathepsin B 也对不上</b>（书写它在胃、细胞内，最适 5–6，那是溶酶体的酸度）。<b>用书的表证书的话，比背结论稳。</b>',
...
segs:[
 ...
 {tag:'段 3 · 稍展开', h:'挑「pH 对蛋白和酶做什么」，因为那是考场上真会问的',
  ...
  note:'第二段最后一句是<b>用书的表打书的话</b>——p116 Tab. 5.1 对 p058 §3.4。<b>这比背结论稳得多。</b>'},
...
{q:'Why do you keep a protein in buffer and not in water?', odd:1,
...
{q:'Why can you smell acetone on the breath of an untreated diabetic?', odd:1,
 ...
 tail:'书 p195 原文有这一整条，包括「aceton je cítit v dechu」（呼气里闻得到丙酮）。<b>acidosa / acidosis</b> ＝ 酸中毒（血 pH 下降），<b>ketosa / ketosis</b> ＝ 酮症（酮体堆积）；书说这种状态持续下去会导致昏迷和死亡。<span class="pg">p195</span>'},

{q:'Why does the stomach need a different protease from the gut?', odd:1,
...
{q:'Why does milk curdle when it goes sour?', odd:1,
...
{q:'Why does a His-tag column let go when you drop the pH?', odd:1,
...
{r:'中', q:'What is a titration, and what is the equivalence point?',
 ...
 cn:'<b>这个词也没人解释过。</b>书画了滴定曲线却没说滴定是什么（p023）。<br><b>图上有一条可以直接引的证据</b>：Obr. 2.1 横轴写的是 <i>spotřeba OH⁻, mmol</i>（消耗的 OH⁻），从 0 到 2。<b>甘氨酸两个可解离基团 → 两个当量 → 横轴走到 2。</b>而 pI 那条虚线恰好在 1 mmol 处穿过曲线，<b>那就是第一个当量点。</b><span class="pg">p023</span>'},
{r:'中', q:'What does amphoteric mean, and what is a zwitterion?',
 ...
 cn:'<b>zwitterion 卡 <code>aa</code> 已有正面定义</b>，用同一个说法。<b>amphoteric 全套卡里没人解释过</b>，所以就地给。书用的是 <i>obojetný</i> 那一类描述而不是这个词，所以这是通用词汇。'},
...
{r:'高', q:'Does an enzyme’s pH optimum tell you the pH of the compartment where it works?',
 ...
 cn:'<b>用书的表打书的话</b>：结论在 p058 §3.4，反例在 p116 Tab. 5.1。<b>这是 LOGIC §14 那条打法的一个干净例子。</b><br>⚠ 别把这条说反了：书说的是<b>「不一定相同」</b>，不是「一定不同」。<b>pepsin 那一行就是相同的那种。</b><span class="pg">p058 p116</span>'},
...
{r:'中', q:'Why is a protein least soluble at its isoelectric point?',
 ...
 cn:'p038 原文就是这几条：pH、<b>离子强度</b>、<b>溶剂的介电性质</b>（<i>dielektrické vlastnosti</i> ＝ dielectric properties，即溶剂极性有多强，介电常数越大越能把两个电荷屏蔽开）、温度。<b>这条也是「乱不清」的一个典型来源</b>：小分子在 pI 上是「不动」，大分子在 pI 上是「析出」，<b>同一个零净电荷，两种后果</b>。<br><b>它还接着书的另一条：盐析和盐溶</b>（p038，<i>vsolování</i> / <i>vysolování</i>）——那是靠<b>离子强度</b>，不是靠 pH。<b>两条别混：一条调 pH，一条调盐。</b><span class="pg">p038</span>'},
