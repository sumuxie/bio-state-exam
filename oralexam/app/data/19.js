...
cram:[
 ...
 {n:'02', t:'第一刀',
  ez:'“This classification is made by two cuts. The first cut asks one question. Does the inhibitor come off again. It may never come off. Then it is irreversible. It may come off again. Then it is reversible. This is the first cut, not competitive versus non-competitive. The reason is simple. The two kinds are not even described by the same equations. The second cut asks a different question. Which form of the enzyme does the inhibitor bind.”',
...
{r:'中', q:'How were the types of inhibition told apart?',
    ez:'“They were told apart by kinetics, not by chemistry. Two numbers made that possible. Michaelis and Menten gave the rate equation in nineteen thirteen. It has a K m and a V max. Once you can measure both you can ask one question. Which of the two does this inhibitor change? Lineweaver and Burk turned the curve into a straight line in nineteen thirty four. Then the answer is read off where the lines cross. Competitive inhibition leaves V max alone. It raises K m. The lines meet on the vertical axis. Non competitive inhibition leaves K m alone. It lowers V max. The lines meet on the horizontal axis. Uncompetitive inhibition lowers both. The lines stay parallel. So the types were defined by the plot.”',
    ezcn:'⚠ <b>这几类是被<b>动力学</b>分开的，不是被化学分开的。</b><b>靠的是两个数：<b>Michaelis 与 Menten 1913 年</b>给出速率方程，里面有 <b>K<sub>m</sub></b> 和 <b>V<sub>max</sub></b>；一旦这两个量可测，问题就只剩一个——<b>这个抑制剂改的是哪一个</b>。</b><b><b>Lineweaver 与 Burk 1934 年</b>把曲线变成直线，于是答案就从<b>两条线交在哪里</b>读出来。</b><b><b>竞争性</b>：V<sub>max</sub> 不变、K<sub>m</sub> 升高，交在纵轴上。<b>非竞争性</b>：K<sub>m</sub> 不变、V<sub>max</sub> 降低，交在横轴上。<b>反竞争性</b>：两个都降，两条线平行。</b>⚠ <b>所以「类型」是被那张图定义出来的。</b>',
 en:'“They were told apart by kinetics rather than by chemistry, and two numbers made that possible. Michaelis and Menten gave the rate equation in nineteen thirteen, and it contains a K m and a V max. Once both can be measured, there is only one question to ask about an inhibitor, which of the two it changes. Lineweaver and Burk turned the curve into a straight line in nineteen thirty-four, so the answer is read off from where the lines cross. Competitive inhibition leaves V max unchanged and raises K m, and the lines meet on the vertical axis. Non-competitive inhibition leaves K m unchanged and lowers V max, and the lines meet on the horizontal axis. Uncompetitive inhibition lowers both, and the lines stay parallel. So the categories on this card were defined by the plot, and the mechanism was fitted to them afterwards.”',
 cn:'<b>通用知识，标 general。</b>书的年表 <span class="pg">p009</span> 上跟酶有关的两行是 <b>1833 Payen 分离出第一个酶（淀粉酶）</b>和 <b>1893 Ostwald 证明酶是催化剂</b>——被问到「酶这件事什么时候搞清楚的」就报这两行。⚠ <b>这一条直接落回速背里的三张图</b>：说完「哪个数变」再画线，比先画线稳。'},
{r:'中', q:'What is the classic example that showed competitive inhibition?',
    ez:'“The classic pair is malonate and succinate dehydrogenase. Malonate resembles succinate closely. The enzyme binds it. But malonate cannot be dehydrogenated. So it occupies the site and blocks it. Adding more succinate overcomes the block. That is the signature of competition. The same experiment did a second job. It is what proved the citric acid cycle is a cycle. Sulfonamides are the other classic. Sulfanilamide resembles p aminobenzoic acid. Bacteria need that compound to make folate. The drug competitively blocks the enzyme. Humans take folate from food. So the drug is selective.”',
    ezcn:'<b>经典的一对是<b>丙二酸</b>与<b>琥珀酸脱氢酶</b>：丙二酸长得很像琥珀酸，酶会结合它，<b>但它脱不了氢</b>，于是占着位点不走；<b>加大琥珀酸浓度就能把它顶开</b>——这正是竞争的标志。</b>⚠ <b>同一个实验还干了第二件事：<b>它是证明柠檬酸循环是一个「循环」的那个实验</b></b>（见卡 24）。<b>另一个经典是<b>磺胺类</b>：磺胺长得像对氨基苯甲酸（PABA），而细菌要靠 PABA 合成叶酸，药物竞争性地堵住那个酶；人是从食物里拿叶酸的，所以这个药有选择性。</b>',
 en:'“The classic pair is malonate and succinate dehydrogenase. Malonate closely resembles succinate, so the enzyme binds it, but malonate cannot be dehydrogenated, so it occupies the site and blocks it. Raising the succinate concentration overcomes the block, and that is the signature of competition. The same experiment did a second job, because it is what proved that the citric acid cycle really is a cycle. The other classic is the sulfonamides. Sulfanilamide resembles para-aminobenzoic acid, which bacteria need in order to make folate, and the drug competitively blocks the enzyme that uses it. Humans take folate from food instead of making it, so the inhibition is selective. That was one of the first antibacterial drugs whose mechanism was understood rather than found by chance.”',
 cn:'<b>通用知识，标 general。</b>⚠ <b>年份待核，别报</b>：丙二酸抑制琥珀酸脱氢酶一般归到二十年代（Quastel），磺胺与 PABA 的解释归到 1940 年前后（Woods 与 Fildes）——<b>这两个年份本仓库没核过</b>，说人名和机制就够。<b>接口</b>：卡 <b>24</b>「柠檬酸循环」的发现用的就是丙二酸这一手。'},
 ]}
]
});
