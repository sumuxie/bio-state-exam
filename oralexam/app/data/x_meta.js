...
cram:[
 {g:'先看这里 · 这张卡的地图', gn:'⚠ <b>这张卡是全套最大的一张</b>（21 个速背点）。所以第一格不是内容，是<b>目录</b>：先说清它的形状，再告诉你哪一条路在哪一格。<b>不必从头读。</b>'},
 {n:'0', t:'这张卡的形状，以及哪条路在哪一格',
  ez:'“This card has one shape. Acetyl coenzyme A sits in the middle. Going down is breakdown. Four inlets come together on it. Going up is synthesis. Things spread out from it again. Nitrogen does not use that road. It has a road of its own. That is the whole map. The table below says which box holds which pathway. Start from the one you want to say. You do not have to read this card from the top.”',
  ezcn:'⚠ <b>这张卡只有一个形状：中间是 acetyl-CoA。</b><b>往下是分解 —— 四条进口汇聚到它身上；往上是合成 —— 从它发散出去；而氮不走这条路，它自己有一条。</b>⚠ <b>下面那张表说的是「哪一条通路在哪一格」——你想说哪条就从哪条进，这张卡不必从头读。</b>',
  big:'⚠ <b>中间是 acetyl-CoA</b>。往下是<b>分解</b>，四条进口汇聚过来；往上是<b>合成</b>，从它发散出去；<b>氮不走这条路，它自己有一条</b>',
  en:'“This card has one shape and it is worth saying out loud before anything else. Acetyl-CoA sits in the middle. Going down is breakdown, and four inlets converge on it. Going up is synthesis, and things spread out from it again. Nitrogen does not use that road at all, because it has a road of its own. That is the entire map. The table below says which box holds which pathway, so you can start from whichever one you need rather than reading the card from the top.”',
  tbl:{head:['你想说哪一条','它是什么','往哪一格看'],
   rows:[
    ['<b>分解 · 往下汇聚</b>','',''],
    ['书自己的三个阶段','框架','速背 <b>03</b>'],
    ['糖进来（甘油也走这条）','进口一','速背 <b>04</b>'],
    ['脂肪酸进来 · β-氧化','进口二','速背 <b>05</b> · 账在 <b>09 10</b>'],
    ['氨基酸碳骨架进来','进口三','速背 <b>06</b>'],
    ['汇合之后那台引擎','共用','速背 <b>08</b>'],
    ['为什么一克脂肪比一克糖给得多','账','速背 <b>11</b>'],
    ['<b>合成 · 往上发散</b>','',''],
    ['合成不是倒放（总纲）','口令','速背 <b>12</b> · 最干净的例子在 <b>19</b>'],
    ['糖异生','路','速背 <b>16</b> · 在谁身上跑 <b>17</b> · 从氨基酸 <b>18</b>'],
    ['糖原合成 · UDP-葡萄糖','路','速背 <b>19</b>'],
    ['脂肪酸合成的三条差别','路','速背 <b>13</b>'],
    ['氨基酸合成 —— <b>书里没有</b>','缺口','速背 <b>14</b>'],
    ['单向阀 · 脂肪变不成糖','边界','速背 <b>15</b>'],
    ['<b>氮 · 自己走一条路</b>','',''],
    ['氮为什么不走漏斗','分岔','速背 <b>07</b>'],
    ['尿素循环 · 五步两区室两氮源','路','速背 <b>20</b> · 账在 <b>21</b>'],
    ['<b>不在这张卡上的</b>','',''],
    ['磷酸戊糖途径','全链','卡 <b>gly</b> 的追问（带页码）'],
    ['糖原分解 · 生酮 · 酮体分解','各一句定义','本卡追问 <b>「这些通路的名字」</b>'],
   ]},
  note:'⚠ <b>2026-09-23 加的。她说：「我看目前这个代谢卡好乱啊？切入不进去？」——她是对的。</b>这张卡是一层层摞上来的：先是分解漏斗，9/22 把合成焊在尾巴上，当天又把八个名字焊在追问最后。<b>21 个速背点 ＋ 29 条追问，全套最大的一张，而原来没有目录</b>，开口那一组讲的是「为什么存在」，漏斗那一组的标题只盖得住 03–08。<br><br>⚠ <b>那句「中间是 acetyl-CoA，往下汇聚往上发散，氮走自己的路」能盖住全部 21 点</b>——原来那句「四种食物，一个漏斗，一台引擎」盖不住 12 以后的任何一格。<b>被问到这一块，第一句先说这个形状，再挑一格进去。</b>'}, {g:'开口 · 这张卡为什么存在', gn:'这张卡<b>没有对应的考题</b>，所以「它为什么存在」这件事本身要能说出口——因为他一定是<b>顺着别的卡问过来的</b>。'},
 {n:'01', t:'三十道题里没有这一题',
  ez:'“None of the thirty written questions asks about this. None asks how fats are broken down. None asks about proteins or amino acids either. None asks how they are built. So this subject can only reach me as a follow up. It walks out of glycolysis. Or out of the citric acid cycle. Or out of the lipid question. What I need here is not another pathway. I need four sentences. Those four hold the shape of all of it.”',
  ezcn:'<b>三十道卷面题里没有一道问「脂肪、蛋白质、氨基酸怎么分解、怎么合成」。</b><b>所以这块内容只能以追问的形式找上我</b>——<b>它从糖酵解走出来，或者从柠檬酸循环走出来，或者从脂质那道题走出来</b>。<b>我在这里需要的不是又一条通路，而是四句话——四句话就能撑住这一整块的形状。</b>',
 ...
 {n:'02', t:'书也是同一个形状',
  ez:'“The textbook has the same shape as the exam. Protein breakdown gets a whole chapter. Amino acid breakdown is in it too. Lipid synthesis gets one section. Lipid breakdown gets another. But amino acid synthesis is not in this book at all. And the book says so itself. A detailed description goes beyond the scope of these notes. That is the description of how each amino acid is degraded.”',
  ezcn:'<b>书的形状跟考试一样。</b><b>蛋白质分解和氨基酸分解占了一整章</b>；<b>脂质合成和脂质分解各占一节</b>；<b>但氨基酸合成在这本书里根本没有</b>。<b>而且书自己说了：各个氨基酸如何降解的详细描述超出了本讲义的范围。</b>',
 ...
 {g:'合成那一半 · 三条路，各自的账', gn:'2026-09-22 她说：「我之前让你做合成代谢的横向卡，其实就是想让你做这几个」——<b>糖异生 · 磷酸戊糖途径 · 脂肪酸氧化与合成 · 尿素循环</b>。上面 12–15 只说了「合成不是倒放」这个形状，<b>这一组是把路本身摆出来</b>。全部有书页可核。<b>磷酸戊糖途径那条全链在卡 gly 的追问里</b>（<span class="pg">p162 p163</span>），不在这里重说。'},
 {n:'16', t:'糖异生 · 它绕过哪三步，以及为什么必须绕',
  big:'⚠ <b>原则上可以是糖酵解的逆转</b>，但有几步平衡不利——<b>书点名的是丙酮酸激酶那一步，它实际上不可逆</b>。绕行：<b>丙酮酸羧化成草酰乙酸，再磷酸化，而且用 GTP 不用 ATP</b>；末尾两步改成<b>水解</b>，所以<b>不产 ATP</b>',
  en:'“In principle gluconeogenesis could just be glycolysis run backwards, and the textbook says so. For some reactions the equilibrium sits the wrong way. The one it names is pyruvate kinase, where making pyruvate and ATP from phosphoenolpyruvate is practically irreversible. So the resynthesis has to detour through oxaloacetate. Pyruvate is carboxylated to oxaloacetate, and oxaloacetate is phosphorylated much more easily, because forming the enol is easier there. That phosphorylation uses GTP rather than ATP. From phosphoenolpyruvate onwards gluconeogenesis does run as the reverse of glycolysis. The changes come back at the end. Fructose-1,6-bisphosphate is hydrolysed to fructose-6-phosphate and inorganic phosphate, and glucose is formed by hydrolysis of glucose-6-phosphate, again giving inorganic phosphate. Neither of those last two steps gives ATP, which is what the reverse of glycolysis would have required.”',
  note:'<span class="pg">p169</span> §7.9，全部是书上的原话。⚠ <b>跟卡 gly 的接口</b>：那张卡从糖酵解那头说同一件事——「三个不可逆步骤既是控制点，也是糖异生要绕的三处」。<b>这一格是从合成这头说</b>：<b>绕行的办法具体是什么</b>（羧化 → GTP 磷酸化 → 两次水解）。<b>书点名的只有丙酮酸激酶那一步</b>，另外两处它是用「末尾的改变」带过去的。'},
 {n:'17', t:'⚠ 它在谁身上跑 · 书描述了 Cori 循环，却没叫它的名字',
  big:'<b>肌肉缺主要的糖异生酶</b>，所以即使有氧，肌肉里厌氧产生的乳酸也<b>变不回葡萄糖</b>（只能继续被氧化掉）。<b>多余的乳酸经血流到肝，在肝里合成葡萄糖，再由血送回肌肉</b>',
  en:'“The main gluconeogenic enzymes are missing from muscle. So lactate formed there under anaerobic conditions cannot be turned back into glucose in the muscle, even when oxygen returns. Under aerobic conditions it can only be broken down further. The surplus lactate is carried in the bloodstream to the liver instead, and glucose synthesis happens there. The glucose formed can then be transported back to the muscle in the blood. That circuit is usually called the Cori cycle. The textbook describes the whole of it and does not use the name.”',
  note:'<span class="pg">p170</span>。⚠ <b>这一格的形状跟卡 14 的 Avery 那条一样</b>：<b>书把整件事描述完了，只是没叫它的名字</b>。所以说的时候<b>先按书说一遍，再补一句 “that circuit is usually called the Cori cycle”</b>——名字标 general。<b>这也解释了一个很常被追的问题</b>：为什么剧烈运动之后肝在忙。'},
 {n:'18', t:'从氨基酸造糖 · 门槛只有一条',
  big:'<b>很多氨基酸能变成葡萄糖，前提只有一条：它得能给出<b>四碳二羧酸</b>（如天冬氨酸）或<b>丙酮酸</b>（如丙氨酸）。</b>四碳二羧酸作为柠檬酸循环的中间物能转成<b>草酰乙酸</b>，然后跟丙酮酸一样直接进糖异生',
  en:'“Many amino acids can be converted into glucose, and the textbook gives one condition for it. The amino acid has to yield either a four-carbon dicarboxylic acid, such as aspartic acid does, or pyruvate, such as alanine does. The four-carbon dicarboxylic acids are intermediates of the citric acid cycle, so they can pass to oxaloacetate, and oxaloacetate enters gluconeogenesis directly, exactly as pyruvate does. So the question of whether an amino acid is glucogenic is a question about where its carbon skeleton lands.”',
  note:'<span class="pg">p170</span> §7.9.1。⚠ <b>这一格把速背 06 和追问里的「生糖／生酮氨基酸」接上了</b>：<b>「生糖」不是氨基酸的一种性质，是它碳骨架落点的一个后果</b>——落在丙酮酸或四碳二羧酸上就是生糖的，落在 acetyl-CoA 上就不是（那就是速背 15 那个单向阀）。'},
 {n:'19', t:'糖要先被活化才能被接上去 · UDP-葡萄糖',
  big:'<b>分解那头是糖苷酶水解，而且平衡偏向裂解</b>；所以合成不能靠同一个酶倒着来。<b>合成用糖基转移酶，而单糖必须先被活化成高能衍生物</b>：活化基团多半是<b>核苷二磷酸，最常见 UDP</b>（甘露糖用 GDP，唾液酸用 CMP）',
  en:'“Glycosidases hydrolyse a glycosidic bond, and the textbook says the equilibrium of that reaction lies on the side of cleavage. So synthesis cannot simply be the same enzyme run backwards. Biosynthesis of glycosides and oligosaccharides uses glycosyltransferases instead, which do not hydrolyse. Before a sugar residue can be transferred, the monosaccharide has to be activated into a macroergic derivative. The activating group is usually a nucleoside diphosphate, and very often it is uridine diphosphate. For mannose the activating group is guanosine diphosphate, and for sialic acids it is cytidine monophosphate. The activation itself is a sequence. A kinase makes glucose-6-phosphate from glucose and ATP, that rearranges to glucose-1-phosphate, and glucose-1-phosphate then reacts with UTP to give UDP-glucose.”',
  note:'<span class="pg">p170</span> §7.10。⚠ <b>这是速背 12「不是倒放」最干净的一个例子</b>，而且理由是热力学的、不是生物学的：<b>水解那个反应的平衡本来就偏向裂解，所以合成必须自己带能量进来</b>——带能量的方式就是先做成 UDP-糖。<b>接口</b>：糖原的磷酸解与合成（追问里那条「糖原有两种拆法」）走的是同一套。'},
 {n:'20', t:'尿素循环 · 五步、两个区室、两个氮源',
  big:'<b>第一步在<b>线粒体基质</b>里做氨甲酰磷酸</b>（强吸能，由 N-乙酰谷氨酸激活）。<b>① ＋鸟氨酸 → 瓜氨酸</b>（循环的别名从这里来）<b>，瓜氨酸出线粒体进胞质</b>；<b>② ＋天冬氨酸 → 精氨琥珀酸</b>（⚠ <b>天冬氨酸是第二个氮的供体</b>）；<b>③ 裂解酶切下延胡索酸、放出精氨酸</b>；<b>④ 精氨酸酶水解出尿素、再生鸟氨酸</b>，鸟氨酸被运回线粒体',
  en:'“The cycle starts in the mitochondrial matrix. Carbamoyl phosphate synthetase makes carbamoyl phosphate from ammonium, carbon dioxide and two ATP, and the textbook calls that reaction strongly endergonic. The enzyme is activated by N-acetylglutamate, which is itself made in the matrix by acetylating glutamate. Carbamoyl phosphate then enters the cycle by reacting with ornithine, and that is where the alternative name, the ornithine cycle, comes from. The product is citrulline, and citrulline passes out of the mitochondria into the cytoplasm. There it reacts with aspartate to give argininosuccinate, and aspartate is the donor of the second nitrogen atom of the urea. A lyase then splits off fumarate and releases arginine. Arginase closes the cycle by hydrolysing urea off and regenerating ornithine, which is transported back into the mitochondria. The textbook makes one comparison explicitly. Unlike the citric acid cycle, the urea cycle is not located in a single organelle, because part of it is the transport of intermediates across the mitochondrial membrane and back.”',
  note:'<span class="pg">p123 p124</span> §5.2.2，图 5.4。酶的 E.C. 号书上都给了：氨甲酰磷酸合成酶 6.3.4.16 · 鸟氨酸氨甲酰转移酶 2.1.3.3 · 精氨琥珀酸合成酶 6.3.4.5 · 精氨酸酶 3.5.3.1。⚠ <b>「不只在一个细胞器里」这一句是书自己拿来跟柠檬酸循环对照的</b>，被问「这两个循环有什么不同」时先说这一条。<b>接口</b>：切下来的<b>延胡索酸</b>回柠檬酸循环——这是尿素循环和卡 24 之间真正的那根线。'},
 {n:'21', t:'⚠ 账，以及氨的三种处置',
  big:'<b>账：每 1 mol 尿素花 4 mol ATP</b>，其中 2 mol 用在氨甲酰磷酸上。⚠ <b>总式写的是 3 个 ATP</b>：2 NH₄⁺ ＋ HCO₃⁻ ＋ 3 ATP ＋ H₂O → 尿素 ＋ 2 ADP ＋ 4 P<sub>i</sub> ＋ AMP ＋ 2 H⁺——<b>因为 AMP 那一下断了两个高能键，所以「3 个 ATP」和「4 个」说的是同一件事</b>。<b>氨的处置按生物分三类</b>：<b>排氨</b>（水生，鳃直接扩散）· <b>排尿素</b>（陆生，肝里）· <b>排尿酸</b>（鸟和爬行类，溶解度差，以晶体悬液排出）',
  en:'“The textbook gives the cost twice and the two numbers look different. In words it says four moles of ATP are consumed per mole of urea, of which two go into making carbamoyl phosphate. In the summary equation it writes three ATP, because two ammonium ions, hydrogen carbonate, three ATP and water give urea, two ADP, four inorganic phosphates, AMP and two protons. The two statements agree, because the ATP that ends as AMP has lost two high-energy bonds rather than one. So the cycle costs four high-energy bonds per urea. The textbook also sorts organisms by how they get rid of ammonia, which is toxic. Aquatic animals let it diffuse straight out through the gills and are called ammonotelic. Land animals convert it in the liver by this cycle and are ureotelic. Birds and reptiles develop inside a closed egg, and they evolved a different route. They convert ammonia to uric acid, which is poorly soluble and is excreted as a suspension of crystals. Those are the uricotelic organisms.”',
  note:'<span class="pg">p123 p124</span>。⚠ <b>「4 mol ATP」和总式里的「3 ATP」不是笔误，是同一件事的两种数法</b>——<b>被问到就主动说破</b>，这一句本身就是加分。<b>三类名字书上都给了</b>：amonotelní · ureotelní · urikotelní。<b>接口</b>：氨为什么必须被清除——速背 07「氮不走漏斗」那一格；谷氨酰胺合成酶在调节血氨上的有限作用见 <span class="pg">p123</span> 同一页。'},
],

end:'<b>这张卡的用法：</b>他从任何一张代谢卡追过来，先画那个漏斗——<b>四种食物 · 一个 acetyl-CoA · 一台引擎</b>，氮走自己的路变成尿素。<b>画完就把话交回给卡 24 和卡 25</b>，别在路口上多走一步。<br>合成那一半只要三句：<b>不是倒放 · 差别在还原剂和地点 · 氨基酸合成这本书里没有</b>。<br>⚠ <b>2026-09-22 起合成那一半不止三句了</b>：速背 <b>16–21</b> 把路本身摆出来了——<b>糖异生怎么绕（GTP、两次水解）· 肌肉不能而肝能（书描述了 Cori 循环却没叫名字）· 从氨基酸造糖的门槛 · 糖要先做成 UDP-糖 · 尿素循环五步两区室 · 4 个高能键的账</b>。<b>被追到合成这一头，就从「不是倒放」接到这六格里对应的那一格。</b>',
...
{q:'How is fat oxidised?',
  ez:'“A fat is hydrolysed first. Lipases give glycerol and free fatty acids. The glycerol is oxidised to a triose. It then joins carbohydrate metabolism. Each fatty acid is activated to a thioester. Coenzyme A makes that thioester. It costs A T P. Then beta oxidation degrades it. It takes two carbons off the carboxyl end each time. One round gives one acetyl Co A. It also gives one F A D H two and one N A D H.”',
  ezcn:'<b>脂肪先被脂肪酶水解成甘油和游离脂肪酸。</b><b>甘油被氧化成一个丙糖，进碳水化合物代谢。</b><b>每条脂肪酸先花 ATP 活化成跟辅酶 A 的硫酯，然后走 β-氧化：每次从羧基端拿走两个碳（一个乙酰基）；一轮给出一个乙酰-CoA、一个 FADH₂、一个 NADH。</b><b>真核里这发生在线粒体基质。</b><b>从乙酰-CoA 往后就是柠檬酸循环和呼吸链，跟任何别的食物一样。</b>',
...
{q:'How is a fatty acid made?',
  ez:'“It starts from acetyl Co A. The textbook says the process is formally similar to degradation. But it differs in three essential ways. First it begins with a carboxylation. Acetyl Co A becomes malonyl Co A. That uses A T P and the coenzyme biotin. Second the hydrogen donor is N A D P H. Oxidation produced N A D H instead. Third it is separated from degradation in the cell. Degradation is in the mitochondria. Synthesis runs in the cytoplasm.”',
  ezcn:'<b>从乙酰-CoA 开始。</b><b>书说这个过程在形式上跟降解相似，但有三处本质差别：① 它先把乙酰-CoA 羧化成丙二酰-CoA，用 ATP 和辅酶生物素；② 供氢体是 NADPH，而氧化产生的是 NADH；③ 它在细胞里跟降解是分开的——降解在线粒体，合成在胞质里的一个多酶复合体上，每个中间物都一直结合着，只有做完的链才被释放。</b><b>追问总账就给书的框图：8 乙酰-CoA ＋ 7 ATP ＋ 14 NADPH → 棕榈酸。</b>',
...
{q:'How are amino acids broken down?',
  ez:'“The textbook divides it into three stages. The first is a change at the alpha carbon. The amino group is removed there. Transamination onto a two oxo acid does it most often. Oxidative deamination is the other route. The second stage is detoxification of the ammonia. In land animals that means the urea cycle in the liver. The third is degradation of the carbon skeleton. That ends in the citric acid cycle. The first stage is nearly the same for all of them.”',
  ezcn:'<b>书把它分成三个阶段：① α-碳上的变化——把氨基去掉，最常见的是转氨到一个 2-氧代酸上，另一条是氧化脱氨；② 氨的解毒——陆生动物是肝里的尿素循环；③ 碳骨架的降解——最后进柠檬酸循环。</b><b>加一句加分的：第一阶段对几乎所有氨基酸都一样，差别在第二和第三阶段。</b>',
...
{q:'Why does fat give more energy than sugar?',
  ez:'“Because a fatty acid chain is more reduced. It also carries no oxygen of its own. The textbook prints both combustions on one page. Glucose gives minus two thousand eight hundred and seventy kilojoules per mole. Palmitic acid gives minus eleven thousand three hundred and forty. Per gram that is about sixteen against about forty four. But per mole of oxygen they are almost identical. So the cell gets the same out of each oxygen. A fatty acid simply buys more oxygens per gram.”',
  ezcn:'因为<b>脂肪酸链被还原得更彻底，而且自身不带氧</b>。<b>书在同一页上印了两者的完全燃烧：葡萄糖 −2870 kJ/mol，软脂酸 −11340。</b><b>按克算大约是 16 对 44；但按每摩尔消耗的氧算，两者几乎一样（约 480 和 490）——细胞从每一个氧里拿到的一样多，脂肪酸只是每克能买到更多的氧，因为糖的每个碳上已经挂着一个氧了。</b>⚠ <b>按克和按氧的数是从书的两个 ΔG°′ 算出来的，书上没有；食品标签上的 9 和 4 是通用数。</b>',
...
{q:'Where does the nitrogen of an amino acid go?',
  ez:'“It is collected then released then packaged. Transamination moves the amino groups onto one amino acid. That one is usually glutamate. Glutamate dehydrogenase then deaminates it oxidatively. Free ammonia comes off there. Ammonia is toxic. So it has to leave. Aquatic animals let it diffuse out through the gills. Land animals convert it in the liver to urea. Birds and reptiles make uric acid instead. It dissolves badly and leaves as crystals.”',
  ezcn:'<b>三步：集中 → 放出氨 → 打包。</b><b>转氨把各个氨基酸的氨基搬到其中一个身上，通常是谷氨酸；谷氨酸再由谷氨酸脱氢酶氧化脱氨，放出游离的氨。</b><b>氨有毒，必须离开：水生动物让它从鳃扩散出去；陆生动物在肝里通过尿素循环（也叫鸟氨酸循环）转成尿素；鸟类和爬行类做的是尿酸，因为它难溶，以晶体悬液的形式排出。</b><b>三类动物是书自己列的，给全比只说尿素强很多。</b>',
...
{q:'What does the body burn when it is starving?',
  ez:'“Mostly fat. But not only fat. The textbook says acetyl Co A floods the cell in three cases. Diabetes. Starvation. And a fat rich diet. More is made than the citric acid cycle can take. So the excess becomes acetoacetate and acetone. Those are the ketone bodies. At the same time glucose must still come from somewhere. And it cannot come from fatty acids. So it comes from the glucogenic amino acids. That means body protein is broken down too.”',
  ezcn:'<b>主要是脂肪，但不只是脂肪。</b><b>书说在糖尿病、饥饿或高脂饮食时乙酰-CoA 泛滥，产生得比柠檬酸循环能吃下的多，多余的变成乙酰乙酸和丙酮——那就是酮体。</b><b>与此同时葡萄糖还是得有来路，而它不可能来自脂肪酸，所以只能来自生糖氨基酸：书说给饥饿的机体喂这些氨基酸会导致糖异生和糖原生成。</b><b>落点就是那句：所以饿的时候身体也在拆自己的蛋白。</b>',
...
{q:'Why can fat not be turned into glucose in animals?',
  ez:'“Because the step back is missing. The textbook states it plainly. The animal organism cannot convert acetyl Co A into pyruvate. Pyruvate is the starting compound for sugar synthesis. So it cannot make sugars from fats. Two qualifications belong with that. The glycerol of a fat can become glucose. It enters as a triose phosphate. And an odd chain fatty acid leaves propionyl Co A at the end. That is extended to succinyl Co A. So the accurate statement is narrower.”',
  ezcn:'因为<b>回头那一步是缺的</b>。<b>书的原话是：动物机体不能把乙酰-CoA 转成丙酮酸——而丙酮酸才是合成糖的起点，所以不能由脂肪造糖。</b><b>要立刻自己补上两个例外：① 脂肪里的甘油可以变成葡萄糖，因为它以丙糖磷酸的形式进来；② 奇数碳脂肪酸最后剩下丙酰-CoA，它会被延长成琥珀酰-CoA 进入循环。</b><b>所以准确的说法是：脂肪酸的那些碳变不成糖。</b>',
...
{q:'Why does your breath smell of acetone if you eat no carbohydrate?',
  ez:'“Because acetyl Co A is made faster than it can be used. The citric acid cycle cannot take all of it. The textbook gives exactly these conditions. Diabetes. Starvation. Or a diet rich in fat. The excess goes in the liver to H M G Co A. That then becomes acetoacetate. Acetoacetate can be reduced to beta hydroxybutyrate. Or it loses carbon dioxide without an enzyme. That gives acetone. Acetone is volatile. So it is smelled on the breath.”',
  ezcn:'因为<b>乙酰-CoA 产生得比柠檬酸循环能用掉的快</b>。<b>书给的正是这三个场景：糖尿病、饥饿、高脂饮食。</b><b>多余的在肝里变成 HMG-CoA，再变成乙酰乙酸；乙酰乙酸要么被还原成 β-羟丁酸，要么非酶地脱羧变成丙酮——这三个就是酮体。</b><b>丙酮挥发，所以从呼气里闻得到；持续下去会使血变酸。</b>⚠ <b>丙酮那一步书特意写了是「非酶的」，这个细节很好用。</b>', odd:1,
...
{q:'Why do you get fat from eating too much bread?',
  ez:'“Because both sugars and fats come down to acetyl Co A. And the cell’s energy demand may be low. Then acetyl Co A is used mainly for making fatty acids and fat. The textbook puts it directly. With an excess supply of carbohydrate or of fat the nutrients are converted into fat. They are then stored. The traffic is one way. The organism cannot turn acetyl Co A back into pyruvate.”',
  ezcn:'因为<b>糖和脂肪最后都落到乙酰-CoA 上，而当细胞能量需求低时，乙酰-CoA 主要被拿去合成脂肪酸和脂肪</b>。<b>书说得很直接：不论碳水化合物还是脂肪供应过量，这些营养物都被转化成脂肪储存起来。</b><b>而这条路是单行的，因为机体不能把乙酰-CoA 变回丙酮酸。</b><b>同一句话也答了「为什么减肥难」：存进去的路通着，回来的路堵着。</b>', odd:1,
...
{q:'Why do you still need to eat protein if you eat enough of everything else?',
  ez:'“Because protein is not only a fuel. The textbook says something strong here. In heterotrophic cells amino acids are the exclusive source of four things. Nitrogen. Sulfur. Aromatic rings. And branched aliphatic structures. It then draws the conclusion itself. Proteins are an essential component of food. An increased intake of any other nutrient cannot replace them. So what you cannot get elsewhere is not the energy. It is those four things.”',
  ezcn:'因为<b>蛋白不只是燃料</b>。<b>书 p115 开篇说得很硬：在异养生物的细胞里，氨基酸是氮、硫、芳香环和支链脂肪族结构的唯一来源；因此蛋白质是食物中不可缺少的成分，增加任何其他营养物的摄入都替代不了它。</b><b>所以你从别处拿不到的不是能量，是那四样东西。</b><b>（「四样东西」是书自己的说法，比泛泛说「必需氨基酸」具体得多。）</b>', odd:1,
...
{q:'Why do birds not urinate?',
  ez:'“Because they do not make urea. The textbook explains why. Egg laying animals develop in a closed system. That is true of birds and reptiles. So a different way of eliminating ammonia evolved. They convert it to uric acid. Uric acid dissolves badly. So it is excreted as a suspension of crystals. It does not leave in solution. That is the white part of what a bird leaves behind.”',
  ezcn:'因为<b>它们不造尿素</b>。<b>书给的理由是：卵生动物（鸟类和爬行类）的胚胎发育是在一个封闭系统里进行的，所以演化出了另一种排氨方式——把氨转成尿酸。</b><b>尿酸难溶，以晶体悬液而不是溶液的形式排出，那就是鸟粪里白色的那部分。</b><b>（书给的理由是「蛋是个封闭系统」，这是进化那块地基，说出口很稳。）</b>', odd:1,
...
/* ---------------- 追问 ---------------- */
ask:[
 {g:'这些通路的名字，各是什么', gn:'⚠ <b>2026-09-22 她问：「这些额外的代谢途径，我们都有讲吗？至少是一个定义？」</b>查过之后的实情是：<b>内容基本都有，缺的是名字</b> —— glycogenesis · glycogenolysis · ketogenesis · ketolysis 四个词在全套卡上 <b>0 命中</b>，而考官问的时候用的就是名字。这一组把八个名字各给一句定义，<b>全的在哪一格也写在下面</b>。', items:[
{r:'高', q:'What is gluconeogenesis?',
    ez:'“Gluconeogenesis is the resynthesis of glucose. The starting material is mostly lactate. It can also start from amino acids. In principle it is glycolysis run backwards. But three steps of glycolysis are practically irreversible. So those three have to be bypassed. The pyruvate kinase step is the one the textbook names. That one detours through oxaloacetate. It uses G T P and not A T P. The last two steps become hydrolyses. So they give no A T P.”',
    ezcn:'<b>糖异生 ＝ 重新合成葡萄糖</b>，原料主要是乳酸，也可以从氨基酸来。⚠ <b>原则上它是糖酵解的逆转，但糖酵解有三步实际上不可逆，必须绕过去</b>：书点名的是<b>丙酮酸激酶</b>那一步——经<b>草酰乙酸</b>绕行、用 <b>GTP 不用 ATP</b>；末尾两步改成<b>水解</b>，所以不产 ATP。',
 en:'“Gluconeogenesis is the resynthesis of glucose, mostly from lactate and also from amino acids. In principle it is glycolysis run backwards, but three steps of glycolysis are practically irreversible and have to be bypassed. The one the textbook names is the pyruvate kinase step. That step detours through oxaloacetate and uses GTP rather than ATP, and the last two steps become hydrolyses that give no ATP.”',
 cn:'<span class="pg">p169</span> §7.9。<b>全的在速背 16–18</b>，另有 <b>gly</b> 上两条定义式追问。'},
{r:'高', q:'What is glycogenesis?',
    ez:'“Glycogenesis is the synthesis of glycogen from glucose. The glucose cannot be added as it is. It has to be activated first. A kinase makes glucose six phosphate. That rearranges to glucose one phosphate. That reacts with U T P. The product is U D P glucose. A glycosyltransferase then adds the residue to the chain. So the activated sugar is the whole trick. The textbook calls this the biosynthesis of polysaccharides.”',
    ezcn:'<b>糖原合成（glycogenesis）＝ 由葡萄糖合成糖原。</b>⚠ <b>葡萄糖不能直接被接上去，必须先被活化</b>：激酶做出<b>葡糖-6-磷酸</b> → 变位成<b>葡糖-1-磷酸</b> → 与 <b>UTP</b> 反应得到 <b>UDP-葡萄糖</b>；再由<b>糖基转移酶</b>把这个残基接到链上。⚠ <b>「先活化成高能衍生物」就是全部的诀窍。</b>⚠ <b>书里没有 glycogenesis 这个词</b>，它叫「多糖的生物合成」。',
 en:'“Glycogenesis is the synthesis of glycogen from glucose. The glucose cannot simply be added, because it has to be activated first. A kinase makes glucose-6-phosphate, that rearranges to glucose-1-phosphate, and that reacts with UTP to give UDP-glucose. A glycosyltransferase then transfers the residue onto the growing chain. The activated sugar is the whole trick, and the textbook describes this as the biosynthesis of polysaccharides rather than using the word glycogenesis.”',
 cn:'⚠ <b>glycogenesis 这个词全套卡上原本 0 命中</b>（书里也没有，书叫「多糖的生物合成」）。化学在<b>速背 19</b>。<span class="pg">p170 p174</span> §7.10 §7.12。'},
{r:'高', q:'What is glycogenolysis?',
    ez:'“Glycogenolysis is the breakdown of glycogen. ⚠ It happens two different ways. In the digestive tract it is hydrolysis. The amylases do that and give maltose and some glucose. Inside the cell it is not hydrolysis. It is phosphorolysis. Phosphorylase takes a glucose residue off the non reducing end. It hands that residue to phosphoric acid. So the product is glucose one phosphate. That product is already phosphorylated. So the cell saves one A T P.”',
    ezcn:'<b>糖原分解（glycogenolysis）＝ 把糖原拆开。</b>⚠ <b>而它有两种完全不同的拆法，这正是这道题的考点</b>：<b>消化道里是<b>水解</b></b>，由淀粉酶做，产物是麦芽糖和一些游离葡萄糖；<b>细胞内不是水解，是<b>磷酸解</b></b>——<b>磷酸化酶</b>从非还原端取下一个葡萄糖残基、交给磷酸，产物是<b>葡糖-1-磷酸</b>。⚠ <b>产物已经带着磷酸，所以细胞省下了一个 ATP</b>，书说这对细胞在能量上是划算的。',
 en:'“Glycogenolysis is the breakdown of glycogen, and it happens in two different ways depending on where. In the digestive tract it is hydrolysis, carried out by the amylases, and the products are maltose and some free glucose. Inside the cell it is not hydrolysis but phosphorolysis. Phosphorylase takes a glucose residue off the non-reducing end and hands it to phosphoric acid, so the product is glucose-1-phosphate. Because that product is already phosphorylated, the cell saves one ATP, and the textbook says this is energetically favourable for it.”',
 cn:'⚠ <b>glycogenolysis 这个词全套卡上原本 0 命中</b>，但<b>内容有</b>——就是这张卡追问里那条「糖原有两种拆法」。<span class="pg">p172 p173</span> §7.11。'},
{r:'高', q:'What is beta-oxidation?',
    ez:'“Beta oxidation is how a fatty acid is broken down. It runs in the mitochondrial matrix. The fatty acid must be activated first. It becomes a thioester with coenzyme A. Then the same four steps repeat. They are oxidation, hydration, oxidation and thiolysis. Each turn shortens the chain by two carbons. Each turn releases one acetyl coenzyme A. It also gives one F A D H two and one N A D H. The acetyl coenzyme A then enters the citric acid cycle.”',
    ezcn:'<b>β-氧化 ＝ 脂肪酸的分解方式，在线粒体基质里。</b><b>脂肪酸必须先被活化成与辅酶 A 的硫酯。</b><b>然后四步反复循环：<b>氧化 → 水合 → 氧化 → 硫解</b>。</b>⚠ <b>每转一圈链短两个碳，放出一个乙酰辅酶 A，外加一个 FADH₂ 和一个 NADH；乙酰辅酶 A 随后进柠檬酸循环——这就是她说的「脂肪酸给 Krebs 循环供能」。</b>',
 en:'“Beta-oxidation is how a fatty acid is broken down, and it runs in the mitochondrial matrix. The fatty acid has to be activated first into a thioester with coenzyme A. Then the same four steps repeat, oxidation, hydration, oxidation and thiolysis. Each turn shortens the chain by two carbons and releases one acetyl-CoA, together with one FADH2 and one NADH. The acetyl-CoA then enters the citric acid cycle, which is what is meant by saying that fatty acids fuel the Krebs cycle.”',
 cn:'<b>全的在速背 09（一轮的账）和 10（一整条的账）</b>，这张卡的追问里也有一条同名的定义式问题。<span class="pg">p193 p196</span>。'},
{r:'高', q:'What is fatty acid synthesis?',
    ez:'“Fatty acid synthesis builds a fatty acid from acetyl coenzyme A. ⚠ It is not beta oxidation run backwards. The textbook gives three differences. First the acetyl group is carboxylated to malonyl coenzyme A. Degradation never does that step. Second the reducing agent is N A D P H. Degradation oxidises onto N A D plus and F A D. Third the place is different. Degradation is in the mitochondrial matrix. Synthesis is on a multienzyme complex in the cytoplasm. There the intermediates never leave the enzymes.”',
    ezcn:'<b>脂肪酸合成 ＝ 从乙酰辅酶 A 造出一条脂肪酸。</b>⚠ <b>它不是 β-氧化倒着走，书自己列了三条差别</b>：① <b>先把乙酰基羧化成丙二酰辅酶 A</b>（分解这一侧从来没有这一步）；② <b>还原剂是 NADPH</b>，而分解是氧化到 NAD⁺ 和 FAD 上；③ <b>地点不同</b>——分解在线粒体基质，合成在<b>胞质的一个多酶复合体</b>上，中间体全程不离开酶。',
 en:'“Fatty acid synthesis builds a fatty acid from acetyl-CoA, and it is not beta-oxidation run backwards. The textbook gives three differences. The acetyl group is first carboxylated to malonyl-CoA, which degradation never does. The reducing agent is NADPH, whereas degradation oxidises onto NAD-plus and FAD. And the place is different. Degradation is in the mitochondrial matrix, while synthesis happens on a multienzyme complex in the cytoplasm, and there the intermediates never leave the enzymes.”',
 cn:'<b>全的在速背 12（不是倒放）和 13（书自己列的三条差别）</b>，追问里还有一条把两者并排问的。<span class="pg">p220</span>。'},
{r:'高', q:'What is ketogenesis?',
    ez:'“⚠ Ketogenesis is the making of ketone bodies. It is not the making of protein. The liver does it. It happens when acetyl coenzyme A is made too fast. The citric acid cycle cannot use all of it. The textbook lists three conditions. They are diabetes, starvation and a diet rich in fat. The excess goes to beta hydroxy beta methylglutaryl coenzyme A. Part of that becomes acetoacetate. Acetoacetate can be reduced to beta hydroxybutyrate. It can also be decarboxylated to acetone.”',
    ezcn:'⚠ <b>ketogenesis ＝ 生酮作用，就是「造酮体」——<b>不是「蛋白质生成」</b>，这两个千万别说反。</b><b>干这件事的是<b>肝</b>，条件是<b>乙酰辅酶 A 生成得比柠檬酸循环用得掉的还快</b>；书列了三种情形：<b>糖尿病 · 饥饿 · 高脂饮食</b>。</b><b>多出来的走到 <b>β-羟-β-甲基戊二酰辅酶 A（HMG-CoA）</b>，其中一部分变成<b>乙酰乙酸</b>；乙酰乙酸可以被酶促还原成 <b>β-羟丁酸</b>，也可以非酶促脱羧成<b>丙酮</b>。</b>',
 en:'“Ketogenesis is the making of ketone bodies, and not the making of protein. The liver does it, when acetyl-CoA is produced faster than the citric acid cycle can use it. The textbook lists the conditions as diabetes, starvation, or a diet rich in fat. The excess goes to beta-hydroxy-beta-methylglutaryl-CoA, part of that becomes acetoacetate, and acetoacetate can either be reduced enzymatically to beta-hydroxybutyrate or decarboxylated non-enzymatically to acetone.”',
 cn:'⚠ <b>2026-09-22 她把 ketogenesis 写成了「蛋白质生成」——说反了很贵，所以这一条第一句就把它挡住。</b><b>ketogenesis 这个词全套卡上原本 0 命中</b>，但内容有：这张卡追问里的「What are ketone bodies?」。书用的词直译是「酮性物质」。<span class="pg">p195</span>。'},
{r:'高', q:'What is ketolysis?',
    ez:'“⚠ Ketolysis is the other half. It is the using of ketone bodies as fuel. The tissues outside the liver do it. The brain, the heart and muscle are the usual ones. They convert the ketone body back to acetyl coenzyme A. That acetyl coenzyme A goes into the citric acid cycle. The liver itself cannot do this. It lacks the enzyme that transfers the coenzyme A. That is why the liver makes them and does not burn them. This half is general knowledge.”',
    ezcn:'⚠ <b>ketolysis ＝ 另外那一半：把酮体当燃料用掉。</b><b>干这件事的是<b>肝以外</b>的组织（脑、心、肌肉）：它们把酮体转回<b>乙酰辅酶 A</b>，送进柠檬酸循环。</b>⚠ <b>肝自己做不了这一步</b>，因为它缺那个转移辅酶 A 的酶——<b>这正是「肝造酮体却不烧酮体」的原因</b>。⚠ <b>这一半捷克书里没有</b>：书 p195 只讲了酮体怎么生成和随之而来的酸中毒，说的时候标 general。',
 en:'“Ketolysis is the other half, the use of ketone bodies as a fuel. The tissues outside the liver do it, mainly the brain, the heart and muscle. They convert the ketone body back into acetyl-CoA, and that acetyl-CoA enters the citric acid cycle. The liver itself cannot do this, because it lacks the enzyme that transfers the coenzyme A, and that is why the liver makes ketone bodies without burning them. This half is general knowledge and is not in the Czech textbook.”',
 cn:'⚠ <b>这一条是真缺口，不只是缺名字</b>：2026-09-22 查过，<b>ketolysis 这个词和这件事在全套卡上都是 0</b>，而捷克书 <span class="pg">p195</span> 也只写到酮体生成和酸中毒。<b>所以整条标 general。</b>'},
{r:'高', q:'What is the pentose phosphate pathway?',
    ez:'“The pentose phosphate pathway is a cytosolic alternative to glycolysis. It starts from glucose six phosphate. ⚠ It makes N A D P H and ribose five phosphate. It does not make A T P. It has two branches. The oxidative branch does two oxidations and one decarboxylation. N A D P plus is the acceptor in both oxidations. The product is ribulose five phosphate. An isomerase gives ribose five phosphate. The non oxidative branch rearranges two glycolytic intermediates. Transketolase and transaldolase do that. That branch is reversible.”',
    ezcn:'<b>磷酸戊糖途径 ＝ 胞质里糖酵解的一条替代路线，从葡糖-6-磷酸起。</b>⚠ <b>它做的是 <b>NADPH</b> 和<b>核糖-5-磷酸</b>，<b>不做 ATP</b>——这一句是这条通路存在的全部理由。</b><b>两支：<b>氧化支</b>两次氧化加一次脱羧（两次氧化的受体都是 NADP⁺）→ 核酮糖-5-磷酸 → 异构成核糖-5-磷酸；<b>非氧化支</b>用<b>转酮酶和转醛酶</b>重排果糖-6-磷酸和甘油醛-3-磷酸，而且<b>可逆</b>，所以多余的戊糖能流回糖酵解。</b><b>书叫它「通向戊糖磷酸的两条路」。</b>',
 en:'“The pentose phosphate pathway is a cytosolic alternative to glycolysis starting from glucose-6-phosphate. It makes NADPH and ribose-5-phosphate instead of ATP, and that is the whole reason it exists. It has two branches. The oxidative branch runs two oxidations and a decarboxylation, with NADP-plus as the acceptor in both, giving ribulose-5-phosphate, and an isomerase then gives ribose-5-phosphate. The non-oxidative branch rearranges fructose-6-phosphate and glyceraldehyde-3-phosphate using transketolase and transaldolase, and it is reversible, so surplus pentoses can flow back into glycolysis. The textbook calls it the two routes to pentose phosphates.”',
 cn:'<b>全链在卡 <b>gly</b> 的追问里</b>（同名的那一条），带页码。<span class="pg">p161 p162 p163</span> §7.7。⚠ <b>NADPH 这条线接的是脂肪酸合成</b>（速背 13 的第二条差别）——两张卡在这里咬合。'},
 ]},
...
{r:'中', q:'What are glucogenic and ketogenic amino acids?',
  ez:'“It is a classification by what the carbon skeleton becomes. Glucogenic amino acids end as pyruvate. The textbook says what follows from that. Give them to a starving organism and you get gluconeogenesis. You also get glycogen formation. Ketogenic ones are degraded to acetyl Co A. Under the same conditions that exceeds the citric acid cycle. So ketone bodies appear. Leucine is the only purely ketogenic one.”',
  ezcn:'<b>这是按「碳骨架最后变成什么」来分类。</b><b>生糖氨基酸最终走到丙酮酸——书说把它们喂给饥饿的机体会导致糖异生和糖原生成。</b><b>生酮氨基酸一路降解到乙酰-CoA，在同样条件下超出柠檬酸循环的处理能力，于是出现酮体。</b><b>书说亮氨酸是唯一纯生酮的，而异亮氨酸、苯丙氨酸、色氨酸、酪氨酸两者都是。</b>',
...
{r:'中', q:'What is gluconeogenesis, and where does it differ from glycolysis?',
  ez:'“Gluconeogenesis is the synthesis of glucose from non sugar precursors. The textbook describes it as a reversal of glycolysis. But three places are changed. The problem step is pyruvate kinase. Making pyruvate and A T P is practically irreversible. So the cell detours. Pyruvate is carboxylated to oxaloacetate. That is then phosphorylated using G T P. At the end two hexose phosphates are hydrolysed instead.”',
  ezcn:'<b>糖异生 ＝ 由非糖前体合成葡萄糖；书把它描述成糖酵解的逆行，但有三处被改掉。</b><b>麻烦的是丙酮酸激酶那一步：由磷酸烯醇式丙酮酸生成丙酮酸和 ATP 实际上不可逆。</b><b>所以细胞绕道：丙酮酸先被羧化成草酰乙酸，再用 GTP（不是 ATP）磷酸化。</b><b>末端那两次己糖磷酸化也不可逆，所以 1,6-二磷酸果糖和 6-磷酸葡萄糖改由另外的酶水解。</b><b>书还补了一句：肌肉缺主要的糖异生酶，所以乳酸要去肝脏。</b>',
...
{r:'中', q:'What are ketone bodies?',
  ez:'“They are what the liver makes in one situation. Acetyl Co A is produced faster than the citric acid cycle can use it. The textbook lists the conditions. Diabetes, starvation, or a diet rich in fat. The excess goes to H M G Co A. Part of that becomes acetoacetate. Acetoacetate can be reduced to beta hydroxybutyrate. Or it loses carbon dioxide without an enzyme and gives acetone.”',
  ezcn:'<b>酮体 ＝ 乙酰-CoA 产生得比柠檬酸循环能用掉的快时，肝脏做出来的那些东西。</b><b>书列的条件是：糖尿病、饥饿、或者高脂饮食。</b><b>多余的走向 HMG-CoA，其中一部分变成乙酰乙酸；乙酰乙酸要么被酶还原成 β-羟丁酸，要么非酶地脱羧成丙酮。</b><b>这些路线异常活跃时产物出现在血里，血 pH 下降，呼气里闻得到丙酮。</b>',
...
{r:'中', q:'What is malonyl-CoA and what is ACP?',
  ez:'“Malonyl Co A is acetyl Co A carrying one extra carboxyl. Acetyl Co A carboxylase makes it. That enzyme needs A T P and biotin. The textbook calls this the necessary activation. It activates the methyl group of acetyl Co A for condensation. A C P is the acyl carrier protein. It is the core of the complex that builds the chain. It has two different sulfhydryl groups. One is from a cysteine. The other is on a phosphopantetheine arm.”',
  ezcn:'<b>丙二酰-CoA ＝ 多带一个羧基的乙酰-CoA，由乙酰-CoA 羧化酶生成（需要 ATP 和辅酶生物素）。</b><b>书说这是「对乙酰-CoA 甲基进行缩合所必需的活化」。</b><b>ACP ＝ 酰基载体蛋白，是搭建脂肪酸链的那个多酶复合体的核心；它有两个不同的巯基：一个来自它链上的半胱氨酸，另一个在磷酸泛酰巯基乙胺臂上（那也是辅酶 A 的一部分）。</b>',
...
{r:'中', q:'What is the urea cycle, and what does it cost?',
  ez:'“It is how land animals get rid of ammonia. It is also called the ornithine cycle. Carbamoyl phosphate is made first. That happens in the mitochondrial matrix. It is strongly endergonic. It then reacts with ornithine to give citrulline. Citrulline moves out into the cytoplasm. There it reacts with aspartate. So aspartate donates the second nitrogen. A lyase splits off fumarate and leaves arginine. Arginase then hydrolyses urea off it.”',
  ezcn:'<b>尿素循环 ＝ 陆生动物处理氨的方式，也叫鸟氨酸循环。</b><b>先在线粒体基质里生成氨甲酰磷酸（强吸能），它跟鸟氨酸反应生成瓜氨酸；瓜氨酸移到胞质，在那里跟天冬氨酸反应生成精氨琥珀酸——第二个氮由天冬氨酸提供；一个裂合酶切下延胡索酸、留下精氨酸；精氨酸酶把尿素从精氨酸上水解下来，同时再生出鸟氨酸。</b>⚠ <b>书强调：跟柠檬酸循环不同，这个循环不在同一个细胞器里。</b>',
...
{r:'中', q:'What is a lipase, and how does a fat get taken apart in the first place?',
  ez:'“A lipase is a hydrolase. It breaks the ester bonds in a fat. Those bonds join the fatty acids to the glycerol. The textbook writes the reaction out. Triacylglycerol plus water gives free fatty acids and glycerol. It puts the lipases in the cytoplasm. It also calls triacylglycerols the main storage substance. Complex lipids have their own enzymes. Those are the phospholipases. The textbook distinguishes four types of them.”',
  ezcn:'<b>脂肪酶 ＝ 一个水解酶，打断脂肪里连接脂肪酸和甘油的那些酯键。</b><b>书把反应写成：三酰甘油 ＋ 水 → 游离脂肪酸 ＋ 甘油，并把脂肪酶放在胞质里；它还说三酰甘油是生物体内主要的储存物质。</b><b>复合脂质由它们自己的酶——磷脂酶——拆解，书按「在分子上哪个位置切」区分了四种。</b>',
...
{r:'中', q:'NADH and NADPH differ by one phosphate. Why does the cell keep two of them?',
  ez:'“Because they do two different jobs. And the cell needs to control them separately. N A D H carries hydrogen from catabolic oxidations. It carries it to the respiratory chain. There it is turned into A T P. N A D P H is reducing power kept for synthesis. The textbook says it directly. The N A D P H from the pentose phosphate pathway is not oxidised in the chain. It is used for synthetic reactions.”',
  ezcn:'因为<b>它们干两件不同的事，而细胞需要分开控制它们</b>。<b>NADH 把分解代谢氧化下来的氢带到呼吸链，在那里变成 ATP；NADPH 是留给合成用的还原力。</b><b>书在戊糖磷酸那一节直说了：那里生成的 NADPH「不在呼吸链里被氧化，而是用于合成反应」；脂肪酸那一章也说「合成的供氢体是 NADPH，而氧化给出的是 NADH」。</b>',
...
{r:'中', q:'Why does the cell have two different routes to the pentose phosphates?',
  ez:'“Because it does not always need the same two products. The oxidative route dehydrogenates glucose six phosphate first. It makes both N A D P H and ribose five phosphate. The non oxidative route starts differently. It moves a two carbon fragment from fructose six phosphate. The acceptor is glyceraldehyde three phosphate. So it makes pentoses without any N A D P H. All its steps are reversible too.”',
  ezcn:'因为<b>细胞并不总是需要同样的两个产物</b>。<b>氧化那条路先把 6-磷酸葡萄糖脱氢，同时给出 NADPH 和 5-磷酸核糖；非氧化那条路是从 6-磷酸果糖上搬一个二碳片段到 3-磷酸甘油醛上，造出戊糖而完全不产 NADPH。</b><b>书说第二条用在「需要的 5-磷酸核糖远多于 NADPH」的时候；而且它每一步都可逆，所以也能反过来跑，把三个戊糖变回两个己糖加一个丙糖。</b>',
...
{r:'中', q:'Transamination and deamination sound alike. Which is which?',
  ez:'“Transamination moves the amino group from an amino acid. It moves it onto the oxo group of a two oxo acid. So the nitrogen changes owner. No ammonia appears. The usual acceptors are pyruvate and two oxoglutarate and oxaloacetate. Deamination takes the nitrogen off as ammonia. The most important case is glutamate. Glutamate dehydrogenase deaminates it oxidatively. So the cell transaminates to collect. And it deaminates once to release.”',
  ezcn:'<b>转氨：把氨基从一个氨基酸搬到一个 2-氧代酸的氧代基上——氮换了主人，但不产生氨</b>（<b>书点名的常见受体是丙酮酸、2-氧代戊二酸、草酰乙酸</b>）。<b>脱氨：真的把氮以氨的形式取下来，最重要的一例是谷氨酸脱氢酶对谷氨酸的氧化脱氨。</b><b>所以细胞靠转氨来「收集」，靠在谷氨酸身上脱一次氨来「释放」。</b>',
...
{r:'中', q:'Why does the nitrogen have to leave separately, and why does that cost ATP?',
  ez:'“Because its waste product is poisonous. The carbon’s waste product is not. Carbon leaves as carbon dioxide. That simply diffuses away. Nitrogen leaves as ammonia. The textbook calls ammonia considerably toxic. So it must be packaged before excretion. The urea cycle is strongly endergonic. The textbook counts four moles of A T P per mole of urea. So the separation is not a matter of chemistry. It is a matter of toxicity.”',
  ezcn:'因为<b>氮的废物有毒，而碳的废物没有</b>。<b>碳以 CO₂ 的形式离开，直接扩散走；氮以氨的形式出来，而书说氨「相当有毒」，所以必须先打包才能排掉。</b><b>尿素循环是强吸能的，书算的是每摩尔尿素 4 摩尔 ATP：两个进氨甲酰磷酸，一个进精氨琥珀酸——而那一个走的是 AMP，所以再生它还要两个。</b><b>所以把氮单独拿出来处理不是化学问题，是毒性问题。</b>',
...
{r:'中', q:'Why is the citric acid cycle also a source of building blocks, not only a furnace?',
  ez:'“Because its intermediates start several syntheses. The textbook names them. Two oxoglutarate and oxaloacetate are converted by transamination. They become amino acids. Succinyl Co A reacts with glycine. That gives delta aminolevulate. The porphyrins are made from it. And fumarate connects the cycle to tyrosine and aspartate. So the same cycle is the end of catabolism. It is also a supply depot for anabolism.”',
  ezcn:'因为<b>它的中间物是好几条合成路线的起点，而书把它们点了名</b>：<b>2-氧代戊二酸和草酰乙酸经转氨变成氨基酸；琥珀酰-CoA 跟甘氨酸反应给出 δ-氨基乙酰丙酸，卟啉由它合成；延胡索酸是这个循环跟酪氨酸和天冬氨酸代谢相连的那个点。</b><b>所以同一个循环既是分解代谢的终点，又是合成代谢的供货仓库——这也是「凡是从它身上抽走的都必须补回来」的原因。</b>',
...
{r:'中', q:'Why store energy as fat rather than as glycogen?',
  ez:'“There are two reasons. The textbook supplies the numbers for the first. Per gram palmitic acid gives about two point eight times what glucose gives. The chain is more reduced. And it carries no oxygen of its own. The second reason is repetition. A fatty acid is a repeat of one two carbon unit. So the same four enzymes run again and again. The textbook also notes a cost for glycogen. Storing it takes two phosphorylations per glucose.”',
  ezcn:'<b>两个理由。</b><b>① 书给了数：按克算，软脂酸完全氧化给出的能量约是葡萄糖的 2.8 倍——因为脂肪酸链被还原得更彻底，而且自身不带氧。</b><b>② 重复性：脂肪酸是同一个二碳单元的重复，所以同样的四个酶一遍遍跑。</b><b>书还说三酰甘油是生物体内主要的储存物质，而糖原每存进一个葡萄糖要花两次磷酸化。</b>',
 ...
 {g:'合成那一半 · 配套追问', gn:'跟速背 16–21 配套的两条。<b>两条都是「书说了什么」和「通用叫法是什么」分开说</b>。', items:[
{r:'高', q:'Why does that one step of gluconeogenesis use GTP instead of ATP?',
    ez:'“The step is the one that makes phosphoenolpyruvate. Going forward that reaction is practically irreversible. Pyruvate kinase makes pyruvate and A T P from phosphoenolpyruvate. So the cell cannot simply run it backwards. It detours through oxaloacetate instead. Pyruvate is carboxylated to oxaloacetate first. Oxaloacetate is much easier to phosphorylate. Forming the enol form is easier there. The textbook says the phosphorylation uses G T P in this case. It does not use A T P. So the detour costs an extra step and a different nucleotide too.”',
    ezcn:'<b>那一步是生成磷酸烯醇丙酮酸的那一步。</b><b>正向走的时候，丙酮酸激酶把磷酸烯醇丙酮酸和 ADP 变成丙酮酸和 ATP，<b>这个反应实际上不可逆</b>，所以细胞不能简单地把它倒过来。</b><b>绕行的办法是先把<b>丙酮酸羧化成草酰乙酸</b>——草酰乙酸容易得多地被磷酸化，因为它<b>形成烯醇式更容易</b>。</b>⚠ <b>而书明确说：这一次的磷酸化用的是 <b>GTP，不是 ATP</b>。</b><b>所以这段绕行不只多了一步，连用的核苷酸都换了。</b>',
 en:'“The step in question is the one that makes phosphoenolpyruvate. Run forwards, pyruvate kinase makes pyruvate and ATP from phosphoenolpyruvate and ADP, and the textbook calls that practically irreversible, so the cell cannot simply run it backwards. It detours through oxaloacetate instead. Pyruvate is first carboxylated to oxaloacetate, and oxaloacetate is far easier to phosphorylate because forming the enol form is easier there. The textbook says explicitly that GTP is used for this phosphorylation rather than ATP. So the detour costs an extra step and a different nucleotide as well.”',
 cn:'<span class="pg">p169</span> §7.9 原话。⚠ <b>这是「合成不是倒放」最便宜的一个证据</b>：<b>同一个化学变化，正向和反向用的不是同一个酶，甚至不是同一个核苷酸</b>。'},
{r:'高', q:'The textbook describes a circuit between muscle and liver. Does it name it?',
    ez:'“It does not name it. It describes all of it. Muscle lacks the main gluconeogenic enzymes. So lactate made there anaerobically cannot become glucose in the muscle. It cannot even do so once oxygen returns. The surplus lactate travels in the blood to the liver. Glucose is synthesised there. That glucose can travel back to the muscle in the blood. That circuit is usually called the Cori cycle. The name is general knowledge and not in this book.”',
    ezcn:'<b>书没有叫它的名字，但它把整件事描述完了。</b><b>肌肉缺主要的糖异生酶，所以肌肉里厌氧产生的乳酸在肌肉里变不回葡萄糖——<b>即使氧气回来了也不行</b>（只能继续被氧化）。</b><b>多余的乳酸经血流到<b>肝</b>，在那里合成葡萄糖，葡萄糖再经血回到肌肉。</b>⚠ <b>这个回路通常叫 <b>Cori 循环</b>——<b>名字是通用知识，这本书里没有</b>。</b>',
 en:'“It does not name it, but it describes all of it. The main gluconeogenic enzymes are missing from muscle, so lactate formed there under anaerobic conditions cannot become glucose in the muscle, not even once oxygen returns, and it can only be oxidised further. The surplus lactate travels in the blood to the liver, glucose is synthesised there, and that glucose can be transported back to the muscle in the blood. That circuit is usually called the Cori cycle. The name itself is general knowledge and is not in this textbook.”',
 cn:'<span class="pg">p170</span>。⚠ <b>跟卡 14 的 Avery 那条是同一个形状</b>：<b>先把书的描述说完，再补一句名字并标 general</b>——「先引书再给名字」这个动作本身在口试上是稳的。'},
 ]},
]
});
