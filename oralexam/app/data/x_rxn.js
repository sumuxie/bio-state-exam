/* 横向卡 · 反应类型的名字
   ...
   书的勘误第 6 条（p196 thiolasa 印成 ketokinasa）用在速背第 13 点和追问里。 */
...
cram:[
 ...
 {n:'01', t:'第一个问题',
  ...
  note:'<b>这一条是整张卡的用法。</b>考场上他报一个名字，你不需要背过它，你需要能说出<b>它属于哪一族</b>。<br>名字几乎全是按「变了什么」起的：<b>iso-</b> 是同一堆原子换摆法，<b>trans-</b> 是有东西从一个分子搬到另一个分子，<b>de-</b> 是拿掉（dekarboxylace 拿掉 CO₂、dehydratace 拿掉水、dehydrogenace 拿掉氢），<b>-lysis</b> 是有人来砍这一刀。'},
 {n:'02', t:'第二个问题',
  ...
  tbl:{head:['EC 类','书给的定义（p041–p042）','对应的日常名字','书自己给的例子和编号'],
   rows:[
    ['<b>1 · Oxidoreduktasy</b>','催化氧化还原反应：电子转移、氢转移、或与氧反应','oxidace · redukce · <b>dehydrogenace</b>','laktátdehydrogenasa <b>E.C.1.1.1.27</b> <span class="pg">p041</span> · glutamátdehydrogenasa E.C.1.4.1.2 <span class="pg">p119</span>'],
    ['<b>2 · Transferasy</b>','催化<b>基团的转移</b>','<b>transaminace</b> · <b>fosforylace</b> · 甲基化 · 酰基转移','aminotransferasy <b>E.C.2.6.1</b> <span class="pg">p120</span> · hexokinasa ＝ ATP:hexosa-fosfotransferasa <span class="pg">p042</span>'],
    ['<b>3 · Hydrolasy</b>','催化水解反应；亚类<b>按被水解的键</b>分','<b>hydrolýza</b>','arginasa E.C.3.5.3.1，水解切下尿素 <span class="pg">p123</span>'],
    ['<b>4 · Lyasy（Synthasy）</b>','<b>非水解、非氧化</b>地断键，常生成一个双键；反过来是加到双键上','<b>dekarboxylace</b> · <b>dehydratace</b> · <b>hydratace</b> · aldolové štěpení','oxalát karboxy-lyasa <span class="pg">p042</span> · serindehydratasa E.C.4.2.1.13 <span class="pg">p119</span>'],
    ['<b>5 · Izomerasy</b>','催化异构化','<b>izomerace</b> · <b>epimerace</b> · cis-trans','fumarát cis-trans-izomerasa <span class="pg">p042</span>'],
    ['<b>6 · Ligasy（Synthetasy）</b>','在<b>水解高能化合物</b>（多半是 ATP）的同时生成一个键','要花 ATP 的缩合','karbamoylfosfátsynthetasa E.C.6.3.4.16 · argininsukcinátsynthetasa E.C.6.3.4.5 <span class="pg">p123</span>'],
   ]},
  ...
  warn:'⚠ <b>两套分类不是一一对应的。</b>同一个日常名字可以落在不同的 EC 类里：<b>hydratace 和 dehydratace 归 lyasy 不归 hydrolasy</b>（书自己把 serindehydratasa 编成 4.2.1.13）；而<b>硫解不是水解</b>，按书给 transferasy 的定义它是转移酶。<b>先答日常名字，他追问再给类。</b>'},
 ...
 {n:'03', t:'判断顺序',
  ...
  tbl:{head:['依次问这一句','答「是」→ 属于','这一族的名字'],
   rows:[
    ['① <b>C–C 键</b>断了或者接上了吗？','<b>家族 D</b> · 碳链变长变短','dekarboxylace · karboxylace · aldolové štěpení · thiolytické štěpení · kondenzace'],
    ['② <b>氧化态</b>变了吗？（最省事的判据：<b>氢走了没有</b>）','<b>家族 B</b> · 氧化还原','oxidace · redukce · dehydrogenace'],
    ['③ 有没有一个<b>基团从这个分子跑到另一个分子上</b>？','<b>家族 C</b> · 基团转移','transaminace · fosforylace · transketolasa · transaldolasa · 甲基化'],
    ['④ <b>一个分子变成两个</b>了吗（或者两个并成一个）？','<b>家族 E</b> · 水进水出，以及谁来砍','hydrolýza · kondenzace · hydratace · dehydratace · fosforolýza · thiolýza'],
    ['四句都答「否」','<b>家族 A</b> · 同一堆原子换个摆法','izomerace · epimerace · mutarotace · cis-trans izomerace'],
   ]},
 ...
 {g:'家族 A · 同一堆原子，换个摆法', gn:'书 p159 §7.6 给了这一族最好的判据：这类反应里<b>碳原子的数目不变</b>。'},
 {n:'04', t:'izomerace 对 epimerace',
  big:'<b>izomerace</b> 挪的是<b>羰基</b>的位置；<b>epimerace</b> 翻的是<b>一个碳上的立体排布</b>',
  ...
  note:'<b>反应式</b>：<code>izomerace　醛糖 ⇌ 酮糖，羰基从 C-1 挪到 C-2　　glukosa ⇌ fruktosa</code><br><code>epimerace　一个碳上的 OH 从右翻到左，羰基不动　　glukosa ⇌ galaktosa（C-4）</code><br>书 <span class="pg">p160 §7.6.1</span> 的节标题就叫 <i>Epimerace a izomerace</i>，两个词并排。<b>这一节是老师问「glucose 怎么变 galactose」时脑子里的那一页</b>（答 <b>epimerization at C-4</b>，UDP-glukosa-4-epimerasa，p172）。<br><b>她已经有的例子</b>：卡 <b>gly</b> 的 hexosafosfátizomerasa（平衡时 30% 果糖）和 triosafosfátizomerasa（平衡时 96% DHAP），都在 <span class="pg">p164</span>，卡 <b>32</b> 引了这两个比例 · 卡 <b>06</b> 的 UDP-glukosa-4-epimerasa。',
  warn:'⚠ <b>书没有给 izomerace 的一般定义。</b>p160 那句「羰基挪到相邻的碳上」只管糖；p042 那句「izomerasy 催化 izomerace」是循环定义。<b>一般定义（同一个分子式、原子排布不同）是通用知识</b>，被追问出处要把这两半分开说。'},
 {n:'05', t:'五个词，当成一道数数题',
  ...
  warn:'⚠ <b>enantiomer 这个词全书 0 命中</b>，stereoizomer 也只在 p148、p149 出现过。书给的是 <b>epimery 的定义</b>（p149：只在一个不对称碳上构型不同的单糖）、<b>anomery 的定义</b>（p150）和 <b>2ⁿ 这个数</b>（p148）。<b>对映体那一句要标明是通用知识。</b>',
 ...
 {n:'06', t:'同族的另两个名字',
  big:'<b>mutarotace</b> 是 α ⇌ β 自己在变；<b>cis-trans izomerace</b> 是取代基挪到双键的另一边',
  ...
  note:'三个旋光度是书 <span class="pg">p151</span> 的：α 是 ＋112°，β 是 ＋18,4°，两边都漂到 ＋52,7°。fumarát ⇌ maleát 是书给 izomerasy 的那个例子 <span class="pg">p042</span>。<br><b>同一个家族横跨三章</b>：糖里是变旋（卡 06）· 脂里是 β-氧化前面那一步，天然不饱和脂肪酸是 cis，酶只认 trans，所以要 <i>cis-trans izomerasa</i> 和 <i>epimerasa</i>（<span class="pg">p195</span>，卡 23）· 蛋白里是 peptidylprolyl-cis,trans-izomerasa（<span class="pg">p109</span>，卡 01、卡 13）。<b>说得出这三处是同一族，比多记一个名字值钱。</b>'},
 ...
 {n:'08', t:'非要数的时候怎么数',
  ...
  note:'<b>拿书里的反应对一遍这把梯子，三个都对得上</b>：glukosa-6-fosfát → 6-fosfoglukonolakton（C-1 从醛升到酯，NADP⁺ 收氢，<span class="pg">p160</span>）· sukcinát → fumarát（脱两个氢给 FAD，<span class="pg">p139</span>，卡 24）· L-malát → oxalacetát（羟基升成酮，脱氢给 NAD⁺，卡 24）。<b>三个都是「氢走了」，梯子只是把它读成一个数。</b>',
  warn:'⚠ <b>这把梯子书里没有</b>，是通用有机化学。书只给到「在有机化合物里氧化常常就是脱氢」那一句，加上 ethanol → acetaldehyd 那个例子（<span class="pg">p134</span>）。<b>被追问出处，把哪一半是书的说清楚。</b>'},

 {g:'家族 C · 一个基团从这个分子搬到那个分子', gn:'书给 transferasy 的定义只有一句：催化基团的转移（p041）。这一族的名字要么 trans- 开头，要么直接拿被搬的东西命名。'},
 {n:'09', t:'transaminace',
  ...
  note:'<b>反应式</b>（书 <span class="pg">p120</span> 印的那一行）：<code>R₁–CH(NH₂)–COOH ＋ R₂–CO–COOH ⇌ R₁–CO–COOH ＋ R₂–CH(NH₂)–COOH</code><br>书给的两个最常用的具体式子：<code>α-氨基酸 ＋ pyruvát ⇌ 2-氧代酸 ＋ alanin</code>　<code>α-氨基酸 ＋ 2-oxoglutarát ⇌ 2-氧代酸 ＋ glutamát</code><br><b>这一格是「什么在动、什么不动」的标准例子</b>：氨基和酮基对调，两条碳链一个原子都没挪。书还写了目的：把各个氨基酸的氨基<b>汇集到一种氨基酸上</b>，通常是谷氨酸，再在下一步被氧化脱氨。<br><b>她已经有的例子</b>：卡 <b>aa</b>（alanine aminotransferase，以及汇到 glutamát 再进尿素）· 卡 <b>24</b> 和卡 <b>28</b> 的 oxaloacetát ⇌ aspartát · 卡 <b>31</b> 的 PLP 那一格 · 卡 <b>18</b> 的 Schiff 碱那一句。',
  warn:'⚠ <b>transaminace 在她已有的卡上出现过十来次，从头到尾没有人定义过它</b>（卡 18、24、28、aa 都用了）。<b>这一格就是补这个定义的地方。</b><br>别说成「氨基被去掉」：<b>去掉是 deaminace，对调才是 transaminace</b>。氧化脱氨是<b>另一个反应</b>，它真的放出氨，酶是 glutamátdehydrogenasa，E.C. 1.4.1.2（<span class="pg">p119</span>）。'},
 {n:'10', t:'fosforylace 的三个收件人',
  ...
  tbl:{head:['磷酸给了谁','这是在干什么','出处 / 在哪张卡'],
   rows:[
    ['一个小分子代谢物<br><b>glukosa → glukosa-6-fosfát</b>','<b>代谢</b>：把糖锁在细胞里，并且把它的能量抬上去，后面的步骤才走得动','hexokinasa <span class="pg">p042</span> · 卡 <b>gly</b> · 卡 <b>06</b>'],
  ...
  note:'<b>反应式</b>：<code>代谢　hexosa ＋ ATP → hexosa-(P) ＋ ADP</code>（书 <span class="pg">p042</span> 给 transferasy 的例子就是这一行）<br><code>调控　protein–Ser–OH ＋ ATP →(kinasa) protein–Ser–O–PO₃²⁻ ＋ ADP　　拆回去是 ＋H₂O →(fosfatasa)</code><br>书 <span class="pg">p113</span>：<b>非常重要的一种修饰，是用磷酸化改变氨基酸侧链的电荷</b>。<span class="pg">p114</span>：Ser、Thr 的羟基和 Tyr 的酚羟基被磷酸化生成<b>磷酸酯</b>，Lys、Arg、His 上少见得多；磷酸化<b>改变构象</b>，有的蛋白磷酸化后活性更高，有的反过来要<b>水解掉磷酸</b>才高。<br><b>最完整的例子在 <span class="pg">p063 §3.7.2</span></b>：glykogenfosforylasa <b>a 是活性形式，b 几乎无活性</b>，靠活性中心里<b>一个丝氨酸羟基的可逆磷酸化</b>互变，拆磷酸的是专门的磷酸酶。',
 ...
 {n:'11', t:'别的 transfer',
  ...
  note:'书 §7.6.3 的节标题就叫「<b>三碳或二碳碎片的转移</b>」<span class="pg">p161 p162</span>，而且给了两条规律：碎片<b>总是来自酮糖</b>，接受的<b>总是醛糖</b>，<b>碳原子的总数不变</b>（<span class="pg">p159</span>）。ornithinkarbamoyltransferasa E.C.2.1.3.3 在 <span class="pg">p123</span>。<br>⚠ <b>transketolasa 和 transaldolasa 同时踩两个家族</b>：它们搬的是一整段碳链，所以既是基团转移（C），也真的把 C–C 键断了又接上（D）。卡 <b>27</b> 的 Calvin 循环和卡 <b>06</b> 的磷酸戊糖路都用到它们。'},

 {g:'家族 D · 碳链变长或者变短', gn:'判据最硬的一族：C–C 键真的断了或者接上了。书 p042 把这一族的大半交给 lyasy —— 非水解、非氧化地断键。'},
 {n:'12', t:'dekarboxylace 和 karboxylace',
 ...
 {n:'13', t:'aldolové 和 thiolytické štěpení',
  ...
  note:'<b>反应式</b>：<code>aldolové štěpení　fruktosa-1,6-bisfosfát ⇌ dihydroxyacetonfosfát ＋ glyceraldehyd-3-fosfát</code><br><code>thiolytické štěpení　R–CO–CH₂–CO–SCoA ＋ CoASH → R–CO–SCoA ＋ CH₃CO–SCoA</code><br>aldolasa 劈 fruktosa-1,6-bisfosfát 在 <span class="pg">p161</span>（卡 <b>gly</b>）· 柠檬酸合成那一步书自己叫 <i>aldolová kondenzace</i>，<span class="pg">p136</span>（卡 <b>24</b>）· threoninaldolasa 靠 PLP 把苏氨酸劈成甘氨酸和乙醛，<span class="pg">p122</span>（卡 <b>aa</b>）。<br><b>卡 23 的 β-氧化四步（脱氢 · 水合 · 脱氢 · 硫解）是这张卡最好的演示</b>：一个循环里踩了三个家族。',
  warn:'⚠ <b>这是勘误第 6 条。</b>书 <span class="pg">p196</span> 那张 β-氧化四步图，第四步写的是 <i>D. Thiolytické štěpení</i>，进来的是 <b>CoASH</b>，出去的是 acyl-CoA ＋ acetyl-CoA，<b>但酶名那一栏印的是 β-ketokinasa</b>。已回 280 dpi 原图确认，不是 OCR 错。<br><b>用书的一半打书的另一半</b>：不要说「别的教材叫 thiolase」，要说「你这本书<b>同一行</b>写的是 thiolytické štěpení，进来的是 CoASH 不是磷酸」。<br>⚠ <b>硫解也不是水解</b>，它按书自己给类二的定义算转移酶 —— 这一条在追问里单独有一格。'},

 {g:'家族 E · 水进水出，以及「谁来砍这一刀」', gn:'四个名字里三个跟水有关，但只有一个是「水把键砍断」。这一格就是把它们分开。'},
 {n:'14', t:'四个一次分清',
  big:'关键只有一句：<b>只有 hydrolýza 是一个分子变成两个</b>',
  ...
  tbl:{head:['名字','水在干什么','分子数','例子 / 在哪张卡'],
   rows:[
    ['<b>hydrolýza</b> 水解','水<b>砍断</b>一个键，H 和 OH 分给断口两边','<b>1 → 2</b>','肽酶切肽键（卡 <b>08</b>）· arginasa 放出尿素 <span class="pg">p123</span>'],
    ['<b>kondenzace</b> 缩合','两个分子接成一个，<b>吐出</b>一分子水','<b>2 → 1</b>','肽键的生成（卡 <b>01</b>）· 柠檬酸合成的 aldolová kondenzace <span class="pg">p136</span>（卡 <b>24</b>）'],
    ['<b>hydratace</b> 水合','一整个水<b>加到双键上</b>，什么键都没断','<b>1 → 1</b>','fumarát ＋ H₂O → L-malát，酶叫 fumaráthydratasa <span class="pg">p139</span>（卡 <b>24</b>）· β-氧化第二步（卡 <b>23</b>）'],
    ['<b>dehydratace</b> 脱水','脱掉一分子水，<b>留下一个双键</b>','<b>1 → 1</b>','enolasa 把 2-fosfoglycerát 变成 PEP（卡 <b>gly</b>）· serindehydratasa E.C.4.2.1.13 <span class="pg">p119</span>'],
   ]},
  note:'<b>反应式</b>：<code>hydrolýza　A–B ＋ H₂O → A–H ＋ B–OH</code>　<code>kondenzace　A–H ＋ B–OH → A–B ＋ H₂O</code><br><code>hydratace　C＝C ＋ H₂O → HC–COH</code>　<code>dehydratace　HC–COH → C＝C ＋ H₂O</code><br><b>最漂亮的一个例子是 akonitasa。</b>书 <span class="pg">p138</span> 说 citrát → isocitrát 这一步是「一个<b>包含脱水、以及随后把水加到 cis-akonitát 的 α,β-双键上</b>的 izomerace」。<b>脱水 ＋ 水合 ＝ 净水没变 ＝ 分子式没变 ＝ 这是一个异构化。</b>一句话把家族 A 和家族 E 缝在一起，卡 <b>24</b> 已经有这一条。',
  warn:'⚠ <b>别把 hydratace 说成 hydrolýza。</b>两个词差两个字母，但一个不断键、一个断键。<b>书自己的酶名帮得上忙</b>：延胡索酸那一步的酶叫 <b>fumaráthydratasa</b>，不叫 hydrolasa；而书把脱水酶编成 4.2.1.13，是 <b>lyasa</b>，也不在水解酶那一类里。'},
 {n:'15', t:'-lysis 这个后缀',
  ...
  note:'<b>通式</b>：<code>A–B ＋ X–H → A–X ＋ B–H</code>，<b>X 是谁，反应就叫什么解</b>：<code>X ＝ OH（水）→ hydrolýza</code>　<code>X ＝ 磷酸 → fosforolýza</code>　<code>X ＝ CoA 的 S → thiolýza</code><br>书 <span class="pg">p173 §7.11.2</span> 原话：细胞里拆多糖跟消化道里不一样，<b>不是水解，是磷酸解</b>；从非还原端拆下一个葡萄糖残基交给磷酸，生成 <b>glukosa-1-fosfát</b>，酶叫 <i>fosforylasa</i>。<span class="pg">p174</span> 说这么做<b>省下了葡萄糖进糖酵解前的第一次磷酸化</b>。<br><b>卡 gly 里还有第三个</b>：GAPDH 那一步，磷酸砍断酶上的硫酯，生成 1,3-bisfosfoglycerát（<span class="pg">p165</span>）。'},
 ...
 {n:'16', t:'复合名字怎么拆',
  ...
  note:'拆开说的好处是<b>每一半都接得住下一刀</b>：他追「哪一步是氧化」，你指得出氢落在哪；他追「那个碳去哪了」，你答 CO₂。<br><b>她已经有的例子</b>：丙酮酸的氧化脱羧（卡 <b>gly</b>、卡 <b>25</b>、卡 <b>31</b>）· 谷氨酸的氧化脱氨（卡 <b>aa</b>，glutamátdehydrogenasa E.C.1.4.1.2，<span class="pg">p119</span>）· 柠檬酸合成的 aldolová kondenzace（卡 <b>24</b>）· β-氧化第四步的硫解（卡 <b>23</b>）。'}
],
...
segs:[
 ...
 {tag:'段 4 · 留口子', h:'落到她每周都在用的两类酶',
  ...
  note:'两个口子都在主场：polymerase 接卡 <b>taq</b>（Taq / Kapa），ligase 接卡 <b>16</b>（DNA 复制）。<b>卡 16 里那条差别可以顺势给</b>：大肠杆菌的连接酶用 NAD⁺，真核和 T4 的用 ATP —— 书 p042 把 ligasy 定义成「在水解高能化合物的同时成键」，<b>NAD⁺ 也是高能化合物，所以两者都在类六里，不矛盾</b>。'}
],
...
why:{
 rungs:[
  ...
  ['为什么要留着两套名字？','因为它们回答两个不同的问题：日常名字答<b>分子身上发生了什么</b>，EC 类答<b>这个酶归哪一类</b>。<b>而且两套都是人划的，不是分子自带的</b> —— 书自己就承认 lyasy 又叫 synthasy、ligasy 又叫 synthetasy，同一类两个名字。']
 ],
...
{q:'What is isomerisation?',
 mean:'最短的问法。<b>先给一般定义，再给书在糖化学里的那个窄义，再说它跟 epimerace 差在哪。</b>',
...
{q:'What kind of reaction is the fourth step of β-oxidation?',
 mean:'问的是 <b>thiolytické štěpení</b>，而且这里藏着书的一个印刷错。',
 ...
 tail:'⚠ <b>勘误第 6 条。</b>已回 280 dpi 原图确认书上印的就是 ketokinasa。<b>说的时候指书自己的图</b>：同一行写着 thiolytické štěpení，进来的是 CoASH。'},
...
{q:'Why does the muscle get sugar out of glycogen without spending ATP?', odd:1,
 mean:'问的是 <b>fosforolýza</b>，也就是「谁来砍这一刀」那一格。',
...
{q:'Why do people call vitamin B6 the protein vitamin?', odd:1,
 mean:'问的是 <b>transaminace</b> 和 <b>PLP</b>。维生素那一半在卡 31。',
...
{q:'Why does a cut apple go brown?', odd:1,
 ...
 tail:'⚠ <b>这本书没有这个例子，酶名不要编。</b>能说的是书给 oxidoreduktasy 的定义里有「与氧反应」这一条（p041）。他要名字就说这是书外的。'}
],
...
{r:'高', q:'What is an isomer?',
 ...
 warn:'⚠ 全书<b>没有 enantiomer 这个词</b>，stereoizomer 也只出现在 p148 和 p149。'},
...
{r:'中', q:'What is a 2-oxoacid, and what is a β-oxoacid?',
 ...
 cn:'三个 2-氧代酸是书 <span class="pg">p120</span> 给 transaminace 的受体名单。β-氧代酸容易脱羧、所以「先氧化再脱羧」这个顺序，书在 <span class="pg">p159</span> 讲己糖变戊糖时写得最清楚。卡 <b>24</b> 里 oxalsukcinát 和 oxalacetát 都是 β-氧代酸。'},
{r:'中', q:'What is a Schiff base?',
 ...
 cn:'书 <span class="pg">p120</span> 只写了「<b>PLP 与氨基酸形成 Schiff 碱</b>」这一句加一张图（obr. 5.3），<b>没有给 Schiff 碱的定义</b>。定义那一句在卡 <b>18</b>，是通用知识。'},
...
{r:'中', q:'What does macroergic mean, since a ligase needs one?',
 ...
 cn:'门槛的两个数在书 <span class="pg">p131</span>（<i>na 1 vazbu</i>，按每个键算）。完整的一格、连同把这两个数换算成平衡常数的推导，在横向卡 <b>x_bonds</b> 的第 2 点。'},
...
{r:'高', q:'Glucose to fructose — isomerisation or epimerisation?',
 ...
 cn:'<b>判据一句话：羰基挪了没有。</b>挪了是 izomerace，没挪只是某个碳翻了个身就是 epimerace。<span class="pg">p160</span><br>同事真的问过的那道题是反过来的方向：<b>glucose → galactose 答 epimerization at C-4</b>，酶是 UDP-glukosa-4-epimerasa（<span class="pg">p172</span>，卡 <b>06</b>）。'},
{r:'高', q:'Transamination or deamination?',
 ...
 cn:'<b>判据一句话：有没有放出氨。</b>没放出就是对调，是 transaminace；放出了才是 deaminace。<span class="pg">p119 p120</span><br><b>最后那句「先汇集再脱氨」是书自己的话</b>，说出来比只分辨两个词有力得多 —— 它顺手把卡 <b>aa</b> 的尿素那一段接上了。'},
{r:'高', q:'Kinase, phosphorylase or phosphatase?',
 ...
 warn:'⚠ <b>最刁的一点在这里</b>：做磷酸解的那个酶，自己是被磷酸化开关的。书 <span class="pg">p063 §3.7.2</span>：<b>glykogenfosforylasa a 是活性形式，b 几乎无活性</b>，靠活性中心里一个丝氨酸羟基的<b>可逆磷酸化</b>互变，拆磷酸的是专门的磷酸酶。<b>一个名字里带 fosforyl、一个动作叫 fosforolýza、一个开关叫 fosforylace —— 三件不同的事挤在同一个酶身上。</b>'},
...
{r:'中', q:'Synthase or synthetase?',
 ...
 cn:'书 <span class="pg">p042</span> 的标题就写着 <i>4. Lyasy (Synthasy)</i> 和 <i>6. Ligasy (Synthetasy)</i>。<b>这一对是「同一类两个名字」最好的证据</b>，也是 why 第三层那句「分类是人划的」的书证。<br>书里的例子对得上：malátsynthasa 不花 ATP（<span class="pg">p140</span>，卡 <b>24</b>）· karbamoylfosfátsynthetasa 花 ATP（E.C.6.3.4.16，<span class="pg">p123</span>）。'},
{r:'中', q:'Hydrolysis or thiolysis — is the fourth step of β-oxidation a hydrolase reaction?',
 ...
 cn:'⚠ <b>这一条要标清楚是推出来的。</b>书给了这一步的名字（<i>thiolytické štěpení</i>）和它自己的六类定义（p041），<b>但没有把这一步归过类</b>。说的时候用「by the textbook’s own definition」，不要说「the textbook says」。'}
]},
...
{r:'中', q:'Why is a decarboxylation so often coupled to an oxidation?',
 ...
 cn:'书 <span class="pg">p159</span> 的原话顺序就是「先脱氢成 β-氧代酸，然后脱羧」。<b>卡 24 里 isocitrát 那一步是同一个顺序的第二个例子</b>：先氧化成 oxalsukcinát，再脱羧成 2-oxoglutarát。<b>说得出「这是同一个套路」，比分别背两条通路值钱。</b>'},
