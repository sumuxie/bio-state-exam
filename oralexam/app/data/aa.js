...
cram:[
 ...
 {n:'04', t:'书的四组',
  ...
  note:'<b>🪄 邪修记法</b>：非极性 8 ＝ <b>AVLIP</b>（五脂）＋ <b>FW</b>（二芳）＋ <b>M</b>（一硫）· 极性不带电 6 ＝ <b>STY</b>（三羟）＋ <b>NQ</b>（二酰胺）＋ <b>C</b>（一巯）· 负 2 ＝ <b>DE</b>（“Dead End”，两个酸）· 正 3 ＝ <b>KRH</b>（“King, Royal, Highness”，三个碱）· G 单列。必需的九个：“<b>PVT TIM HiLL</b>”＝ Phe Val Thr Trp Ile Met His Leu Lys（通用知识）。纯生酮：<b>两个 L</b>，Leu ＋ Lys（书只算 Leu）。<br><b>数目是骨架</b>：8 ＋ 6 ＋ 2 ＋ 3 ＋ 1 = 20，漏了谁一数就知道。<br><b>书和 Lehninger 不一样的两处，主动说</b>：书把 <b>tyrosine 放进极性组</b>（Lehninger 放芳香组），把 <b>glycine 单列</b>（Lehninger 放非极性脂肪组）。“Lehninger files tyrosine with the aromatic ones and glycine with the aliphatic ones — same twenty, different drawers.”<span class="pg">p021</span>',
