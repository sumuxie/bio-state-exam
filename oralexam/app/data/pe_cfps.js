...
cram:[
 ...
 {n:'02', t:'整张卡的铰链',
  ez:'“The hinge between the two halves is one requirement. A codon must be made to mean something new. For that, one natural synthetase must be absent. Otherwise it keeps loading its own amino acid. It loads it onto its own tRNA. And it wins by sheer numbers. You cannot take one protein out of a crude lysate. In a reconstituted system it is different. You simply do not add it. So leaving it out is the same as removing it.”',
