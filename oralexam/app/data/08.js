...
cram:[
 ...
 {n:'03', t:'两者的关系',
  ez:'“They are two stages of one thing. The textbook calls it a two stage proteolytic modification. Pre is about location. The signal peptide says where the chain goes. It is cut off first, in the E R. That happens while the chain is still being made. Pro is about activity. The propeptide keeps the protein inactive. Or it holds the protein together. It is cut off later, mostly in the Golgi. For the digestive enzymes it is cut only in the gut. A protein carrying both is a preproprotein. Preproinsulin is signal, B chain, C peptide, A chain.”',
  ezcn:'<b>它们是同一件事的两个阶段——书叫它「两阶段的蛋白水解修饰」。</b><b>pre 管位置</b>：<b>信号肽说明这条链去哪儿，它最先被切掉，在内质网里，而且是链还在被造的时候</b>。<b>pro 管活性</b>：<b>前肽让蛋白保持无活性、或者把它拢在一起，它晚一步才被切，多半在高尔基体；消化酶则要到肠道里才切</b>。<b>两样都带的蛋白叫前体原蛋白：前胰岛素原 ＝ 信号 ＋ B 链 ＋ C 肽 ＋ A 链。</b>',
