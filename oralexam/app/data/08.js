...
{r:'高', q:'Where do you put the His-tag, and why?',
    ez:'“After the signal sequence, or at the C terminus. Never in front of the signal. Everything before the cleavage site leaves with the signal peptide. If the construct also has a pro region, the tag must sit after that cleavage site too. And the residues right after the cut matter. They affect how efficiently signal peptidase cleaves. So I keep that junction as it is in the parent vector.”',
