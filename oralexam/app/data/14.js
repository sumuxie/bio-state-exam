...
{r:'高', q:'What actually happens to the membrane during an electric pulse?',
    ez:'“The field puts a voltage across the membrane itself. The membrane is a thin insulator. It sits between two conducting solutions. Above a threshold that voltage destabilises the bilayer. Water filled pores then open through it. They are transient. They close again within seconds once the field is off. The nucleic acid moves through while they are open. The pulse is described by two numbers. They are the field strength and the duration. For bacteria that is a few kilovolts per centimetre, for milliseconds. Mammalian cells are pulsed more gently and for longer.”',
...
{r:'实测', q:'Where does this come into your own work?',
    ez:'“Three of the four happen weekly for me. I put plasmids into E. coli by electroporation. Electroporation is transformation done electrically. I use the pulse instead of chemical competence. The reason is that it is more efficient. I also put libraries into yeast for display. Yeast is a eukaryote. But the field still calls that transformation. In both cases the marker defines what I recover. The efficiency of that one step is my ceiling. The number of cells that take up DNA is the number of variants I can screen.”',
