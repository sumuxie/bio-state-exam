/* 卡 31 · Explain the role of vitamins and minerals in metabolism.
   ...
   出处 Biochemie OCR：维生素的定义与 Tab. 3.1 在 p043（§3.2.1 Koenzymy），
   ...
   Tab. 3.1 的正文 OCR 出来是空的，已回 300 dpi 原图逐行读出，见速背 07。
...
cram:[
 ...
 {n:'02', t:'定义 · 矿物质',
  ...
  note:'三档的名字和元素清单全在 <span class="pg">p011</span>：<b>makrobiogenní</b> H O C N P（约 1% 以上）· <b>oligobiogenní</b> Ca Mg S Na K Fe Cl（0,05–1%）· <b>mikrobiogenní</b> Cu Zn Co Mn I Mo。还有一档 <b>variabilní / stopové prvky</b>（B Si V Br Li As Se Ti Al），只在某些物种里才有可观的量。<b>百分数是书给的，直接报</b>。<br><b>注意 H O C N P 这一档也在清单里</b>——所以严格说，「矿物质」这个日常词并不等于书的任何一档。被追问时就说这件事本身：<b>分类是人划的</b>。',
 ...
 {n:'03', t:'一句话机制（role ＋ metabolism 在这里被交代掉）',
  ...
  note:'<b>这一格是整张卡的脊梁</b>，后面每一条都是它的注脚。书 p043 对辅酶的功能定义要背下来：<i>Koenzymy obvykle fungují jako intermediární přenašeče funkčních skupin, atomů nebo elektronů</i> —— <b>基团、原子或电子的中间搬运工</b>。英文：“The textbook says a coenzyme is an intermediate carrier of the functional group, the atoms or the electrons that the reaction moves.”<br>所以链条是<b>单向</b>的：<b>食物里的维生素 → 细胞把它改造成辅酶 → 辅酶搬那个基团</b>。这条链说清楚了，「role」就答完了。<span class="pg">p043</span>'},
 ...
 {n:'04', t:'投入',
  ...
  note:'书 <span class="pg">p168</span> 原话：<i>Jako kofaktory se při tomto ději účastní thiamindifosfát, lipoová kyselina a koenzym A. V regeneraci lipoové kyseliny pak dále participují FAD a konečně NAD.</i> 三个酶的名字书也给了：<b>pyruvátdehydrogenasa · dihydrolipoyltransacetylasa · dihydrolipoyldehydrogenasa</b>。'},
 {n:'05', t:'产出',
  ...
  note:'书 <span class="pg">p168</span> 的式子：<code>pyruvát + NAD⁺ + CoA = acetyl-CoA + CO₂ + NADH + H⁺</code>。三个 ATP 在 <span class="pg">p169</span>。<b>这条直接接卡 24（柠檬酸循环）和卡 25（呼吸链）</b>——他多半会顺着走过去。'},
 {n:'06', t:'总结（净账）',
 ...
 {n:'07', t:'书的表，原样',
  ...
  tbl:{head:['koenzym','přenášená skupina','vitamin'],
       rows:[['NAD⁺','H⁺, e⁻','nikotinová kyselina'],
             ['NADP⁺','H⁺, e⁻','nikotinová kyselina'],
             ['FMN','H⁺, e⁻','riboflavin (B₂)'],
             ['FAD','H⁺, e⁻','riboflavin (B₂)'],
             ['Koenzym Q','H⁺, e⁻','—（空）'],
             ['TPP','aldehyd','thiamin'],
             ['Koenzym A','acyl','panthothenová kyselina'],
             ['Lipoamid','acyl, H','—（空）'],
             ['Biotin','CO₂','biotin (H)'],
             ['Pyridoxalfosfát','–NH₂','pyridoxin (B₆)']]},
  note:'<b>这张表的正文 OCR 出来是空的，上面十行是回 300 dpi 原图一行一行读出来的。</b>书自己在表下注了一句：<i>Zkratky jsou vysvětleny v následujícím textu.</i>（缩写在后文解释）。<br><b>两个要注意的地方</b>：① NAD/NADP 那一栏书写的维生素是 <b>nikotinová kyselina（烟酸）</b>，而辅酶里带的那个环是 <b>nikotinamid（烟酰胺）</b>——<b>维生素和它变成的东西不是同一个分子，这张表第一行就在演示这件事</b>。② <b>Koenzym Q 和 Lipoamid 两行的 vitamin 栏是空的</b>，见速背 19。<span class="pg">p043</span>'},
 ...
 {n:'10', t:'Coenzyme A · 搬酰基',
  ...
  note:'<span class="pg">p050</span>。<b>「为什么偏偏是硫酯」值得顺手答掉</b>：硫的孤对电子跟羰基的共轭比氧差得多，所以硫酯没有普通酯那种共轭稳定化，<b>酰基随时可以被交出去</b>。这是台面化学，可以答（见 LOGIC §5）。书给的是「非常活泼」和「高能」两个说法，<b>原因是通用的</b>。<br><b>同一个磷酸泛酰巯基乙胺还在另一个地方出现</b>：书 <span class="pg">p188</span> 说脂肪酸合成的 <b>ACP</b> 上那个 SH 就是 fosfopanthetein 的，跟 CoA 里的是同一段。<b>说出这一句，脂肪酸合成那道题就接上了。</b>'},
 {n:'11', t:'TPP · 搬醛',
  ...
  note:'<span class="pg">p050</span>。<b>Mg²⁺ 那半句要说</b>——它是全卡唯一一处「维生素和矿物质在同一个活性中心里协作」的书面证据，正好把题面两半缝在一起。<br>书还说清了 thiamine 的结构：<b>一个取代嘧啶用亚甲基桥连一个取代噻唑</b>，活性形式再带一个焦磷酸（二磷酸）基团。书顺带更正了自己的用词：<i>Thiamindifosfát (TPP) — správněji thiamindifosfát</i>，<b>即缩写沿用 pyrofosfát 的 P，名字该叫二磷酸</b>。'},
 {n:'12', t:'Biotin · 搬 CO₂',
  ...
  note:'<span class="pg">p049</span> <span class="pg">p169</span> <span class="pg">p188</span>。书 p188 把那个反应式整个印出来了：<code>CO₂ + acetyl-CoA + ATP → ⁻OOC-CH₂-CO-SCoA + ADP + Pᵢ</code>，酶是 <b>acetyl-CoA karboxylasa</b>，条件写着 <b>Mn²⁺ 和 biotin</b>。p169 的糖异生图上，丙酮酸到草酰乙酸那一箭头下面写的也是 <b>biotin</b>。<br><b>「异肽键」就地交代</b>：肽键连的是 α 羧基和 α 氨基；异肽键连的是<b>侧链</b>上的那一个，这里是赖氨酸的 ε-氨基。',
 ...
 {n:'14', t:'表外还有一批，正文里',
  ...
  note:'tetrahydrolistová <span class="pg">p048</span> <span class="pg">p049</span>；adenosylmethionin <span class="pg">p048</span>；biopterin <span class="pg">p047</span>；B₁₂ <span class="pg">p053</span>；ATP <span class="pg">p051</span>；UDP、CDP <span class="pg">p052</span>。<br><b>ATP 那一条在这道题里特别有用</b>：书专门开了一小节叫 <i>d) ATP jako koenzym</i>——<b>一个「辅酶」完全不来自维生素，而它的磷酸来自一个矿物质（磷）</b>。题面的两半在这里第二次碰头。<br><b>B₁₂ 是「矿物质住在维生素里」的例子</b>：钴是 mikrobiogenní 那一档的元素（p011），而它的位置在 korrin 环中央——书说这个环<b>像血红蛋白里的卟啉，只是有两个吡咯环直接相连、没有次甲基桥</b>。B₁₂ 的结构 <b>1957 年才弄清</b>，这个年份是书给的。',
 ...
 {n:'15', t:'A · D · E · K',
  big:'<b>书从不说「脂溶性维生素」这四个字</b>，但它把 A D E K 全放进 <b>terpeny（isoprenoidy）</b> 一节，并且说 <b>fytol 是维生素 K 亲脂性的原因</b>。分类的依据在这里，不在溶解度表上',
  ...
  note:'<span class="pg">p183</span> <span class="pg">p184</span> <span class="pg">p185</span> <span class="pg">p186</span>。书给的具体数：<b>vitamin K₁ 是 fylochinon，n = 4；K₂ 是 menachinon，n = 8</b>；这一族异戊二烯单元<b>通常 4–10 个</b>。胆固醇是维生素 D 的前体（p185），而 <b>7-脱氢胆固醇经紫外线开 B 环得到 cholekalciferol ＝ 维生素 D₃</b>（p186）。<b>「在皮肤里」这半句书没说，是通用知识。</b><br><b>「水溶性／脂溶性」这个分类本身书里没有</b>——但书用 <i>lipofilní</i> 形容维生素 K（p183）。<b>老实说出这件事比装作书有更稳</b>：“This textbook never names the two classes. It separates them by putting them in two different chapters, and it says the phytol tail is what makes vitamin K lipophilic.”',
 ...
 {n:'16', t:'催化金属 vs 电解质',
  ...
  note:'<span class="pg">p043</span>（已回 300 dpi 原图逐字核过）与 <span class="pg">p012</span>。<b>电解质那一栏的名单，被追问再给</b>：“The chief cations are sodium, potassium, magnesium and calcium. The chief anions are chloride and the oxygen-containing anions, above all phosphate.”<b>书还给了金属离子在酶里的三种角色，这是「role」那个词在矿物质这一半的正面回答</b>：<i>jako součást aktivního centra, jako můstky pro vazbu substrátu na enzym, nebo jako prvek stabilizující prostorovou strukturu</i> —— <b>① 活性中心的一部分 ② 把底物拴到酶上的桥 ③ 稳定酶的空间结构</b>。英文：“The textbook gives metal ions three roles in an enzyme. They can be part of the active centre. They can bridge the substrate onto the enzyme. Or they can stabilise the spatial structure of the molecule.”<br><b>⚠ 书写的是 Mn²⁺（hexokinasa）</b>，通用写法里己糖激酶用的是 <b>Mg-ATP</b>。按书报，被追问就说通用写法不同。书另一处（<span class="pg">p037</span>）还给了 <b>carboxypeptidasa – Zn²⁺</b> 和 <b>xanthinoxidasa – 钼</b>。<br><br><b>=== 公式和推导（背之前先看懂这一段） ===</b><br><b>书给的比例</b>（<span class="pg">p012</span>）：细胞外液里主要阳离子的<b>原子比</b> <code>Na : K : Ca ≈ 100 : 2 : 2</code>，而且书说这个比例在不同生物里<b>出奇地恒定</b>，并且<b>接近海水的组成</b>。<br><b>符号</b>：这是<b>原子数之比</b>，不是浓度的绝对值，也不是质量比。<br><b>三步读它</b>：<br>① 归一到 Na：<code>K / Na = 2 / 100 = 0,02</code>，<code>Ca / Na = 0,02</code>。<b>钾和钙各只有钠的 1/50。</b><br>② 反过来：<code>Na / K = 50</code>。<b>细胞外每有五十个钠，才有一个钾。</b><br>③ 而细胞<b>内</b>正好相反，钾多钠少——<b>这一半书里没有，是通用知识</b>，别报具体数，报判据：「梯度的方向是反的，维持它要花 ATP」。<br><br><b>=== 一句话理解 ===</b><br><b>100 : 2 : 2 不是一个生理常数，是一份化石。</b>书自己把结论说出来了：这暗示<b>海洋环境在生命起源或早期演化里起过重要作用</b>。细胞没有重新发明自己的外环境，它<b>把一小滩海水包了起来带走</b>，然后花能量在膜两侧维持一个反过来的内环境。<br>所以「电解质在代谢中的作用」可以答成一句话：<b>它们本身不参加反应，它们定义了反应发生在什么介质里</b>——离子强度、pH 缓冲、膜两侧的电位差，以及 ATP 花在维持这些差上的那一份。'},
 {n:'17', t:'铁 —— 拿它当走读的例子',
 ...
 {n:'19', t:'辅酶不是维生素',
  ...
  note:'<b>这是这张卡的核心陷阱，考官一定会让你说出区别。</b>三句话的层次要清楚：① 维生素是<b>营养学</b>的范畴，判据是「必须从食物来」；② 辅酶是<b>酶学</b>的范畴，判据是「酶的非蛋白有机部分，搬基团」；③ <b>两者的关系是前体和产物</b>，而且不是一一对应——烟酸一个维生素对应 NAD 和 NADP 两个辅酶，核黄素一个对应 FMN 和 FAD 两个。<br><b>Q 和硫辛酸人体能自己做，所以不是维生素</b>——<b>这半句书里没有，是通用知识</b>；书只留了两个空格。但书给了 Q 的来路：<span class="pg">p183</span> 说 <b>辅酶 Q 的疏水链跟维生素 K₂、维生素 E 一样，生化上出自 fytol</b>，那是异戊二烯的路线。',
...
['<b>表</b>：Tab. 3.1 三列 —— <b>辅酶 · 搬什么 · 哪个维生素</b>',
...
segs:[
 ...
 {tag:'段 4 · 留口子', h:'主动给他一个抓手，而且落在她的主场：配位、竞争洗脱、Kd',
  ...
  note:'<b>段 4 必须落在主场，这一段落在 Kd 和纯化上</b>——两样她都答得住（见 LOGIC §4 的 IMAC 复盘）。<br><b>为什么这条桥是安全的</b>：配位键、咪唑竞争洗脱、EDTA 剥金属，全部是「台面上能看见或能量到」的化学，按 LOGIC §5 该答；再往下（哪个空轨道、八面体、d 电子数）才是停止线。<b>他顺着走，你走到卡 02（Kd）；他往下钻，你有一句现成的停止句。</b><br><b>最后那句「热稳定」是书给的</b>（p043：<i>kofaktory enzymů jsou tepelně stabilní, zatímco proteinová část molekuly enzymu ne</i>），而且它同时是⑤那一格的钥匙——见追问「怎么证明一个酶需要辅酶」。'}
],
...
{q:'Name the coenzymes and say which vitamin each one comes from.',
 mean:'<b>这是书的 Tab. 3.1 逐行背</b>。他问得出这句，说明他脑子里就是这张表。',
...
{r:'中', q:'What is a metalloenzyme?',
 ...
 cn:'<span class="pg">p043</span>（已回 300 dpi 核过）与 <span class="pg">p037</span>。<b>⚠ 书写 hexokinasa 是 Mn²⁺</b>，通用写法是 <b>Mg-ATP</b>。按书报，被追问说明差别：“The book prints manganese for hexokinase. The generally taught cofactor there is magnesium, as the Mg-ATP complex.”'}
]},
...
{r:'中', q:'Why iron? Why not some other metal?',
 ...
 cn:'<span class="pg">p046</span>。再给一句就够：“Haem and an iron-sulfur cluster are two different surroundings for the same atom, and they sit at different points on the scale.”<br><b>「换配体就换电位」这一句是能答的台面化学</b>（LOGIC §5）；再往下问哪个轨道、什么场强，就用停止句。<b>电位这条线直接走进卡 25 的 Tab. 6.2。</b>'}
]},
...
{r:'实测', q:'So a coenzyme is a vitamin?',
 ...
 cn:'<b>这是这张卡的头号陷阱。</b>证据不用外借：书自己的 Tab. 3.1 里 <b>Koenzym Q 和 Lipoamid 两行的 vitamin 栏是空的</b>（<span class="pg">p043</span>，已回原图核过）。<b>「人体自己能做这两个」是通用知识，书只留了空格</b>，说的时候分清楚。<br>反方向也别说错：<b>不是所有维生素都变辅酶</b>——A 和 D 都不是。所以准确说法是 “most of the water-soluble vitamins are precursors of coenzymes”。'},
...
{r:'高', q:'Is coenzyme Q a vitamin?',
 ...
 cn:'<span class="pg">p043</span>（空格）与 <span class="pg">p183</span>（fytol 来源）。<b>「人自己能合成 Q，所以它不是维生素」这句推论要标成自己的推论</b>，书只给了空格和来源。<b>Q 在呼吸链里的位置见卡 25</b>：书 p045 说它在<b>黄素蛋白和细胞色素之间当中间人</b>。'},
...
{r:'高', q:'Which of these show up in the citric acid cycle and the respiratory chain?',
 ...
 cn:'卡 24 与卡 25。<b>2-氧代戊二酸走同一个机制是书说的</b>（<span class="pg">p138</span> <span class="pg">p169</span>）：<i>Oxidační dekarboxylace kyseliny 2-oxoglutarové se uskuteční mechanismem oxidační dekarboxylace</i>。<b>说出「同一个机制」比再背一遍五个辅因子有用。</b>'},
{r:'中', q:'Where does biotin appear in fatty acid metabolism?',
 ...
 cn:'<span class="pg">p188</span>。<b>最后那一句是分</b>：书自己把 ACP 的那个巯基指回 CoA（<i>též součást molekuly CoA — viz kap. 3.2.1</i>）——<b>第三章和第八章被书自己缝在了一起，跟着缝。</b>'},
