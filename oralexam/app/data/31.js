...
cram:[
 ...
 {n:'11', t:'TPP · 搬醛',
  big:'来自 <b>thiamine（B₁）</b>。书给两类反应：<b>α-酮酸的脱羧</b>（裂合酶）和<b>转酮醇酶反应</b>（转移酶）。醛基挂在<b>噻唑环的 C-2</b> 上，反应常常还要 <b>Mg²⁺</b>',
  en:'“Thiamine diphosphate comes from thiamine, vitamin B-one. The textbook gives it two classes of reaction. One is the decarboxylation of two-keto acids, which are lyase reactions. The other is the transketolase reaction, which transfers acetaldehyde or glycolaldehyde. The transferred aldehyde group binds to carbon two of the thiazole ring. Those reactions often need magnesium ions as well.”',
 ...
 {n:'14', t:'表外还有一批，正文里',
  ...
  warn:'<b>抗坏血酸（维生素 C）在书里根本不在辅酶这一章</b>，它在糖化学那一章的「糖酸」一节（<span class="pg">p152</span> <span class="pg">p153</span>），书只说它<b>作为抗坏血病的维生素被分离出来</b>、是个内酯、含<b>烯二醇</b>结构因而<b>强还原性</b>，脱氢就变脱氢抗坏血酸。<b>它的代谢角色要到 p112 才出现</b>——胶原的脯氨酸和赖氨酸羟化，需要氧、α-酮戊二酸、<b>L-抗坏血酸和 Fe²⁺</b>。见速背 19 下面的便装问题。'},
...
{q:'Why do we need vitamin C?',
  ez:'“Because collagen cannot be finished without it. After translation three hydroxylases act on collagen. They sit in the cisternae of the endoplasmic reticulum. They hydroxylate proline and lysine residues. This textbook says the reaction needs four things. Oxygen. Alpha-ketoglutarate. L ascorbic acid. And iron two plus ions. Without the hydroxyproline the triple helix is unstable. And that is scurvy. Chemically ascorbic acid is a sugar acid. It is strongly reducing.”',
  ezcn:'因为<b>没有它，胶原做不完</b>。<b>翻译之后，内质网腔里三个特异的羟化酶把胶原上的脯氨酸和赖氨酸残基羟化，而书说这个反应需要四样：氧气 · α-酮戊二酸 · L-抗坏血酸 · Fe²⁺。</b><b>没有羟脯氨酸，胶原三螺旋就不稳定——那就是坏血病。</b><b>化学上抗坏血酸是一个糖酸，一个带烯二醇基的内酯；像所有烯二醇一样还原性很强，交出氢就变成脱氢抗坏血酸。</b>⚠ <b>「它在那里的作用是让羟化酶的铁保持还原态」是通用解释，书只说这四样都必需。</b>', odd:1,
 mean:'<b>听起来完全不像生化题，答案却整段在书里。</b>LOGIC §9 点名要有这一条。注意书把抗坏血酸放在糖那一章，不在辅酶那一章。',
 say:'“Because collagen cannot be finished without it. After translation, three specific hydroxylases in the cisternae of the endoplasmic reticulum hydroxylate proline and lysine residues of collagen, and this textbook says the reaction needs oxygen, alpha-ketoglutarate, L-ascorbic acid and iron two-plus ions. Without the hydroxyproline the collagen triple helix is unstable, and that is scurvy. Chemically ascorbic acid is a sugar acid, a lactone with an endiol group, and like all endiols it is strongly reducing. It gives up hydrogen and becomes dehydroascorbic acid. So its job there is to keep the iron of the hydroxylase in the reduced state.”',
...
{r:'中', q:'Where does biotin appear in fatty acid metabolism?',
 ...
 cn:'<span class="pg">p188</span>。<b>书印的就是这条式子，箭头下面标着锰和生物素</b>：<br><code>acetyl-CoA ＋ HCO₃⁻ ＋ ATP →[acetyl-CoA carboxylase|Mn²⁺ · biotin] malonyl-CoA ＋ ADP ＋ Pᵢ</code><br><b>这是脂肪酸合成的承诺步骤</b>，也是生物素在这条路上唯一露面的地方。<br><br><b>最后那一句是分</b>：书自己把 ACP 的那个巯基指回 CoA（<i>also a part of the CoA molecule — see chapter 3.2.1</i>）——<b>第三章和第八章被书自己缝在了一起，跟着缝。</b>'},
