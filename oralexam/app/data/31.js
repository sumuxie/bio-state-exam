...
cram:[
 ...
 {g:'水溶性维生素 → 辅酶', gn:'<b>🪄 邪修记法</b>（维生素 → 辅酶 → 搬什么，按书表的顺序）：<b>烟酸</b> → NAD/NADP 搬氢 · <b>核黄素</b> B₂ → FMN/FAD 搬氢 · <b>硫胺素</b> B₁ → TPP 搬醛 · <b>泛酸</b> → CoA 搬酰基 · <b>生物素</b> → 搬 CO₂ · <b>吡哆醇</b> B₆ → PLP 搬氨基。英文首字母 “<b>N</b>ice <b>R</b>ats <b>T</b>ake <b>P</b>ills <b>B</b>efore <b>P</b>arties” ＝ Niacin · Riboflavin · Thiamine · Pantothenate · Biotin · Pyridoxine。<br>书的 <b>Table 3.1</b> 就是这一组的骨架：<b>辅酶 · 搬什么 · 来自哪个维生素</b>，三列。每一行只要三件事：<b>叫什么 · 搬什么基团 · 在哪个反应里见过</b>。结构式不用背（她有专门的 app）。'},
 {n:'07', t:'书的表，原样',
