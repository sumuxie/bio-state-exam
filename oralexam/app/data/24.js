...
{r:'中', q:'Why store the energy as NADH instead of making ATP directly?',
 ...
 cn:'书 p134–p135 给了根据：能量的生成和消耗都是「量子化」的，机体只能以约 30 kJ/mol 的份额（一个 ATP）捕获能量。比原来那句「在膜上统一结算」有书可依。<br><br><b>=== 公式和推导（背之前先看懂这一段） ===</b><br><b>式子</b>：<code>ΔG°′ = −nFΔE°′</code>（书 p135）· <code>一个 ATP ≈ 30 kJ/mol</code>（书 p135–p136 说的那个「量子」）<br>n 是转移的电子数 · F 是法拉第常数，一摩尔电子带的电量 <code>≈ 96,5 kJ·V⁻¹·mol⁻¹</code> · ΔE°′ 是两端的电位差。<br><br><b>三步推导</b>（一次烧完到底浪费多少）：<br>① NADH 那一端的电位是 <b>−0,32 V</b>，氧那一端是 <b>+0,82 V</b>（书 Tab. 6.2，p135）：<code>ΔE°′ = 0,82 − (−0,32) = 1,14 V</code>。<br>② 一个 NADH 交出<b>两个</b>电子，n = 2：<code>ΔG°′ = −2 × 96,5 × 1,14 ≈ −220 kJ/mol</code>。<br>③ 而细胞一次只装得下约 <b>30 kJ</b>（一个 ATP）：<code>220 ÷ 30 ≈ 7</code> 份。按书的 3 个 ATP 算，实收 <code>3 × 30,5 ≈ 91 kJ</code>，约 <b>40%</b>。<br><br><br><b>=== 一句话理解 ===</b><br>一步烧完，等于拿一个 <b>30 毫升的杯子</b>去接 <b>220 毫升</b>的水：接住 30，洒掉 190。<br><b>把落差切成一串台阶，不是为了慢，是为了让每一级的落差正好装得进一个杯子。</b>NADH 的作用就是先把电子<b>停在半路</b>（−0,32 V 这个高度），等膜上有台阶了再一级一级放下去。<br>这也顺带解释了为什么全代谢里<b>没有任何一步是「NADH → ATP」</b>：两边的货币不一样（这边流通电子，那边流通磷酸基），中间必须换一次汇，而那个汇就是质子梯度。<br>⚠ <code>−220</code> 和 <code>40%</code> 是拿书的表和书的式子<b>算出来的，书没有印</b>——报的时候带一句「按你这本书的数算下来大约」。'}
]},
