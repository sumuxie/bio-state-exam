...
cram:[
 ...
 {n:'02', t:'题面里的词',
  ...
  en:'“The question asks for the <b>different types</b> of lipids and their <b>roles in the body</b>, so two lists first. The <b>types</b>: structurally the textbook makes three groups — <b>simple</b>, <b>complex</b>, <b>derived</b> — and its table splits those into eleven classes by what each gives on hydrolysis. The <b>roles in the body</b>, its own five: a <b>component of biological membranes</b>; the <b>main storage form of carbon and energy</b>; <b>precursors of vitamins, hormones and regulatory substances</b>; an <b>insulating barrier against thermal, electrical or other physical shock</b>; and a <b>protective coat against infection and dehydration</b>.”',
 ...
 {n:'03', t:'归类 · 书的表',
  ...
  en:'“The table classifies by hydrolysis products. <b>Simple</b>: acylglycerols — glycerol and fatty acids; waxes — a long-chain alcohol and long-chain fatty acids. <b>Complex</b>, five classes: glycoacylglycerols — sugar, glycerol, fatty acids; phosphoacylglycerols — glycerol, fatty acids, phosphate and an organic compound; sphingomyelins — sphingosine, fatty acids, phosphate, choline; cerebrosides — sphingosine, fatty acids, sugars; gangliosides — the same plus sialic acid. <b>Derived</b>: four classes with no hydrolysis products listed at all, because they are not esters.”',
 ...
 {n:'08', t:'简单脂 · 三酰甘油与蜡',
  ...
  en:'“<b>Acylglycerols are esters of the trihydric alcohol glycerol and fatty acids</b> — an <b>ester</b> being the bond between an <b>acid</b> and an <b>alcohol</b>, formed with loss of water; triacylglycerols are commonest, and having <b>no ionisable group</b> they are <b>neutral lipids</b> — <b>fats</b> when solid at room temperature, <b>oils</b> when liquid. Three jobs in the textbook: in <b>adipose tissue</b> the store of carbon and energy, into which excess dietary carbon — above all sugars — is converted; in <b>chylomicrons</b> the transport form; and <b>insulation and physical protection</b> of organs. <b>Waxes</b> esterify a <b>long-chain alcohol</b> instead of glycerol: completely insoluble, <b>not attacked by lipases</b>, and they waterproof surfaces.”',
  ...
  good:'<b>第二层（为什么存脂不存糖原）</b>：“The textbook’s figures for complete oxidation are <b>minus eleven thousand three hundred and forty kilojoules per mole for palmitic acid against minus two thousand eight hundred and seventy for glucose</b>; divided by the molar masses, about <b>forty-four kilojoules per gram against sixteen</b>. A fatty acid is a chain of CH₂ groups with no oxygen — it is <b>more reduced</b>. And generally fat is stored <b>anhydrous</b>, glycogen hydrated.” 两个摩尔数是书印的（<span class="pg">p135</span>）；<b>每克的数是除出来的，说时要把除法说出来</b>。同一条在<b>卡 24</b>。'},
 {n:'09', t:'甘油磷脂',
 ...
 {n:'18', t:'留口子',
  ...
  en:'“The place I meet this chapter is the first step of every purification. To get a protein out of yeast or <i>E. coli</i> I have to take a membrane apart, and what I add is a <b>detergent</b> — the same design as a phospholipid, a hydrocarbon tail and a polar head, so it competes for the tails and breaks the bilayer up. Which detergent matters: a mild non-ionic one leaves the protein folded, a strongly ionic one unfolds it. And from a Gram-negative host there is a second lipid to think about, the <b>lipid A</b> part of the outer-membrane <b>lipopolysaccharide</b>, which sticks to the protein and has to be removed.”',
...
['<b>鞘脂</b>：脂肪酸走<b>氨基 → 酰胺键 → ceramide</b>；＋磷酰胆碱（酯键）= 鞘磷脂；＋糖（O-糖苷键）= 糖鞘脂',
 '“Although sphingosine has two hydroxyls, the fatty acid binds through the amino group — an amide bond — giving a ceramide. Phosphorylcholine by an ester bond gives sphingomyelin; a sugar by an O-glycosidic bond gives the glycosphingolipids, and a ganglioside always contains at least one sialic acid.”',
 'p181–p182。ceramide 是共同核心，先说它再分叉。'],
['<b>胆固醇 ＋ 萜类</b>：甾烷骨架 ＋ C-3 羟基 = 固醇，占膜脂 <b>0–40%</b>，<b>增加刚性</b>，是胆汁酸、性激素、维 D 的前体；维生素 A D E K、辅酶 Q 都是异戊二烯类',
 '“Cholesterol is zero to forty per cent of membrane lipids, and because the steroid skeleton is inflexible it contributes significantly to rigidity; it is the precursor of the bile acids, the sex hormones and vitamin D. Practically all the other derived lipids are terpenes built from isoprene — vitamins A, D, E and K, and coenzyme Q.”',
...
segs:[
 {tag:'段 1 · 定义', h:'定义、为什么只能这样定义、三大组、五条功能 —— 一口气',
  p:['“A lipid is defined by a property rather than by a structure. The textbook’s definition: all natural nonpolar compounds that are almost or completely insoluble in water but soluble in other, nonpolar, organic solvents — chloroform, ethanol, ether. And it says immediately why: because lipids are so diverse in structure and in function that no more exact definition of this varied set of biologically active substances can be formulated. That is unusual — proteins, nucleic acids and carbohydrates are all defined by a shared skeleton and a shared bond, and lipids are not.',
     'The written question asks for the different types of lipids and their roles in the body, so let me put both lists down first. The types: structurally the textbook makes three main groups — simple, complex and derived — and its table splits those into eleven classes, each defined by what it gives on hydrolysis.',
     'The roles in the body, as the textbook opens the chapter: lipids are a component of biological membranes; the main storage form of carbon and energy; precursors of other important substances — vitamins, hormones and regulatory substances; an insulating barrier against thermal, electrical or other physical shock; and a protective coat of organisms and cells against infection and dehydration.”'],
 ...
 {tag:'段 2 · general · 怎么分', h:'脂肪酸是穿起来的那根线，然后三大组一组一句',
  p:['“The thread through the first seven classes is the fatty acid: many-carbon aliphatic monocarboxylic acids, and the textbook says it is their marked hydrophobicity that makes the whole lipid molecule hydrophobic. In nature they are linear, with an even number of carbons, twelve to twenty-four, and the double bonds are mostly cis. Saturated ones raise the melting point, unsaturated ones lower it — which is the whole difference between a fat and an oil. Two are essential in the mammalian diet: linoleic acid, eighteen-two n-six, and alpha-linolenic acid, eighteen-three n-three.',
     ...
     'Derived lipids are everything that cannot be put in the first two groups, and practically all of them are terpenes, built from the isoprene unit: the steroids, with cholesterol, the carotenoids, the prostaglandins, and the fat-soluble vitamins A, D, E and K.”'],
  note:'<b>三个自然停顿点</b>：脂肪酸说完、简单脂说完、复合脂说完。他在任何一处插进来，你都还在自己的框架里。<b>时间紧就把衍生脂那段压成一句</b>——他要细节会自己问。'},
 {tag:'段 3 · 稍展开', h:'从两亲性一路走到膜 —— 他最可能挖的方向',
  p:['“The most interesting of those is the complex lipids, because of one property the textbook gives a name to. A phospholipid has two clearly different regions: a nonpolar hydrophobic one, the fatty acids, and a polar hydrophilic one, the glycerol, the phosphate and the head group. The textbook calls this dual character amphipathy. A triacylglycerol is barely amphipathic at all — it has no head — and that one difference decides what the molecule can build: a lipid with only tails becomes a store, a lipid with a tail and a head becomes a surface.',
 ...
 {tag:'段 4 · 留口子', h:'落到你每天拆的那层膜',
  p:['“The place I actually meet this chapter is the first step of every purification. To get a protein out of yeast or <i>E. coli</i> I have to take a membrane apart, and what I add is a detergent — a molecule with exactly the design we have been describing, a hydrocarbon tail and a polar head, which competes for the tails and breaks the bilayer up. Which detergent matters: a mild non-ionic one leaves the protein folded, a strongly ionic one unfolds it, and the textbook does list detergents with urea and guanidine as chemical denaturants. It also explains why some proteins come off easily and others do not: peripheral proteins interact only with the polar heads and can be released fairly simply, while integral proteins are held by hydrophobic interaction between their nonpolar side chains and the fatty-acid tails.”'],
...
why:{
 rungs:[
  ...
  ['那为什么是片，不是球？','<b>形状。</b>通用：一条尾巴的两亲分子（肥皂）像个锥，锥堆成球 = <b>胶束</b>；两条尾巴的磷脂接近圆柱，圆柱只能铺成<b>平片</b>，而片会自己合拢成囊，因为边缘会把尾巴露给水。“Generally, one tail makes a cone and gives a micelle; two tails make a cylinder and give a sheet, which closes on itself because an edge would expose the tails.” <b>书只给双层，不给这个几何理由——说 generally。</b>']
 ],
 stop:{lbl:'停 · 落在热力学',
...
{q:'Why does soap get grease off your hands?', odd:1,
 ...
 say:'“Because soap is amphipathic in exactly the way a phospholipid is — a hydrocarbon tail and a polar head; amphipathy is the textbook’s word for that dual character. The tails bury themselves in the grease, which is triacylglycerol and has no polar part at all, and the heads stay in the water, so the grease ends up in a particle with a water-friendly outside. Generally that particle is a micelle. The same trick unfolds proteins: the textbook lists detergents with urea and guanidine as chemical denaturants, because the tails get in between the nonpolar side chains and take away the hydrophobic effect holding the core together.”'},
...
{q:'Why is cholesterol both necessary and dangerous?', odd:1,
 ...
 say:'“Necessary for two reasons the textbook gives: cholesterol is up to forty per cent of the lipids of a membrane and, the steroid skeleton being inflexible, it sets the membrane’s rigidity; and it is the primary precursor of the bile acids, the sex hormones and vitamin D. Dangerous because of the exit: the textbook says terpenoids including steroids are generally not metabolised as a source of energy and carbon, and that cholesterol leaves the body only after conversion to bile acids — there is no way to burn it. It names the control point itself, HMG-CoA reductase, followed in medicine in connection with the therapy of atherosclerosis. That the drugs inhibiting it are the statins is general.”'},

{q:'Why do polar bears have a thick layer of fat under the skin?', odd:1,
 mean:'一次命中书的<b>两条功能</b>（第 2 和第 4 条），而且能把能量密度带出来。',
 say:'“It does two of the textbook’s five jobs at once: the insulating barrier against thermal shock, and the main storage form of carbon and energy. Fat is the right material because it is so reduced: the textbook’s figures for complete oxidation are minus eleven thousand three hundred and forty kilojoules per mole for palmitic acid against minus two thousand eight hundred and seventy for glucose, which per gram — dividing by two hundred and fifty-six and one hundred and eighty — is about forty-four against about sixteen. And generally fat is stored without water while glycogen is hydrated.”'},

{q:'Why does someone who is starving smell of acetone?', odd:1,
 mean:'<b>酮体。</b>书 p195 把整条链写全了，包括气味和结局。',
 say:'“Because fatty acids are being burned faster than the acetyl-CoA can be used. The textbook says that in diabetes, in starvation or on a fat-rich diet acetyl-CoA is overproduced because not all of it can be used in the citrate cycle; the excess is converted in liver cells to HMG-CoA, part of which becomes acetoacetate. Acetoacetate is either reduced enzymatically to beta-hydroxybutyrate or decarboxylated non-enzymatically to acetone. When those pathways are abnormally active the products appear in the blood as ketone bodies, the blood pH falls — acidosis and ketosis — and, the textbook says, acetone is smelled on the breath.”'},
...
{q:'Why can you get fat from eating sugar, but not sugar from eating fat?', odd:1,
 ...
 say:'“Because both meet at acetyl-CoA but the traffic is one-way. Sugars go to pyruvate and then to acetyl-CoA, and when the cell’s energy demand is low acetyl-CoA is used mainly for fatty-acid and fat synthesis — so an excess of either nutrient is converted to fat and stored, the glycerophosphate for it coming from sugar metabolism. Going back is blocked: the textbook says the animal organism cannot convert acetyl-CoA to pyruvate, the starting compound for sugar synthesis, and therefore cannot make sugars from fats. Glycerol is the one exception — it is oxidised to a triose and enters carbohydrate metabolism.”'}
],
...
{r:'高', q:'Why is fat a better store than glycogen?',
 en:'“Because it is more reduced, and because it is dry. The textbook’s figures for complete oxidation: minus eleven thousand three hundred and forty kilojoules per mole for palmitic acid against minus two thousand eight hundred and seventy for glucose; divided by the molar masses, about forty-four kilojoules per gram against about sixteen. A fatty acid is a chain of CH₂ groups with no oxygen, while every carbon of glucose already carries one — more hydrogen to hand to NAD⁺ and FAD. Generally, fat is stored anhydrous and glycogen hydrated.”',
...
{r:'中', q:'How do we know a membrane is a bilayer and not a single layer?',
 en:'“Generally — the textbook gives the bilayer as a fact, not the evidence. The classical experiment, in the nineteen-twenties, was to extract the lipid from a known number of red blood cells, spread it as a single molecular layer on a water surface and measure the area: it came out about twice the total surface of the cells. The textbook’s own support is structural instead — two monolayers tail to tail, a nonpolar middle and two polar surfaces, three and a half to four nanometres, which is about two extended chains.”',
...
{r:'高', q:'How is a membrane built, and what holds it together?',
 en:'“Proteins and lipids, weight ratio one to four up to three to one, plus carbohydrates — always as glycoproteins or glycolipids — at half a per cent to ten per cent. The structure is the lipid bilayer: tails in contact with tails and heads with heads, the monolayers tail to tail, a markedly nonpolar middle and two polar surfaces, three and a half to four nanometres thick. And the textbook is emphatic: the interactions of heads and tails are <b>exclusively noncovalent</b>. The proteins are of two kinds — peripheral, interacting only with the polar heads and relatively easy to release, and integral, held by hydrophobic interaction with the fatty-acid tails.”',
...
{r:'高', q:'How is a fatty acid broken down?',
 en:'“By beta-oxidation, in the mitochondrial matrix, which the textbook says holds all four enzymes needed for one cycle. The acid is first activated to a thioester with coenzyme A by a thiokinase, costing one ATP. Then two carbons come off the carboxyl end per cycle, in four steps: dehydrogenation by acyl-CoA dehydrogenase with FAD, producing only trans isomers; hydration by enoyl-CoA hydratase, which requires trans and gives only L-isomers; dehydrogenation by beta-hydroxyacyl-CoA dehydrogenase with NAD⁺; and thiolytic cleavage with CoASH, releasing acetyl-CoA. Its example is stearic acid: eight cycles, nine acetyl-CoA, eight FADH₂ and eight NADH.”',
...
{r:'中', q:'What are the phospholipases?',
 en:'“The hydrolases that take phospholipids apart, and the textbook classifies them by which bond they cut, using phosphatidylcholine as the map: <b>phospholipase A one</b> takes the fatty acid off position one, <b>A two</b> off position two, <b>C</b> cuts between the glycerol and the phosphate, and <b>D</b> between the phosphate and the head group. Four names for four bonds on one molecule — which is also a compact way of saying what a phospholipid is made of.”',
