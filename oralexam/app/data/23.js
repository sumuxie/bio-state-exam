...
cram:[
 ...
 {n:'02', t:'题面里的词',
  ...
  ez:'“The question asks two things. It asks for the types. It also asks for the roles in the body. So I will give two lists. For the types, the textbook makes three groups. They are simple, complex and derived. Its table splits these into eleven classes. For the roles, the textbook gives five. One, lipids build biological membranes. Two, lipids are the main energy store. Three, lipids are precursors of regulatory molecules. Four, lipids insulate and protect. Five, lipids are pigments and vitamins.”',
