/* 卡 28 · What are the differences between C3, C4, and CAM plants?
   ...
   ⚠ 全书没有 CAM。grep 229 页：CAM / tučnolist / crassul 全部 0 命中（p053 p097 p108 p175 的 cam
      是 vitamin / cAMP / 序列噪音）。所以 CAM 那半张卡全部是通用知识，卡上逐条标 general。
   400 dpi 原图已核三处：① 图 9.8 确实画着 karbonátdehydratasa 把 CO₂ 变成 HCO₃⁻，
      PEP-karboxylasa 用的是 HCO₃⁻（正文却写 CO₂）——content/28_c4.md 里那条「待核」到此结清；
      ② 正文 "nižší K_m"（OCR 把 m 吃了）、"asi dvojnásobná"、"více než 100 druhů" 都是书印的；
      ③ 书把 kaktusovité rostliny (sukulenty) 列进 C-4，这是书与通用分类的冲突，卡上明说。
...
cram:[
 ...
 {n:'01', t:'定义 · C-3',
  ...
  en:'“A C-3 plant is a plant whose only route for fixing carbon dioxide is the <b>Calvin cycle</b> — the ring of enzyme reactions in the <b>stroma</b> of the chloroplast, the soluble space outside the thylakoid membranes, that builds sugar out of CO₂ using the ATP and NADPH the light reactions make. The enzyme that attaches the CO₂ is <b>rubisco</b>, ribulose-1,5-bisphosphate carboxylase/oxygenase, and it attaches it to a five-carbon sugar, ribulose-1,5-bisphosphate. The six-carbon product is unstable and immediately splits into <b>two molecules of 3-phosphoglycerate</b>, a <b>three-carbon</b> acid — and the textbook says it in one line: the first stable product of CO₂ fixation is 3-phosphoglycerate, a three-carbon compound, and the plants that use the Calvin cycle mechanism are named C-3 after it.”',
  note:'<b>这是书自己的命名句，可以逐字引</b>：<i>Prvním stabilním produktem fixace CO₂ je tedy 3-fosfoglycerát, tříuhlíkatá sloučenina, podle které se rostliny využívající mechanismus Calvinova cyklu nazývají rostliny C-3.</i><span class="pg">p210</span><br><b>「stroma」承重</b>——不交代它，「在叶绿体里」和「跟光反应分开」两句都立不住：书 p202 明写 <i>Ve stromatu chloroplastů, tedy vně thylakoidů, probíhá fixace a redukce CO₂</i>（固碳发生在基质，也就是类囊体之外）。<br><b>Calvin 循环本身不在这张卡上展开</b>，完整走读在卡 27（#27 光合作用）。这里一句话交代掉就走。<span class="pg">p202 p209 p210</span>'},
 {n:'02', t:'定义 · C-4',
  big:'<b>C-4 = 固两次</b>。第一次<b>不用 rubisco</b>：<b>PEP carboxylase</b> 在叶肉细胞先把碳挂到 <b>PEP</b> 上，第一个产物是四个碳的 <b>oxaloacetate</b>',
  en:'“A C-4 plant fixes carbon <b>twice</b>. The first fixation does not use rubisco and does not go through three-carbon intermediates. <b>PEP carboxylase</b> attaches inorganic carbon to <b>phosphoenolpyruvate</b> — PEP, the three-carbon compound carrying a phosphate on its enol oxygen, the last high-energy intermediate of glycolysis — and the first product is <b>oxaloacetate</b>, a <b>four-carbon</b> acid: hence C-4. Oxaloacetate is then converted either to <b>malate</b>, by reduction, or to <b>aspartate</b>, by transamination — swapping its keto group for an amino group. That four-carbon acid is carried into a <b>second cell type</b>, decarboxylated there, and the CO₂ it releases is handed to rubisco and the ordinary Calvin cycle.”',
  note:'书的命名句同样可以逐字引：1970 年 Hatch 和 Slack 发现有些植物走的路 <i>nevyužívá tříuhlíkaté meziprodukty, ale čtyřuhlíkaté sloučeniny malát (event. aspartát). Podle toho se tyto rostliny nazývají rostliny C-4.</i><span class="pg">p212</span><br><b>注意书的措辞是「不走三碳中间体，走四碳化合物」</b>，所以「C-4 这个名字数的是第一个产物的碳数」这句话有书作根据，不是我的推论。'},
 {n:'03', t:'定义 · CAM ＋ 三者的差别在哪',
  big:'<b>CAM = 同一套 C-4 化学，但把两步分在<u>时间</u>上，不是分在<u>空间</u>上</b>。<b>差别只有三件事</b>：先动手的是哪个酶、在哪儿、什么时候',
  en:'“A CAM plant runs the <b>same chemistry</b> as a C-4 plant, but separated in <b>time</b> instead of in <b>space</b>. CAM stands for <b>crassulacean acid metabolism</b>. At <b>night</b> the <b>stomata</b> — the adjustable pores in the leaf surface, the door CO₂ comes in by and water vapour goes out by — are open, and PEP carboxylase fixes CO₂ into oxaloacetate and then malate, stored as <b>malic acid</b> in the <b>vacuole</b>, the large fluid-filled sac that fills most of a plant cell. By <b>day</b> the stomata are shut, the malate is decarboxylated, and the CO₂ goes to rubisco <b>inside the same cell</b>. So the three differ in only three things — <b>which enzyme fixes first</b>, <b>where</b>, and <b>when</b>: C-3 one enzyme in one place; C-4 two cell types; CAM night against day.”',
  warn:'<b>CAM 这一段书里一个字都没有。</b>全书 229 页 grep 过：CAM、tučnolisté（景天科）、Crassulaceae 全部 0 命中。说的时候要主动标出来——“The textbook I studied from does not cover CAM separately; what I am giving you there is the standard account.” <b>主动说明出处，比被戳穿强得多。</b>',
 ...
 {n:'04', t:'光呼吸是什么',
  ...
  en:'“<b>Photorespiration is the reaction sequence that starts when rubisco adds O₂ to ribulose-1,5-bisphosphate instead of CO₂.</b> Rubisco has two activities, and the textbook says so in its full name: ribulose-1,5-bisphosphate <b>carboxylase/oxygenase</b>. Oxygenated RuBP breaks into one 3-phosphoglycerate, which is useful, and one <b>phosphoglycolate</b>, which is not; <b>phosphoglycolate phosphatase</b> hydrolyses that to glycolate and <b>glycolate oxygenase</b> — the textbook’s name for it; elsewhere it is usually called glycolate oxidase — makes glyoxylate. Those three enzymes are the ones the textbook names. It runs across three compartments — <b>chloroplast, peroxisome and mitochondrion</b>, the peroxisome being the small organelle that handles oxidations producing hydrogen peroxide. And the textbook makes two points: it is <b>competitive</b> with the Calvin cycle, because it uses the same substrate; and it looks <b>useless</b> — though the reasons are not fully clear, it probably protects the apparatus from <b>photooxidation</b> when CO₂ is short, and it supplies <b>glycine and serine</b>.”',
  note:'<b>书 §9.2 整节就是这一格</b>，它自己先给了最重要的界定：<i>liší se podstatně od respirace mitochondrií (dýchacího řetězce)</i>——<b>光呼吸跟线粒体的呼吸本质上不同</b>。又说 <i>většina rostlin… kyslík i spotřebovávat</i>（大多数植物在光照下一边放氧一边耗氧）。<br><b>⚠ 分清书说了什么</b>：「浪费碳和能量」<b>书没有明说</b>，书说的是「看起来完全没用」＋「跟 Calvin 循环竞争同一个底物」。要给结论就标 general：“In the standard account the plant loses carbon and spends ATP and reducing power recovering the rest; that accounting is not in this textbook.” <b>不要报比例</b>——书没有，而且这张卡别处已经说了「不给这个数」。<span class="pg">p212 p213</span>'},
 {n:'05', t:'为什么热和干的时候会更糟',
  ...
  good:'<b>书替你写好了 ④「为什么」这一格</b>，而且是自问自答：<i>Otázkou je, proč tyto rostliny fixují CO₂ prostřednictvím PEP a vzápětí opět CO₂ uvolňují… Důvodem je zvýšení účinnosti fixace CO₂ v oblastech s vysokou sluneční radiací, s vysokými teplotami a omezenou dodávkou vody.</i> 直接翻译成英文就是满分答案：“The textbook asks the question itself — why fix CO₂ through PEP only to release it again — and answers it: to raise the efficiency of CO₂ fixation where the sunlight is strong, the temperature high and the water supply limited.”<span class="pg">p212</span>',
  note:'⚠ <b>「温度本身也偏向加氧」这一层是通用知识</b>，书没说：温度升高时 CO₂ 在水里的溶解度比 O₂ 掉得快，而 rubisco 对 CO₂ 的相对选择性也随温度下降。要说就标 general：“Temperature also shifts it directly — CO₂ is less soluble than O₂ as it warms, and rubisco’s preference for CO₂ falls with temperature — though that part is not in this textbook.”<b>不要给具体数字</b>，书没有，编一个是这场考试里最危险的动作（见 LOGIC §11）。'},
 ...
 {n:'06', t:'先说两种细胞',
  ...
  en:'“The C-4 plant is built for this. Between the surface cells of the <b>epidermis</b> and the <b>vascular tissue</b> — the leaf’s plumbing, the veins that carry water and sugar — there are two layers of different cells: the <b>mesophyll cells</b> on the outside, which are the ones in contact with the air spaces of the leaf, and the <b>bundle-sheath cells</b>, a ring wrapped tightly around each vein. The textbook says exactly which does which: <b>the mesophyll cells fix CO₂ by the C-4 mechanism, and the bundle-sheath cells by the C-3 mechanism</b> — that is, with rubisco and the reactions of the Calvin cycle.”',
  note:'<b>这一句同时回答了最大的那个陷阱</b>（「C-4 是不是取代了 Calvin 循环」）。书的原文：<i>Mezofylové buňky fixují CO₂ mechanismem C-4, buňky pochev cévních svazků mechanismem C-3, tj. zapojením RuBPkarboxylasy a reakcemi Calvinova cyklu.</i><span class="pg">p212 p214</span>（跨页，OCR 断在中间，引的时候两页都报）<br><b>「维管束」承重</b>——不交代它，「鞘细胞包在外面」没有指称对象。<br>Kranz anatomy（花环结构）书里没有，<b>不要主动说</b>；他说了你听得懂就行：“That arrangement is called Kranz anatomy — a wreath of bundle-sheath cells around the vein — though the textbook does not use the name.”'},
 {n:'07', t:'第 1 步 · 固碳，而且用的是<b>碳酸氢根</b>',
  ...
  en:'“In the mesophyll cell, CO₂ from the air is first hydrated to <b>bicarbonate</b>, HCO₃⁻, by <b>carbonic anhydrase</b> — the textbook calls it <b>carbonate dehydratase</b>, the same enzyme. Then <b>PEP carboxylase</b> joins that bicarbonate to phosphoenolpyruvate, releasing inorganic phosphate, and the product is <b>oxaloacetate</b>. Two properties of PEP carboxylase matter, and the second is the whole point: it has a <b>lower Km</b> for its inorganic substrate than rubisco does, so it works at a CO₂ concentration where rubisco would be starved; and it has <b>no oxygenase activity at all</b> — its substrate is the charged bicarbonate ion, which O₂ cannot imitate, so it <b>cannot be fooled by oxygen</b> the way rubisco is.”',
  warn:'<b>书的正文和书的图在这里打架，两边都要知道。</b>正文 <span class="pg">p212</span> 写 <i>Primárním akceptorem CO₂ je fosfoenolpyruvát (PEP)</i>（受的是 CO₂）；<b>书自己的 Obr. 9.8</b>（<span class="pg">p214</span>，400 dpi 已核）却画着 <b>CO₂ →（karbonátdehydratasa）→ HCO₃⁻ → PEP-karboxylasa</b>，通用写法跟图一致。<br><b>怎么答</b>：“The textbook’s own figure 9.8 shows carbonate dehydratase making bicarbonate first, and PEP carboxylase using the bicarbonate — which is the standard account; the running text simply says CO₂.” <b>用这本书的一半打这本书的另一半</b>（LOGIC §14）。',
  note:'<b>「Km 低」是书说的</b>：<i>schopnost PEP-karboxylasy využívat nižší koncentrace CO₂ (nižší K_m), než vyžaduje RubisCO</i>（400 dpi 原图确认写的是 K_m，OCR 把下标 m 吃了）。<b>Km 是什么</b>他一问就落到卡 02 的主场——那里有完整答案，而且记得卡 02 的警告：书 p056 把 Km 读成亲和力，严格说它是 (k₋₁+k₂)/k₁。<span class="pg">p212 p214</span>'},
 {n:'08', t:'第 2 步 · 变成四碳酸，运过去',
  ...
  note:'<b>「载着走」这个说法是我给的画面，但每个零件都在书里</b>：两条去向、malátdehydrogenasa、NADPH、四碳化合物 malát (event. aspartát) 全是 <span class="pg">p212</span> 的字面。<br><b>malate 和 oxaloacetate 这两个名字她刚在卡 24 见过</b>——柠檬酸循环的第 7 和第 8 步。<b>同样两个分子，完全不同的差事</b>：那里是被氧化取电子，这里是当搬运工。这个对照本身就是一条现成的追问答案。'},
 {n:'09', t:'第 3 步 · 在鞘细胞里放出 CO₂',
  big:'<b>decarboxylating malate dehydrogenase</b>（书叫「苹果酸酶 jablečný enzym」）把 malate 拆成 <b>pyruvate ＋ CO₂ ＋ NADPH</b>。CO₂ 就放在 <b>rubisco 的鼻子底下</b>',
  ...
  note:'「jablečný enzym」＝ 苹果酸酶（malic enzyme），书图 9.8 就是这么标的，加了引号说明它是俗名。反应：malate ＋ NADP⁺ → pyruvate ＋ CO₂ ＋ NADPH。<br><b>这一格是答案的高潮，说的时候慢一点。</b>「把 CO₂ 放在 rubisco 鼻子底下」这句话说出来，他就知道你理解了这条路的目的，而不是在背步骤。<span class="pg">p214</span>'},
 {n:'10', t:'第 4 步 · 再生 PEP —— 这就是那笔额外开销',
  ...
  en:'“The pyruvate travels back to the mesophyll cell, and <b>pyruvate–phosphate dikinase</b> phosphorylates it back to PEP at the cost of ATP, which closes the cycle that regenerates the primary acceptor. The cost is bigger than it looks, and the textbook’s figure shows why: the reaction is <b>ATP plus inorganic phosphate going to AMP plus pyrophosphate</b> — the ATP is cut down to AMP, not to ADP, so <b>two</b> high-energy phosphate bonds are spent, not one. And the figure shows the pyrophosphate then being split to <b>two inorganic phosphates</b>, which pulls the reaction to completion and makes it effectively <b>irreversible</b>. So the price of delivering one CO₂ to rubisco this way is about <b>two extra ATP equivalents</b>.”',
  note:'<b>这笔账是从书自己的图上读下来的，不是我编的</b>：Obr. 9.8 左边写着 <i>ATP + Pᵢ → AMP + PPᵢ</i>，上面一支箭标着 <i>2Pᵢ</i>。400 dpi 原图已核。<span class="pg">p214</span><br>正文只说 <i>za spotřeby ATP</i>（消耗 ATP），没说几个——<b>所以「两个」这个数要说清楚是从图上数出来的</b>：“The running text just says at the cost of ATP; the figure shows ATP going to AMP and PPi, which is two.”'},
 ...
 {n:'15', t:'投入',
  ...
  en:'“Per CO₂ fixed: the Calvin cycle itself costs <b>three ATP and two NADPH</b> — that is the standard figure, the textbook does not print it, it only says that 3-phosphoglycerate is converted to glyceraldehyde-3-phosphate in two steps at the cost of ATP and NADPH. A C-4 plant pays that <b>and</b> the cost of the shuttle: regenerating PEP takes <b>ATP to AMP plus pyrophosphate</b>, two high-energy bonds, so about <b>two extra ATP equivalents</b> — and that number I am reading off the textbook’s own figure 9.8. A CAM plant pays the same as C-4, plus the cost of pumping malate into the vacuole against a gradient.”',
...
['<b>C-4 的定义</b>：先用 <b>PEP carboxylase</b> 固一次，第一个产物是<b>四碳</b>的 oxaloacetate，再交给 rubisco',
 ...
 '书 <span class="pg">p212</span>：不走三碳中间体，走四碳的 malát（或 aspartát）。'],
...
['<b>问题是什么</b>：rubisco 既是<b>羧化酶</b>也是<b>加氧酶</b>——CO₂ 少、O₂ 多的时候它装 O₂',
 '“Rubisco is both a carboxylase and an oxygenase — its full name says so — and when CO₂ is low and O₂ high it fixes O₂ instead.”',
...
['<b>光呼吸</b>：rubisco 把 O₂ 装上 RuBP，裂成 3-phosphoglycerate ＋ <b>phosphoglycolate</b>；跨<b>叶绿体 / 过氧化体 / 线粒体</b>三个区室',
 ...
 '三个酶：RubisCO · phosphoglycolate phosphatase · <b>glycolate oxygenase</b>（书的叫法 <i>glykolátoxygenasa</i>，<span class="pg">p212</span>；通用叫 glycolate <b>oxidase</b>——<b>按书说，知道差别</b>）。'],
...
['<b>账</b>：C-4 每个 CO₂ 多花 <b>~2 个 ATP 当量</b>（ATP → AMP ＋ PPᵢ），买到<b>压住光呼吸</b> ＋ <b>气孔近乎关闭</b>',
 '“C-4 pays about two extra ATP equivalents per CO₂ — the dikinase takes ATP to AMP and pyrophosphate — and buys suppressed photorespiration and nearly closed stomata.”',
...
segs:[
 ...
 {tag:'段 3 · 稍展开', h:'C-4 四步 ＋ CAM 一天 ＋ 那笔账',
  p:['“The C-4 shuttle, step by step. In the <b>mesophyll cell</b>, carbonic anhydrase — the textbook calls it carbonate dehydratase — hydrates CO₂ to <b>bicarbonate</b>. <b>PEP carboxylase</b> joins the bicarbonate to phosphoenolpyruvate, releasing phosphate, giving <b>oxaloacetate</b>. Malate dehydrogenase reduces that to <b>malate</b> with NADPH, or a transamination gives aspartate. The four-carbon acid moves into the <b>bundle-sheath cell</b>, where the decarboxylating malate dehydrogenase — the malic enzyme — splits it to <b>pyruvate, CO₂ and NADPH</b>. That CO₂ is released in an enclosed compartment right next to rubisco, so the carboxylase reaction wins. The pyruvate goes back and <b>pyruvate–phosphate dikinase</b> regenerates PEP.',
     'Two properties of PEP carboxylase are the point of the whole design: the textbook says its <b>Km is lower</b> than rubisco’s, so it works at a CO₂ concentration rubisco could not use — which is why the stomata can stay nearly shut; and it has <b>no oxygenase activity</b>, because its substrate is a charged bicarbonate ion that O₂ cannot imitate.',
     'CAM is the same four steps on a clock instead of a map. At night the stomata open — cool, humid air, little water lost — PEP carboxylase fixes CO₂, and the malate is stored as malic acid in the <b>vacuole</b>; the PEP comes from starch broken down overnight. By day the stomata are shut, the malate returns, is decarboxylated, and the CO₂ feeds rubisco in the same cell while the light reactions supply ATP and NADPH.',
...
why:{
 rungs:[
  ...
  ['为什么 rubisco 会分不清？','因为它的机制经过一个<b>高活性的中间体</b>——书 <span class="pg">p210</span> 说酶先把 RuBP 变成一个反应性的烯醇（endiolát）离子，正是这个离子去结合 CO₂。而这种类似碳负离子的中间体对 <b>O₂ 一样敞开</b>；CO₂ 和 O₂ 又都是小的、不带电的、非极性的分子，活性中心没有干净的办法把其中一个挡在外面。（中间体是书说的；「O₂ 攻击同一个中间体」是通用机制。）'],
...
{q:'What is a C4 plant?',
 ...
 say:'“A plant that fixes carbon twice. First PEP carboxylase, in the mesophyll cell, attaches bicarbonate to phosphoenolpyruvate and gives the four-carbon oxaloacetate — hence C-4 — which becomes malate or aspartate. That is carried into the bundle-sheath cell, decarboxylated, and the CO₂ released is fixed again, this time by rubisco in the ordinary Calvin cycle. The point is to concentrate CO₂ around rubisco. Maize, sugarcane and sorghum are the examples.”'},
...
{q:'What is photorespiration?',
 ...
 tail:'书还加了一句很有用的限定：<i>Důvody zatím nejsou zcela jasné</i>（原因还不完全清楚），并给了两个可能的用处——防光氧化、造 glycine 和 serine。<b>引用这句限定本身就得分</b>，因为它说明你读的是书而不是口号。<span class="pg">p212</span>'},
...
{q:'Which plants are which — give me examples.',
 ...
 tail:'书的原文：<i>Jsou to především tropické trávy (např. cukrová třtina) a kaktusovité rostliny (sukulenty)</i>（<span class="pg">p212</span>，400 dpi 原图已核）。书还说 <i>více než 100 druhů</i>（已发现 100 多种 C-4 植物）。<b>现代的计数远大于这个数，但不要报另一个数字</b>——就说「书当年的计数是 100 多种」。'},

{q:'Why does a cactus not wilt in the desert?', odd:1,
 mean:'<b>听起来是植物学常识题，其实问的是 CAM。</b>答案落在「气孔什么时候开」。',
 say:'“Because it keeps its stomata — the pores in the surface — <b>shut all day</b> and opens them only at night. That is CAM, crassulacean acid metabolism: at night, when the air is cool and humid so little water evaporates, PEP carboxylase fixes CO₂ into oxaloacetate and then malate, which is banked as malic acid in the vacuole. By day the plant is sealed, the malate is decarboxylated, and rubisco gets that CO₂ inside the closed cell. The cost is growth rate — it can only fix as much carbon as its vacuole can store overnight, which is why cacti grow so slowly.”',
...
{r:'高', q:'What is rubisco?',
 en:'“<b>Rubisco is the enzyme that attaches CO₂ to an organic molecule</b> — it catalyses the first reaction of the Calvin cycle, the carboxylation of the five-carbon sugar ribulose-1,5-bisphosphate. Its full name is <b>ribulose-1,5-bisphosphate carboxylase/oxygenase</b>, and the second half of that name is the whole problem: it also adds O₂. The textbook describes it as a soluble protein in the <b>stroma</b> of the chloroplast, one of the most abundant high-molecular-weight proteins on Earth, built from two kinds of subunit, <b>small and large</b>, with eight active sites in the functional molecule. It works through a reactive enediolate intermediate formed from ribulose-1,5-bisphosphate, and that intermediate is what CO₂ — or O₂ — attacks.”',
 cn:'书 <span class="pg">p209</span>：<i>rozpustný, na Zemi jeden z nejrozšířenějších vysokomolekulárních proteinů, umístěný ve stromatu chloroplastů</i>；小（S）大（L）两类亚基，每个单体 4 S ＋ 4 L，功能酶是二聚体——即通用写法的 <b>L₈S₈</b>。<span class="pg">p210</span> 说「八个活性位点中的每一个」，跟 L₈S₈ 自洽。<br><b>rubisco 的完整走读在卡 27（#27 光合作用）</b>，这里只给定义和那个致命的双活性。'},
{r:'高', q:'What is the Calvin cycle, in one sentence?',
 en:'“It is the cycle of enzyme reactions in the <b>stroma</b> of the chloroplast that fixes CO₂ onto ribulose-1,5-bisphosphate with rubisco, reduces the resulting 3-phosphoglycerate to glyceraldehyde-3-phosphate using the <b>ATP and NADPH</b> the light reactions supply, and then rearranges most of those trioses back into ribulose-1,5-bisphosphate so the cycle can close. Its net product is a sugar. The textbook also warns against calling it the <b>dark phase</b> — the name suggests it does not happen in the light, which is wrong; it runs whenever ATP and NADPH are available.”',
 cn:'<b>这道题不展开 Calvin 循环</b>（那是卡 27）。但这一句必须能说，因为 C-3 的定义靠它撑着。<br>「别叫 dark phase」是书自己的意见（<span class="pg">p209</span>）：<i>termín temná fáze… není vhodné, protože navozuje myšlenku, že k této přeměně nedochází na světle</i>。<b>这是一个很划算的加分点</b>——纠正一个常见叫法，而且纠正的依据就是他手里那本书。'},
{r:'高', q:'What is PEP carboxylase?',
 en:'“<b>PEP carboxylase is the enzyme that carries out the first carboxylation of the C-4 and CAM pathways</b>: it joins inorganic carbon to <b>phosphoenolpyruvate</b> and gives <b>oxaloacetate</b>, releasing inorganic phosphate. Three things about it are the reason the pathways work. Its substrate is <b>bicarbonate</b>, not CO₂, so the CO₂ must be hydrated first by carbonic anhydrase. It has a <b>lower Km</b> than rubisco — Km being the substrate concentration at which an enzyme runs at half its maximum rate, so a lower Km means it still works where rubisco would be starved. And it has <b>no oxygenase activity</b>, so unlike rubisco it cannot be fooled by O₂. It is not a photosynthetic enzyme and needs no light, which is what lets a CAM plant use it at night.”',
 cn:'<b>这是这张卡的第二核心酶，必须有正面定义</b>——他问 “What is PEP carboxylase?” 的概率不比问 rubisco 低。<br>三条性质的出处：<b>底物是 HCO₃⁻</b> 和放出 Pᵢ 来自书的 Obr. 9.8（<span class="pg">p214</span>，400 dpi 已核）；<b>Km 比 rubisco 低</b>是正文（<span class="pg">p212</span>）；<b>没有加氧活性</b>和「不需要光」是通用知识，书没说。<br>Km 的那一句定义是就地交代的承重名词（LOGIC §4b）；完整的 Km 在<b>卡 02</b>，连同书 p055/p056 自相矛盾那条警告。'},
{r:'中', q:'What is PEP, and where else have you met it?',
 en:'“<b>Phosphoenolpyruvate</b> — a three-carbon compound, pyruvate with a phosphate on the enol oxygen. That enol phosphate is <b>macroergic</b>: hydrolysing it releases a lot of energy, which is why in glycolysis the last step, pyruvate kinase, transfers that phosphate to ADP and makes ATP, and why the textbook calls that step practically irreversible. Here it is used the other way round: as a <b>carbon acceptor</b>, and regenerating it costs the C-4 plant two high-energy phosphate bonds.”',
 cn:'<b>接卡 gly（糖酵解）第 10 步</b>：enolase 造出 PEP，pyruvate kinase 把磷酸交给 ADP（<span class="pg">p166</span>，书说这一步 <i>prakticky ireverzibilní</i>，<span class="pg">p169</span>）。<b>同一个分子在两张卡上做两件相反的事</b>——这种对照他很喜欢问。'},
{r:'中', q:'What are mesophyll and bundle-sheath cells?',
 en:'“Two layers of different cells lying between the <b>epidermis</b> — the surface skin of the leaf — and the <b>vascular tissue</b>, the veins that carry water in and sugar out. The <b>mesophyll cells</b> are the outer layer, in contact with the air spaces of the leaf, so they are where CO₂ arrives. The <b>bundle-sheath cells</b> are a ring wrapped around each vein, more enclosed. The textbook says which does what: the mesophyll cells fix CO₂ by the C-4 mechanism, the bundle-sheath cells by the C-3 mechanism, with rubisco and the Calvin cycle.”',
...
{r:'中', q:'What is a stoma?',
 ...
 cn:'书的原文 <span class="pg">p212</span>：<i>průduchy listů, kudy proniká CO₂ do listu, jsou otevřeny jen minimálně, aby nedocházelo k enormnímu odpařování vody</i>。<br><b>「保卫细胞 guard cells」书里没有</b>，是通用补充；被追问开关机制就停在这里，那是植物生理学不是生化。'},
...
{r:'高', q:'Why fix CO₂ with PEP and then immediately release it again? That looks wasteful.',
 ...
 cn:'<b>书的自问自答段，可以逐字引</b>：<i>Otázkou je, proč tyto rostliny fixují CO₂ prostřednictvím PEP a vzápětí opět CO₂ uvolňují… Důvodem je zvýšení účinnosti fixace CO₂…</i><span class="pg">p212</span><br><b>这是全套材料里少有的「书替你写好了 ④」的地方</b>，所以这一格值得背到逐字。'},
{r:'高', q:'Why can’t PEP carboxylase be fooled by O₂ the way rubisco is?',
 en:'“Because it is not doing the same kind of chemistry on the same kind of intermediate. Rubisco makes a highly reactive <b>enediolate</b> out of ribulose-1,5-bisphosphate, and that carbanion-like intermediate will react with any small electrophilic gas that reaches it — CO₂ or O₂ — and the two are both small, uncharged and non-polar, so the active site has no clean handle for excluding one. PEP carboxylase instead uses <b>bicarbonate</b>, HCO₃⁻ — a <b>charged</b> ion, which the site can recognise by its charge, and which <b>O₂ cannot imitate</b>. So the enzyme has no oxygenase activity at all. The textbook’s own figure 9.8 shows the bicarbonate being made first, by carbonate dehydratase — carbonic anhydrase.”',
 cn:'<b>「用电荷认底物」这一层是通用机制</b>，书没写；书写的是图上的 HCO₃⁻ 和正文里的 Km 比较。烯醇（endiolát）中间体是书 <span class="pg">p210</span> 写的。<br><b>这一条是这道题最深的一层，也是最容易加分的一层</b>：它把「C-4 为什么管用」从「浓度高」推进到「换了一个认不错的底物」。'},
{r:'高', q:'Why does the CO₂ concentration inside the leaf fall when it is hot?',
 en:'“Because the plant shuts the door. The <b>stomata</b> are the only route CO₂ takes into the leaf, and they are also the route water vapour leaves by — one pore, both directions. When it is hot and dry the plant cannot afford the water, so it closes them; CO₂ stops coming in, while the light reactions keep producing O₂ inside. So the CO₂-to-O₂ ratio at rubisco moves the wrong way and the oxygenase reaction gains. Temperature also pushes the same way directly — CO₂ becomes less soluble than O₂ as the water warms, and rubisco’s preference for CO₂ falls with temperature — though that second part is the standard account, not this textbook.”',
...
{r:'中', q:'Who discovered the C4 pathway?',
 en:'“The textbook credits <b>M. Hatch and C. Slack</b>, in <b>1970</b>: they found that some plants can fix CO₂ by a route that does not use three-carbon intermediates but four-carbon compounds, malate or aspartate — and the plants are named C-4 after that. The pathway is often called the <b>Hatch–Slack pathway</b> for them.”',
...
{r:'中', q:'And who worked out the C3 cycle?',
 en:'“<b>M. Calvin</b>, who the textbook notes received the <b>Nobel Prize in 1961</b>, together with <b>A. A. Benson</b> and <b>J. A. Bassham</b> — which is why it is sometimes called the Calvin–Benson–Bassham cycle, and usually just the Calvin cycle.”',
...
{r:'高', q:'Photorespiration is a kind of respiration, then?',
 ...
 cn:'书 <span class="pg">p212</span> §9.2 第二句就是这个界定：<i>liší se podstatně od respirace mitochondrií (dýchacího řetězce, viz kap. 6)</i>。<br><b>「不产 ATP」这一句书没有明写</b>，但它是「跟呼吸链本质不同」的直接推论，而且通用说法一致。标一句 general 更稳。'},
{r:'高', q:'PEP carboxylase fixes CO₂, doesn’t it?',
 en:'“Strictly, it fixes <b>bicarbonate</b> — HCO₃⁻, the hydrated form of CO₂ — and the CO₂ has to be hydrated first by <b>carbonic anhydrase</b>. This textbook is interesting on that point, because its running text says the primary acceptor of CO₂ is phosphoenolpyruvate, but <b>its own figure 9.8</b> draws carbonate dehydratase converting CO₂ to bicarbonate and PEP carboxylase using the bicarbonate, releasing inorganic phosphate. The figure agrees with the standard account. And the distinction is not pedantic: it is precisely because the substrate is a <b>charged ion</b> that O₂ cannot substitute for it, which is why this enzyme has no oxygenase activity.”',
 cn:'<b>用书的一半打书的另一半</b>（LOGIC §14），跟 α-helix 的 n+3 / Obr. 2.8 是同一类操作。<b>400 dpi 原图已核</b>：<span class="pg">p214</span> 的图上确实印着 karbonátdehydratasa 和 HCO₃⁻，<span class="pg">p212</span> 正文确实写 CO₂。<b>这条已经可以进 book/BOOK_ERRATA.md。</b>'},
...
{r:'中', q:'Your textbook lists cacti as C4 plants. Are they?',
 en:'“The textbook does say that — tropical grasses such as sugar cane, and cactus-like plants, succulents. In the current classification those succulents are <b>CAM</b> plants. The textbook is not wrong about the chemistry, because CAM uses exactly the C-4 chemistry; what it does not have is a <b>separate CAM category</b>, so plants that separate the two fixations in time end up in the same box as plants that separate them in space. If you want the modern split: tropical grasses — maize, sugar cane, sorghum — are C-4; cacti, agave and pineapple are CAM.”',
 cn:'<b>书的原话</b>（<span class="pg">p212</span>，400 dpi 已核）：<i>Jsou to především tropické trávy (např. cukrová třtina) a kaktusovité rostliny (sukulenty).</i><br><b>答法的顺序很重要</b>：先承认书说了什么、并说书在化学上没错，再给现代分类。<b>先否定书是最危险的开口方式</b>——他脑子里就是这本书。'}
]},

{g:'相邻考点', gn:'这一题四面都连着别的卡。<b>他从这里走出去，多半走这四个方向。</b>', items:[
{r:'高', q:'Tell me about photosynthesis itself, then.',
 en:'“In one frame: the light reactions in the <b>thylakoid membranes</b> convert the energy of photons into two chemical currencies, <b>ATP and NADPH</b>; the fixation reactions in the <b>stroma</b> spend those two to build a carbohydrate out of CO₂. The textbook notes that the second half should not be called the dark phase, because it runs in the light too — for as long as ATP and NADPH are available. Everything on this topic — C-3, C-4, CAM, photorespiration — is about the second half only: how the CO₂ reaches rubisco.”',
...
{r:'中', q:'You said oxaloacetate and malate — where else do those appear?',
 en:'“In the <b>citric acid cycle</b>, as the last two intermediates: malate dehydrogenase oxidises malate to oxaloacetate and that closes the ring, and oxaloacetate is the acceptor that takes in the next acetyl group. And in <b>gluconeogenesis</b>: because the pyruvate kinase step of glycolysis is practically irreversible, the cell detours through oxaloacetate, which is carboxylated from pyruvate and then phosphorylated — using GTP — to phosphoenolpyruvate. So the same four-carbon acid is an <b>oxidisable intermediate</b> in the mitochondrion, a <b>bypass</b> in gluconeogenesis, and a <b>carbon carrier</b> in the C-4 leaf.”',
...
{r:'中', q:'What is glyoxylate, which you mentioned in photorespiration?',
 en:'“It is the two-carbon aldehyde-acid formed when <b>glycolate oxygenase</b> oxidises glycolate — the salvage route the plant runs after rubisco has oxygenated its substrate. In the textbook’s scheme it is then transaminated on the way to <b>glycine and serine</b>, which is why the book says photorespiration is one of the plant’s routes to those two amino acids. It also gives its name to the <b>glyoxylate cycle</b>, which is a different thing — a modification of the citric acid cycle in bacteria and germinating oil seeds — so the two should not be confused.”',
 cn:'光呼吸的路线图是书的 Obr. 9.7（<span class="pg">p213</span>）：glykolát → glyoxylát → glycin → serin，跨叶绿体、过氧化体、线粒体。<br>⚠ <b>酶名按书说</b>：书写 <i>glykolátoxygenasa</i>（glycolate oxygenase），通用写法是 glycolate <b>oxidase</b>。<br><b>乙醛酸循环在卡 24 的相邻考点里</b>（<span class="pg">p140 p141</span>）——<b>名字像，是两回事</b>，主动分清是加分点。'}
]},
...
{r:'中', q:'What is a fitness landscape?',
 en:'“A map from <b>sequence</b> to <b>function</b>: every point is one variant of the protein, the height is how well it performs the function you are selecting on, and evolution — natural or directed — is a walk on that surface that can normally only go uphill, one or a few mutations at a time. The features that matter are the ones that constrain the walk: <b>ridges</b>, where two properties trade off against each other so you can move along but not up; <b>local peaks</b>, which you cannot leave without going downhill first; and <b>epistasis</b>, where the effect of one mutation depends on which others are already there. Rubisco is usually described as sitting on a ridge of exactly that kind.”',
