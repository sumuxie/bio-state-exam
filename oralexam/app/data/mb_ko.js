...
ask:[
 ...
 {g:'定义类', gn:'他挑一个词问「那是什么」。', items:[
  {r:'中', q:'Forward genetics starts from a phenotype. What tools actually generate the variants?',
    ez:'“Three, and all three are random on purpose. First, chemical mutagenesis. You feed animals a mutagen such as E M S or E N U, and it makes single base changes all over the genome. Then you screen thousands of animals for an odd phenotype. Second, transposon mutagenesis. You let a jumping element hop around, and wherever it lands it breaks a gene. The advantage is that the insertion tags the gene, so it is easy to find afterwards. Third, association studies. You do not mutagenise anything. You collect tens of thousands of people with a trait and look for variants they share across the whole genome. That is a G W A S. Reverse genetics is the opposite direction. There I already know the gene and I break it on purpose.”',
    ezcn:'<b>三样，而且三样都是故意随机的。</b><b>一、化学诱变</b>：<b>给动物喂 EMS 或 ENU 这类试剂，它在全基因组上随机造单碱基改变，然后你筛成千上万只找古怪表型。</b><b>二、转座子诱变</b>：<b>让跳跃元件在细胞里乱跳，跳到哪里就把那个基因弄坏。</b>⚠ <b>它比化学诱变强的地方是插入本身就是个标签，事后很容易把基因找出来。</b><b>三、关联分析</b>：<b>什么都不诱变，收几万个有某个表型的人，在全基因组上找他们共有的变异 —— 就是 GWAS。</b><b>反向遗传学是反方向：基因我已经知道了，我故意把它弄坏。</b>',
   en:'“Three, and all three are random on purpose. First, chemical mutagenesis: you feed animals a mutagen such as EMS or ENU, it makes single-base changes all over the genome, and then you screen thousands of animals for an odd phenotype. Second, transposon mutagenesis: you let a jumping element hop around and wherever it lands it breaks a gene, and the advantage over a chemical is that the insertion tags the gene, so it is easy to find afterwards. Third, association studies. You do not mutagenise anything. You collect tens of thousands of people with a trait. Then you look for variants they share across the whole genome. That is a GWAS. Reverse genetics runs the other way: there I already know the gene and I break it on purpose.”',
   cn:'⚠ <b>2026-09-25 她抽查时查出来的两处零命中</b>：<b>EMS / ENU 化学诱变</b>和<b>GWAS</b>。她定了只补一条，<b>只为有个了解，不铺开</b>—— 因为她不做动物也不做群体遗传，被问的概率比方法学那几位低得多。<br><b>三样里只有转座子这一样卡上本来就有</b>（本卡「书外 · 转座子」那一组六条）。<br><b>一句话的判据：正向从表型找基因，反向从基因找表型。</b><span class="pg">通用</span>'},
