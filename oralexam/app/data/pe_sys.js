...
{r:'中', q:'Why did more hosts keep being added after bacteria worked?',
    ez:'“Each host arrived because the previous one could not do something. Bacteria came first. Somatostatin and insulin were made in Escherichia coli in the late seventies. Those are small peptides with no sugar on them. Yeast came next. The hepatitis B vaccine was made in yeast in nineteen eighty six. It was the first recombinant vaccine. The antigen has to assemble into a particle. A bacterium could not do that. Mammalian cells came after that. Human tissue plasminogen activator came from C H O cells in nineteen eighty seven. That protein needs human glycosylation to work. Insect cells with baculovirus arrived in the same period. So the list on this card is a history. Every entry is a thing the cheaper host could not do.”',
    ezcn:'⚠ <b>每一种新宿主的出现，都是因为上一种做不了某件事。</b><b><b>细菌最早</b>：七十年代末生长抑素和胰岛素在大肠杆菌里做出来——<b>那是不带糖的小肽</b>。</b><b><b>接着是酵母</b>：1986 年乙肝疫苗在酵母里做出来，<b>第一个重组疫苗</b>；它的抗原必须<b>组装成颗粒</b>，细菌做不到。</b><b><b>再往后是哺乳动物细胞</b>：1987 年人组织型纤溶酶原激活剂（tPA）由 <b>CHO 细胞</b>做出来——<b>这个蛋白要有人源的糖基化才有功能</b>。</b><b>昆虫细胞加杆状病毒是同一时期出现的。</b>⚠ <b>所以这张卡上那份清单其实是一部历史：<b>每一项都是「更便宜的那个宿主做不了的那件事」</b>。</b>',
 en:'“Each host arrived because the previous one could not do something. Bacteria came first, and somatostatin and insulin were made in E. coli in the late seventies. Those are small peptides with no sugar on them. Yeast came next, and the hepatitis B vaccine was made in yeast in nineteen eighty-six as the first recombinant vaccine. That antigen has to assemble into a particle, which a bacterium could not do. Mammalian cells came after that, and human tissue plasminogen activator was made in CHO cells in nineteen eighty-seven, because that protein needs human glycosylation in order to work. Insect cells with baculovirus arrived in the same period. So the list on this card is really a history, and every entry on it is something the cheaper host could not do.”',
 cn:'⚠ <b>这一条就是这张卡的口令的历史版</b>：「蛋白需要被做什么，宿主就由它定」——<b>历史是按这个顺序被逼出来的，不是被设计出来的</b>。<b>通用知识，标 general</b>；1986 与 1987 这两个年份安全，其余说范围。<b>接口</b>：糖基化那一条回 <b>卡 13</b> 和 <b>卡 08</b>。'},
 ]}
]
});
