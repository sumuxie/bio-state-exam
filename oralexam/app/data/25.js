...
/* ---------------- 追问 ---------------- */
ask:[
 {g:'⚠ 考官 · Ryšlavá · 活性氧从哪来，又怎么被清掉', gn:'⚠ <b>2026-09-23 名单下来当天补的。</b><b>Prof. Helena Ryšlavá 领植物生物化学实验室</b>，方向是<b>植物在胁迫下的代谢变化</b>，核心测的就是<b>抗氧化酶（SOD、过氧化物酶、过氧化氢酶）</b>。⚠ <b>量过：<code>reactive oxygen</code> 在整套卡上只有 5 处、抗氧化酶 8 处，偏薄</b>；而她那份医学生化考纲 <b>#4B 就是「自由基生物化学 · 氧化应激与衰老」</b>。<b>⚠ 她的典型问法是「你怎么解释这个现象」——要的不是背诵，是从现象往上推机制。</b><b>放在呼吸链这张卡上，因为活性氧就是从这里漏出来的。</b>', items:[
{r:'高', q:'Where do reactive oxygen species come from?',
    ez:'“Mostly from the respiratory chain itself. The chain moves electrons one at a time. Sometimes an electron leaks out early. It meets molecular oxygen directly. Oxygen then takes one electron instead of four. The product is superoxide. Complex one and complex three are the main leak points. So the same machine that uses oxygen safely also makes the dangerous form of it. That is the price of using oxygen at all.”',
    ezcn:'<b>主要就是<b>从呼吸链本身漏出来的</b>。</b><b>这条链<b>一次只传一个电子</b>，有时候电子会<b>提前漏出去</b>，直接撞上分子氧：<b>氧本来要一次拿四个电子变成水，现在只拿到一个，产物就是超氧阴离子</b>。</b>⚠ <b>主要的漏点是<b>复合物 I 和复合物 III</b>。</b><b>所以<b>同一台安全使用氧的机器，也在制造氧的危险形式</b>——这是用氧的代价。</b>',
 en:'“Mostly from the respiratory chain itself. The chain moves electrons one at a time, and sometimes an electron leaks out early and meets molecular oxygen directly. Oxygen then takes one electron instead of four, and the product is superoxide. Complex one and complex three are the main leak points. So the same machine that uses oxygen safely also makes the dangerous form of it, and that is the price of using oxygen at all. The Czech textbook does not set this out, so it is general knowledge.”',
 cn:'⚠ <b>整条 general</b>。<b>放在这张卡上是有理由的</b>：<b>这张卡已经讲了「复合物 IV 让氧一次拿四个电子，不放出中间体」</b>——<b>活性氧正是「没走完那条安全路线」的结果</b>，两句话咬在一起。<br><br>⚠ <b>她的问法是「你怎么解释」</b>，<b>所以这一条的价值不在名词，在那句因果：一次一个电子 ＋ 氧就在旁边 ＝ 必然会漏。</b>'},
{r:'高', q:'How does the cell get rid of them?',
    ez:'“In a short chain of enzymes. Superoxide dismutase acts first. It turns two superoxide into hydrogen peroxide and oxygen. Hydrogen peroxide is still dangerous. Catalase breaks it into water and oxygen. Glutathione peroxidase does the same job using glutathione. Glutathione is oxidised to its disulfide form. Glutathione reductase then restores it using N A D P H. So the whole defence finally runs on N A D P H.”',
    ezcn:'<b>靠一小串酶接力：</b><b>① <b>超氧化物歧化酶（SOD）</b>先动手，把<b>两个超氧</b>变成<b>过氧化氢 ＋ 氧气</b>；</b><b>② 过氧化氢还是危险的，<b>过氧化氢酶（catalase）</b>把它拆成<b>水 ＋ 氧气</b>；</b><b>③ <b>谷胱甘肽过氧化物酶</b>做同一件事，但用掉<b>谷胱甘肽</b>，后者被氧化成二硫形式（GSSG）；</b><b>④ <b>谷胱甘肽还原酶</b>再用 <b>NADPH</b> 把它还原回来。</b>⚠ <b>所以整套防御<b>最后是靠 NADPH 供着的</b>。</b>',
 en:'“In a short chain of enzymes. Superoxide dismutase acts first and turns two superoxide into hydrogen peroxide and oxygen. Hydrogen peroxide is still dangerous, and catalase breaks it into water and oxygen. Glutathione peroxidase does the same job using glutathione, which is oxidised to its disulfide form. Glutathione reductase then restores the glutathione using NADPH. So the whole defence finally runs on NADPH. This is general knowledge.”',
 cn:'⚠ <b>整条 general</b>。<b>最后那一句是这一条真正的价值</b>：<b>抗氧化防御最后靠 NADPH</b> —— <b>而 NADPH 的主要来源是磷酸戊糖途径</b>（x-meta 速背 06）。<b>说出这一步，就把「呼吸链」「磷酸戊糖途径」「谷胱甘肽」三样缝在一起了</b>，<b>而她要的正是这种从现象往上推的回答。</b><br><br>⚠ <b>留一个口子，别主动展开</b>：<b>羟自由基</b>是最凶的那一个（Fe²⁺ ＋ H₂O₂ 的 Fenton 反应产物），<b>而且没有任何酶能清除它</b> —— 被追问再说这一句，它很漂亮，但说多了会引到自由基化学里去。'},
 ]},
