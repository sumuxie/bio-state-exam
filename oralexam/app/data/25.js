...
{r:'高', q:'Why is the yield “about” three ATP and not a whole number?',
 ...
 cn:'书 p146 用的正是「přibližně 3 ATP」「asi 2 ATP」。现代值：约 10 个质子/NADH、约 4 个质子/ATP（3 个转动 ＋ 1 个把磷酸运进来）→ <b>2.5 和 1.5</b>，<b>书里 0 命中，标 general</b>。这条同时回答「为什么现代教材说 30–32」；另一半原因（胞质 NADH 要穿梭进来）见卡 <b>gly</b>。<br><br><b>=== 公式和推导（背之前先看懂这一段） ===</b><br><b>式子</b>：<code>一个还原辅酶值几个 ATP ＝ 泵出去的质子数 ÷ 造一个 ATP 花掉的质子数</code><br><b>这是个汇率，不是化学计量。</b>分子和分母是两次互不相干的点数，它们<b>没有任何理由</b>正好整除。<br><br><b>两套数各自怎么来的</b>：<br>① <b>书（经典）</b>：分子 <code>6</code>（I 泵 2 ＋ III 泵 4 ＋ IV 不泵），结果是 3 个 ATP，反推出单价约 <b>2 个质子一个 ATP</b>；FADH₂ <code>4 ÷ 2 = 2</code>。<br>② <b>现代（general，书里 0 命中）</b>：分子 <code>10</code>（I 泵 4 ＋ III 泵 4 ＋ <b>IV 也泵 2</b>），分母 <code>4</code>——其中 <b>3 个用来转合酶</b>（F₁ 上有三个 β 催化位点，中轴转一整圈松出三个 ATP），<b>1 个用来把 Pᵢ 连着质子一起运进基质</b>。<br>③ 于是 <code>10 ÷ 4 = 2,5</code>，FADH₂ <code>6 ÷ 4 = 1,5</code>；一分子葡萄糖从 38 掉到 <b>30–32</b>。<br><br><br><b>=== 一句话理解 ===</b><br><b>2,5 不是「两个半 ATP」这种怪东西，它是个汇率：十份收入除以四份单价。</b>链和合酶之间没有任何化学键把两边锁成整数比，中间只隔着<b>一池子质子</b>——泵的那头不知道取的那头一次要舀几个。<br>所以问「一个 NADH 到底几个 ATP」，就像问「<b>一百块钱到底是几件衣服</b>」：答案取决于衣服的单价，不取决于这一百块。<b>书自己用的词就是「přibližně（大约）」——那不是含糊，那是诚实。</b>'},
