...
ask:[
 ...
 {g:'方法速查 · 这几张卡上出现的实验，各自在测什么', gn:'⚠ <b>2026-09-21 她说：「方法学我不先了解一下直接看卡我完全看不懂」。</b>查下来她是对的：下面这几个方法在四张分子生物学卡上被点名用到，<b>全套材料里却没有一句解释</b>。每一条只回答三件事：<b>它是什么 · 它测的是什么 · 读出来的是什么</b>。', items:[
  ...
  {r:'高', q:'What is a yeast one-hybrid assay?',
   ez:'“A yeast one hybrid assay asks which protein binds a known piece of D N A. It runs inside a living yeast cell. The known element is cloned upstream of a minimal promoter. A reporter gene is joined downstream of that promoter. The candidate protein is made as a fusion. Its partner in the fusion is a transcription activation domain. A protein that binds the element drags that domain over. The promoter then fires and the reporter is transcribed. So binding to D N A is read out as a blue colony.”',
   ezcn:'<b>酵母单杂交 ＝ 问「哪个蛋白结合这段已知 DNA」，在活的酵母细胞里做。</b><b>把已知顺式元件克隆到最小启动子 Pmin 上游，报告基因接在 Pmin 下游；待测蛋白与酵母转录激活域做成融合蛋白。</b>⚠ <b>蛋白一结合到元件上，就把激活域拽到 Pmin，Pmin 点火，报告基因被转录——于是「结合 DNA」被读成了「蓝色菌落」。完整版在速背 04。</b>',
