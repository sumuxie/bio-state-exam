...
{r:'中', q:'When was a human protein first made in bacteria?',
    ez:'“The first was somatostatin in nineteen seventy seven. It is a short human peptide. The gene was chemically synthesised rather than cloned. It was then expressed in Escherichia coli. Human insulin followed in nineteen seventy eight. The A chain and the B chain were made separately. They were then joined chemically. That product reached the market in nineteen eighty two. It was the first recombinant drug ever approved. The point worth making is about supply. Insulin had been extracted from pig and cattle pancreas. Recombinant insulin removed that dependence entirely.”',
    ezcn:'<b>第一个是 <b>1977 年的生长抑素（somatostatin）</b>——一段很短的人源肽；<b>它的基因是化学合成的，不是克隆来的</b>，然后在大肠杆菌里表达。</b><b>紧接着是 <b>1978 年的人胰岛素</b>：A 链和 B 链分开做，再用化学方法接起来；<b>1982 年上市，成为历史上第一个获批的重组药物</b>。</b>⚠ <b>值得说出口的那一点是<b>供给</b>：在那之前胰岛素是从猪和牛的胰腺里提的，<b>重组胰岛素把这个依赖整个去掉了</b>。</b>',
 en:'“The first was somatostatin, in nineteen seventy-seven. It is a short human peptide, and its gene was chemically synthesised rather than cloned, then expressed in E. coli. Human insulin followed in nineteen seventy-eight, with the A chain and the B chain made separately and then joined chemically, and that product reached the market in nineteen eighty-two as the first recombinant drug ever approved. The point worth making is about supply. Insulin had previously been extracted from pig and cattle pancreas, and the recombinant product removed that dependence entirely.”',
 cn:'<b>通用知识，标 general。</b>⚠ <b>这一条是这张卡「为什么要在细菌里表达」的历史答案</b>：不是因为方便，是因为<b>原来的来源是动物器官</b>。<b>接口</b>：为什么短肽先成功而大蛋白后成功——见 <b>pe-sys</b>「宿主由蛋白需要被做什么来定」。'},
{r:'中', q:'Where did the T7 system in pET vectors come from?',
    ez:'“It came from splitting transcription off from the host. T7 is a bacteriophage. Its own R N A polymerase is a single protein. That polymerase reads only T7 promoters. The host polymerase cannot read them at all. Studier and colleagues used that separation. They put the T7 polymerase gene into the host chromosome. They put it under a promoter that I P T G controls. They put the gene of interest under a T7 promoter on a plasmid. So nothing is transcribed until you add I P T G. Then one dedicated polymerase transcribes only your gene. It is fast and it ignores everything else. That is the DE3 strain and the pET vector together.”',
    ezcn:'<b>它来自<b>把转录从宿主身上拆下来</b>这个想法。</b><b>T7 是一种噬菌体，<b>它自己的 RNA 聚合酶是单条蛋白</b>，而且<b>只读 T7 启动子</b>——宿主的聚合酶根本读不了它。</b><b>Studier 等人利用了这个分离：把 <b>T7 聚合酶基因放进宿主染色体</b>，受一个 IPTG 控制的启动子管；把<b>目的基因放在质粒上的 T7 启动子</b>下。</b>⚠ <b>于是不加 IPTG 就什么都不转录；一加，一个专用的、又快又不管别的事的聚合酶<b>只转录你的基因</b>。</b><b>这就是 DE3 菌株和 pET 载体合起来的那套东西。</b>',
 en:'“It came from splitting transcription off from the host. T7 is a bacteriophage whose own RNA polymerase is a single protein, and that polymerase reads only T7 promoters, which the host polymerase cannot read at all. Studier and colleagues used that separation. They put the T7 polymerase gene into the host chromosome under a promoter controlled by IPTG, and the gene of interest under a T7 promoter on a plasmid. So nothing is transcribed until IPTG is added, and then one dedicated polymerase transcribes only your gene, quickly and ignoring everything else. That is the DE3 strain and the pET vector taken together.”',
 cn:'<b>通用知识，标 general。</b>⚠ <b>年份待核</b>（一般归到 1986 年前后）——说机制就够。<b>接口</b>：微生物短答里「What is the DE3 cassette and how does it work?」讲的是同一件事的机制版，这一条是它的来历版。'},
 ]}
]
});
