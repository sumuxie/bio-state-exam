...
{r:'高', q:'How much protein do you get, and how much survives refolding?',
    ez:'“Yields from E. coli run to tens or hundreds of milligrams per litre. With the T seven system the product can reach fifty per cent of total cell protein. Refolding is the opposite story. Refolding from inclusion bodies typically recovers one to five per cent. That is one to five per cent of the starting material. That gap is the honest reason for something. It is why people work so hard to keep the protein soluble in the first place.”',
