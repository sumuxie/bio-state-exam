...
figs:[
 ...
 {k:'认',
  ...
  cap:'<b>这张是「认」。全书只有这一张把一条链折完之后的样子画出来了。</b>'
    ...
    + '<br>③ 中间那个<b>打斜线的圆盘是血红素（haem）</b>，图注里书明说了。'
    ...
    + 'The hatched disc in the middle is the <b>haem</b>, so this is cytochrome P450.”'
...
{q:'Is haemoglobin an example of tertiary structure?',
 ...
 say:'“No — haemoglobin is the standard example of <b>quaternary</b> structure: four chains, two α and two β. The textbook itself speaks of the β-chain of haemoglobin in the sickle-cell example, and a β-chain implies there is an α-chain. The tertiary example is <b>myoglobin</b> — a single chain, mostly α-helix folded around a haem, the first protein structure ever solved, Kendrew 1957. Each chain of haemoglobin has a myoglobin-like fold. The way the four chains are arranged is the quaternary level.”'},
...
/* ---------------- 追问 ---------------- */
ask:[
 {g:'⚠ 氢键这一族 · 她自己列的问题', gn:'⚠ <b>2026-09-23 她贴了一串问题，这一组是其中氢键那几条。</b><code>hydrogen bond</code> 在卡上有 82 处，<b>但没有一条题正面问「为什么是两个」「在哪形成」「哪里不能」</b>。<br>⚠ <b>她笔记里有两处结论对、理由错，这一组顺便纠掉</b>：「甘氨酸的 α 碳不能形成氢键」（应该说<b>任何 C–H 都不行</b>）、「盐桥撑起 α 螺旋」（<b>撑起它的是主链氢键</b>）。', items:[
{r:'高', q:'Why can one oxygen take part in two hydrogen bonds?',
    ez:'“Because oxygen has two lone pairs. A hydrogen bond needs a donor and an acceptor. The donor is a hydrogen attached to a very electronegative atom. The acceptor is a lone pair. Oxygen carries two lone pairs. So it can accept two hydrogen bonds. In water the same oxygen also carries two hydrogens. Those two are donors. So one water molecule can take part in four hydrogen bonds at once.”',
    ezcn:'<b>因为氧上有<b>两对孤对电子</b>。</b><b>一个氢键需要<b>一个供体和一个受体</b>：供体是「连在强电负性原子上的氢」，受体是<b>一对孤对电子</b>。</b><b>氧带两对孤对，所以<b>能接受两个氢键</b>。</b>⚠ <b>而在水里，同一个氧还带着两个氢（两个供体）——所以<b>一个水分子能同时参与四个氢键</b>，这就是水那些反常性质的来源。</b>',
 en:'“Because oxygen has two lone pairs. A hydrogen bond needs a donor and an acceptor. The donor is a hydrogen attached to a very electronegative atom, and the acceptor is a lone pair. Oxygen carries two lone pairs, so it can accept two hydrogen bonds. In water the same oxygen also carries two hydrogens, which are donors, so one water molecule can take part in four hydrogen bonds at once. That is where the unusual properties of water come from.”',
 cn:'⚠ <b>她 2026-09-23 贴的问题之一</b>：「Why O 氢键 两个 H」。<b>卡上 hydrogen bond 有 82 处，但没有一条题正面问「为什么是两个」。</b><br><br><b>接口</b>：氢键的定义在这张卡已有的那一条；水的反常性质和疏水效应在卡 <b>x-bonds</b>。'},
{r:'高', q:'Where in a protein do hydrogen bonds form, and where can they not?',
    ez:'“The important ones are in the backbone. Every peptide unit has an N H and a C double bond O. The N H is the donor. The C double bond O is the acceptor. Those two make the alpha helix and the beta sheet. Side chains can also hydrogen bond. Serine, threonine, tyrosine, asparagine and glutamine all can. A carbon hydrogen bond cannot. Carbon is not electronegative enough. So a pure hydrocarbon side chain makes none. Alanine, valine, leucine and phenylalanine are like that.”',
    ezcn:'<b>最要紧的那些在<b>主链</b>上：每个肽单位都带一个 <b>N–H</b>（供体）和一个 <b>C=O</b>（受体），<b>α 螺旋和 β 折叠就是这两者搭起来的</b>。</b><b>侧链也能形成氢键：丝氨酸、苏氨酸、酪氨酸、天冬酰胺、谷氨酰胺都可以。</b>⚠ <b>不能形成的是 <b>C–H</b> —— 碳的电负性不够</b>，所以<b>纯烃基侧链一个氢键都不给</b>（丙氨酸、缬氨酸、亮氨酸、苯丙氨酸）。',
 en:'“The important ones are in the backbone. Every peptide unit carries an N-H and a C=O. The N-H is the donor and the C=O is the acceptor. Those two are what build the alpha helix and the beta sheet. Side chains can hydrogen bond as well, and serine, threonine, tyrosine, asparagine and glutamine all can. A carbon-hydrogen bond cannot, because carbon is not electronegative enough, so a purely hydrocarbon side chain makes none. Alanine, valine, leucine and phenylalanine are of that kind.”',
 cn:'⚠ <b>她贴的问题</b>：「氢键如何 form protein？<b>哪里形成氢键？哪里不可以？</b>」<br><br>⚠ <b>她笔记里那一条要纠</b>：她写「<b>Glycine alpha Carbon</b> … not possible for 氢键形成」——<b>结论对，理由错</b>。<b>不是甘氨酸特殊，是任何 C–H 都不行</b>；而<b>甘氨酸的主链照样形成氢键</b>，它跟别的残基在这一点上没有区别。<b>被问到就说「碳的电负性不够」，不要说「甘氨酸不行」。</b><br><br><b>接口</b>：α 螺旋和 β 折叠在这张卡速背 06；二十个氨基酸的侧链分类在卡 <b>aa</b>。'},
{r:'中', q:'Do salt bridges hold the alpha helix together?',
    ez:'“No. The alpha helix and the beta sheet are held by backbone hydrogen bonds. A salt bridge is something else. It is an ionic interaction between two charged side chains. One is positive and one is negative. Those are usually far apart in the sequence. So a salt bridge stabilises the tertiary structure. It can also stabilise the quaternary structure. It is not what defines the secondary structure.”',
    ezcn:'<b>不是。</b><b>α 螺旋和 β 折叠是<b>主链氢键</b>撑起来的。</b><b>盐桥是另一回事：它是<b>两个带电侧链之间的离子相互作用</b>（一正一负），而这两个残基在序列上通常离得很远。</b>⚠ <b>所以盐桥稳的是<b>三级结构</b>，也可以稳<b>四级结构</b>——<b>它不是定义二级结构的那个东西</b>。</b>',
 en:'“No. The alpha helix and the beta sheet are held together by backbone hydrogen bonds. A salt bridge is something else. It is an ionic interaction between two charged side chains, one positive and one negative, and those two residues are usually far apart in the sequence. A salt bridge therefore stabilises the tertiary structure, and it can stabilise the quaternary structure as well. It is not what defines the secondary structure.”',
 cn:'⚠ <b>她贴的原话是个问句</b>：「Salt bridges formed alpha helix’s and beta?」——<b>答案是否定的</b>，而这正是考官喜欢挖的那种混淆。<b>一句话分开：二级结构靠主链，盐桥管侧链之间。</b><br><b>接口</b>：盐桥／离子对／离子键三个词的区别在卡 <b>x-bonds</b> 已有一条。'},
 ]},
 {g:'⚠ 考官 · Hudeček · 光谱怎么读出一个蛋白', gn:'⚠ <b>2026-09-23 名单下来当天补的。</b><b>Prof. Jiří Hudeček 是生物物理化学家</b>，方向是<b>用光谱方法表征大分子</b>（UV-Vis · 圆二色谱 CD · 荧光 · SPR）。⚠ <b>量过：<code>circular dichroism</code> 在整套卡上 0 命中</b>，而 CD 正是他的招牌方法。<b>⚠ 他最不能容忍把仪器当黑箱</b> —— 说了一个方法，就要说得出<b>它测的到底是什么物理量</b>。', items:[
{r:'高', q:'How would you show that a protein is folded, and measure how much helix it has?',
    ez:'“I would use circular dichroism. C D measures a difference in absorption. The sample absorbs left and right circularly polarised light differently. Only a chiral structure does that. A folded backbone is chiral. So the signal reports secondary structure. In the far ultraviolet the chromophore is the peptide bond. An alpha helix gives two negative bands. They are at two hundred and eight and at two hundred and twenty two nanometres. A beta sheet gives one negative band near two hundred and eighteen. A random coil gives a strong negative band below two hundred.”',
    ezcn:'<b>用<b>圆二色谱（CD）</b>。</b><b>CD 测的是<b>吸收之差</b>：样品对<b>左旋和右旋圆偏振光</b>的吸收不一样</b>——⚠ <b>只有<b>手性结构</b>才会这样，而折叠好的主链正是手性的，所以这个信号直接报告二级结构。</b><b>在<b>远紫外</b>（190–250 nm），起作用的发色团是<b>肽键</b>：<b>α 螺旋给两个负峰，在 208 和 222 nm</b>；<b>β 折叠给一个负峰，在 218 nm 附近</b>；<b>无规卷曲在 200 nm 以下给一个很强的负峰</b>。</b>',
 en:'“I would use circular dichroism. CD measures a difference in absorption, because the sample absorbs left and right circularly polarised light differently, and only a chiral structure does that. A folded backbone is chiral, so the signal reports secondary structure directly. In the far ultraviolet, between about 190 and 250 nanometres, the chromophore is the peptide bond. An alpha helix gives two negative bands at 208 and 222 nanometres, a beta sheet gives one negative band near 218, and a random coil gives a strong negative band below 200. The near ultraviolet region instead reports the environment of aromatic side chains, so it reports tertiary structure. This is general knowledge and not in the Czech textbook.”',
 cn:'⚠ <b>整条 general</b>：<code>circular dichroism</code> 全书和全套卡 0 命中。<br><br><b>两句话就能把 CD 说清楚</b>：<b>① 它测的是「吸收之差」，不是吸收本身</b>；<b>② 之所以有差，是因为分子是手性的。</b><b>说出这两句，就不是在把仪器当黑箱。</b><br><br><b>他很可能往下追两句</b>：<br>① <b>「远紫外和近紫外有什么区别？」</b> —— <b>远紫外看主链（二级结构）</b>，<b>近紫外（250–320 nm）看芳香侧链和二硫键所处的环境（三级结构）</b>。<br>② <b>「你能用它做什么实验？」</b> —— <b>一边升温一边盯着 222 nm</b>，信号消失的那个温度就是<b>熔解温度</b>，这就测出了热稳定性；<b>跟 DNA 的 Tm 是同一个思路，只是探针换了。</b><br><br><b>接口</b>：α 螺旋和 β 折叠本身在这张卡速背 06；<b>「结构是怎么测出来的」那一组给的是 X 射线／NMR／冷冻电镜，CD 是它的第四个成员</b>。'},
{r:'中', q:'Can you follow unfolding without any label at all?',
    ez:'“Yes. I can use the protein own fluorescence. Tryptophan is the main fluorophore. Its emission depends on its surroundings. A buried tryptophan sits in a nonpolar core. It emits near three hundred and thirty nanometres. When the protein unfolds that tryptophan meets water. The emission then shifts to longer wavelength. It moves towards three hundred and fifty. So the shift itself is the report. Nothing has to be attached to the protein.”',
    ezcn:'<b>能，用<b>蛋白质自己的荧光</b>。</b><b>主要的荧光基团是<b>色氨酸</b>，而<b>它的发射波长取决于它周围是什么环境</b>。</b><b>埋在疏水核心里的色氨酸<b>发射在 330 nm 附近</b>；蛋白一旦解折叠，这个色氨酸就碰到了水，<b>发射峰红移到 350 nm 左右</b>。</b>⚠ <b>所以<b>位移本身就是读数</b>——不需要在蛋白上挂任何标记。</b>',
 en:'“Yes. I can use the protein own fluorescence, because tryptophan is the main fluorophore and its emission depends on its surroundings. A buried tryptophan sits in a nonpolar core and emits near 330 nanometres. When the protein unfolds, that tryptophan meets water and the emission shifts to a longer wavelength, moving towards 350. The shift itself is therefore the read-out, and nothing has to be attached to the protein. This is general knowledge.”',
 cn:'⚠ <b>整条 general</b>。<b>这套卡上 <code>fluorescence</code> 有 46 处，但几乎全是 GFP 和荧光标记</b>——<b>「蛋白自己的荧光」这一层原本没有。</b><br><br>⚠ <b>这一条跟 CD 配成一对，是回答「你怎么知道它折叠好了」最省事的两句</b>：<b>CD 看主链，色氨酸荧光看核心。</b><b>接口</b>：疏水核心在这张卡速背 07；二十个氨基酸里哪些带芳香环在卡 <b>aa</b>。'},
  {r:'高', q:'What is the electromagnetic spectrum, and where do UV and visible light sit on it?',
    ez:'“The electromagnetic spectrum is all electromagnetic radiation ordered by wavelength. Gamma rays are the shortest. Radio waves are the longest. Ultraviolet runs from about one hundred to four hundred nanometres. Visible light runs from about four hundred to seven hundred. So the protein absorption at two hundred eighty nanometres is in the ultraviolet, just below the visible.”',
    ezcn:'<b>电磁波谱 ＝ 全部电磁辐射，按波长排开。</b><b>最短是伽马射线，最长是无线电波。</b><b>紫外大约 100 到 400 纳米，可见光大约 400 到 700 纳米。</b><b>所以蛋白在 280 纳米那个吸收落在紫外区，就在可见光下面一点。</b>',
   en:'“The electromagnetic spectrum is the whole range of electromagnetic radiation ordered by wavelength, from gamma rays at the short end to radio waves at the long end. Ultraviolet runs from roughly 100 to 400 nanometres and visible light from roughly 400 to 700. So the protein absorption at 280 nanometres sits in the ultraviolet, just below the visible.”',
   cn:'<b>两个数字记住就够：紫外 100–400，可见 400–700。</b><b>说完波段马上接「所以 280 在紫外」</b>，直接接到这张卡的 280 nm 那一条。<span class="pg">通用</span>'},
  {r:'高', q:'In fluorescence polarisation, what physical motion makes the anisotropy rise when the ligand binds?',
    ez:'“Rotation. A small labelled molecule tumbles fast in solution. It rotates a lot during the fluorescence lifetime, so the emitted light loses the polarisation of the excitation and the anisotropy is low. Bound to a large complex it tumbles slowly. It barely rotates before it emits, so the emission keeps the original polarisation and the anisotropy goes up. The rotation rate falls as the hydrodynamic volume grows.”',
    ezcn:'<b>转动。</b><b>一个小的标记分子在溶液里转得很快</b>：<b>在荧光寿命那么长的时间里它已经转了很多，所以发射光丢掉了激发光的偏振方向，各向异性很低。</b><b>一旦结合到大复合体上，它转得很慢，发射之前几乎来不及转，偏振就保住了，各向异性升上去。</b><b>体积越大，转得越慢。</b>',
   en:'“Rotation. A small labelled molecule tumbles fast in solution and rotates a lot during the fluorescence lifetime, so the emitted light loses the polarisation of the excitation and the anisotropy is low. Bound to a large complex it tumbles slowly and barely rotates before it emits, so the emission keeps more of the original polarisation and the anisotropy rises. The rotation rate falls as the hydrodynamic volume grows.”',
   cn:'<b>判据一句：转得慢，偏振保得住。</b><b>各向异性读的是「转动多快」，而转动快慢由流体力学体积定。</b>接卡 <b>02</b>（Kd 怎么测）。<span class="pg">通用</span>'},
  {r:'高', q:'High salt or DTT ruins a CD signal below 200 nm. Why, and what do you change?',
    ez:'“Because those components absorb strongly in the far ultraviolet themselves. Chloride is the main culprit, and D T T absorbs too. The light is absorbed before it reaches the detector, so the photomultiplier gets too little signal and the noise explodes. And that region is exactly where the helix and sheet bands are. So I change the buffer to something transparent in the far U V, phosphate for example. I swap the reducing agent for T C E P. And if I need salt, I use sodium fluoride instead of sodium chloride, because it is the chloride that absorbs.”',
    ezcn:'<b>因为这些成分自己在远紫外区就强吸收</b>——<b>主要是氯离子，DTT 也吸。</b><b>光在到达检测器之前已经被吸掉，光电倍增管收不到足够信号，噪声爆掉。</b><b>而那一段恰好就是 α 螺旋和 β 折叠特征峰所在的波段。</b><b>所以改成在远紫外透明的缓冲液（比如磷酸盐），还原剂换 TCEP。</b>⚠ <b>实在需要盐，用氟化钠而不是氯化钠 —— 吸光的是氯离子。</b>',
   en:'“Because those components absorb strongly in the far ultraviolet themselves. Chloride is the main culprit and DTT absorbs as well. The light is absorbed before it reaches the detector, so the photomultiplier receives too little signal and the noise explodes, and that region is exactly where the helix and sheet bands are. So I change the buffer to something transparent in the far UV, phosphate for example, and swap the reducing agent for TCEP. If I need salt I use sodium fluoride rather than sodium chloride, because it is the chloride that absorbs.”',
   cn:'⚠ <b>「用氟化钠代替氯化钠」这一句是这条的加分项</b>，因为它说明你知道<b>吸光的到底是哪个离子</b>，而不是笼统地说「降盐」。<br>TCEP 中文是<b>三(2-级乙基)膦</b>，说英文缩写就行。<span class="pg">通用</span>'},
  {r:'中', q:'What causes the bulk shift right after injection in SPR, and how do you subtract it?',
    ez:'“It is a refractive index mismatch, not binding. The sample buffer and the running buffer are never matched perfectly, in temperature or in trace components. Surface plasmon resonance detects refractive index, so that mismatch alone gives a sharp jump the moment the sample arrives. The standard fix is a reference channel, a surface with no ligand immobilised on it. The sample flows over both channels, and you subtract the reference from the measurement. The bulk shift is common to both, so it cancels.”',
    ezcn:'<b>那是折射率不匹配，不是结合。</b><b>样品缓冲液和流动相永远不可能完全一样（温度、痕量成分）。</b><b>而表面等等子体共振测的就是折射率，所以光是这个差异就能在样品到达那一瞬给出一个尖跳。</b><b>标准做法是设一个参照通道</b>（一个没固定配体的空白表面），<b>样品同时流过两个通道，用实验通道减参照通道 —— 体积效应是两边共有的，相减就没了。</b>',
   en:'“It is a refractive index mismatch rather than binding. The sample buffer and the running buffer are never perfectly matched, in temperature or in trace components, and surface plasmon resonance detects refractive index, so that mismatch alone gives a sharp jump the moment the sample arrives. The standard fix is a reference channel, a surface with no ligand immobilised. The sample flows over both channels and the reference is subtracted from the measurement, so the bulk shift, which is common to both, cancels out.”',
   cn:'<b>一句话的判据：SPR 测的是折射率，所以任何折射率变化它都报。</b>接这张卡和 mb-int 的 SPR 那一格。<span class="pg">通用</span>'},
  {r:'中', q:'A mutation makes ΔH strongly positive but binding is still favourable. What must ΔS do?',
    ez:'“It must become a large positive number. From delta G equals delta H minus T delta S, if delta H is strongly positive and delta G is still negative, then T delta S has to be larger and positive. So the binding is entropy driven. The usual mechanism is the hydrophobic effect. Ordered water molecules held at the interface are released into bulk solution when the two partners bind. The entropy those waters gain outweighs the entropy lost by fixing the two molecules together, and it pays for the unfavourable enthalpy.”',
    ezcn:'<b>ΔS 必须变成一个很大的正值。</b><b>由 ΔG ＝ ΔH − TΔS：ΔH 是大正值而 ΔG 还要为负，那 TΔS 必须更大且为正。</b><b>所以这是熵驱动的结合。</b><b>典型机制是疏水效应</b>：<b>原本被按在界面上的有序水分子，在结合时被释放回本体溶液；它们得到的熵超过两个分子被固定在一起损失的熵，并且付得起那个不利的焰变。</b>',
   en:'“It must become a large positive number. From delta G equals delta H minus T delta S, if delta H is strongly positive and delta G is still negative, then T delta S has to be larger and positive. So the binding is entropy-driven, and the usual mechanism is the hydrophobic effect: ordered water molecules held at the interface are released into bulk solution when the partners bind. The entropy those waters gain outweighs the entropy lost by fixing the two molecules together, and it pays for the unfavourable enthalpy.”',
   cn:'<b>先写式子，再说机制。</b>疏水效应的熵那一层在卡 <b>x-bonds</b> 和 <b>01</b>，这一条是它在<b>结合热力学</b>上的用法。<span class="pg">通用</span>'},
]},
...
{r:'中', q:'On a Ramachandran plot, which residue has the largest allowed region?',
    ez:'“Glycine. The plot maps the two rotatable backbone angles of a residue. Most combinations are forbidden. They are forbidden because atoms would collide. Glycine has only a hydrogen as its side chain. So almost nothing collides. Its allowed region is the largest of the twenty. Proline is the opposite case. Its ring fixes one of the two angles. So its allowed region is the smallest. The plot is general knowledge. My textbook does not print one.”',
    ezcn:'<b>甘氨酸。</b><b>拉氏图画的是一个残基那两个可旋转的主链二面角</b>；绝大多数组合是禁区，<b>因为原子会撞上</b>。<b>甘氨酸的侧链只是一个氢，几乎撞不上任何东西，所以它的允许区是二十个里最大的</b>。<br>⚠ <b>脯氨酸正好相反</b>：环把两个角里的一个<b>锁死</b>了，<b>它的允许区最小</b>。<br>⚠ <b>这张图是通用知识，书里没有印。</b>',
 en:'“Glycine. The plot maps the two rotatable backbone angles of a residue, and most combinations are forbidden because atoms would collide. Glycine has only a hydrogen as its side chain, so almost nothing collides and its allowed region is the largest of the twenty. Proline is the opposite case, because its ring fixes one of the two angles and its allowed region is the smallest. The plot itself is general knowledge and my textbook does not print one.”',
 cn:'⚠ <b>2026-09-24 查出来的缺口</b>：<code class="eq">Ramachandran</code> 在<b>卡上 0 命中，捷克书上也 0 命中</b>（回 OCR 查过）。<b>标 general。</b><br>⚠ <b>但 Lehninger 有</b>（她 2026-09-24 问的）：第 4 章「Common Secondary Structures Have Characteristic Dihedral Angles」一节，<b>Fig. 4-8</b>（a 是立体允许区，b 是真实结构里量到的点）。<br><b>Lehninger 自己那句话值得照搬</b>：“The only amino acid residue often found in a conformation <b>outside</b> these regions is <b>glycine</b>.” —— 注意它的说法是「常出现在常规允许区<b>之外</b>」，跟「允许区最大」是同一件事的两种说法，<b>两句都能说，别说成「甘氨酸不在允许区里」</b>。<br><b>这一条跟前面两条是同一件事的第三种问法</b>：甘氨酸最自由、脯氨酸最受限，<b>原因都是侧链和主链的几何</b>。三条连起来，他从哪个角度问你都接得住。<br><b>顺带的加分</b>：胶原蛋白三股螺旋<b>每三个残基必须有一个甘氨酸</b>，因为只有它塞得进最拥挤的中心——<b>胶原蛋白卡上已经有</b>（卡 01 / 08 / 13 / 17 都提到）。'},
{r:'高', q:'Why is proline the one amino acid an α-helix cannot take?',
    mean:'⚠ <b>2026-09-24：考官很可能不这么问，而是直接用俗名</b> —— “Why is proline called the <b>helix breaker</b>?”。<b>同一道题，答案就是下面这两条机制</b>：没有 N-H 供不出氢键 ＋ 五元环锁死一个主链二面角。<br>听见 breaker 不要愁，一句 “breaker is the common name for it” 带过，直接给机制。<br>⚠ 同样这两条也解释了它为什么常出现在 <b>β-转角</b>里 —— 那里恰恰需要链<b>改方向</b>。<br><b>不单独立一条</b>：她 2026-09-24 指出卡上已经有一模一样的问题，再加就是第三份重复。',
...
{r:'实测', q:'How did anyone know a protein has one definite three-dimensional structure at all?',
 ...
 cn:'<b>「能结晶就说明形状唯一」这个论证是这题的分数所在。</b>它把一个 1864 年的现象变成一个推理，而不是一个年份。<br><br>年表全在 p009 的 table 1.1：1864 Hoppe-Seyler 结晶 haemoglobin · 1902 Fischer 证明多肽本质 · <b>1951 Pauling &amp; Corey 提出 α-helix 与 β-structure</b> · 1953 Sanger 第一个序列 · 1957 Kendrew 第一个结构。方法名在 p008。'},
...
{r:'高', q:'Give me the classic example of cooperativity.',
    ez:'“The classic pair is myoglobin and haemoglobin. Myoglobin is one chain with one haem. Its oxygen binding curve is a hyperbola. Haemoglobin has four chains. They are two alpha and two beta. Its oxygen binding curve is sigmoid. Binding the first oxygen makes the next ones easier. That is positive cooperativity. The reason it matters is physiological. Haemoglobin has to load oxygen in the lung. It also has to unload it in the tissue. A hyperbola cannot do both well. A sigmoid curve can. Generally this is outside the textbook.”',
 ...
 en:'“The classic pair is myoglobin and haemoglobin. Myoglobin is a single chain with one haem, and its oxygen binding curve is a hyperbola. Haemoglobin has four chains, two alpha and two beta, and its oxygen binding curve is sigmoid, because binding the first oxygen makes the next ones easier. That is positive cooperativity. The reason it matters is physiological. Haemoglobin has to load oxygen in the lung and unload it in the tissue, and a hyperbola cannot do both well while a sigmoid curve can. Generally this comparison is outside this textbook, which uses both proteins only as structural examples.”',
...
{r:'中', q:'Where does haem come from in the first place?',
