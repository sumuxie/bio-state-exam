...
{r:'中', q:'On a Ramachandran plot, which residue has the largest allowed region?',
 ...
 cn:'⚠ <b>2026-09-24 查出来的缺口</b>：<code class="eq">Ramachandran</code> 在<b>卡上 0 命中，书上也 0 命中</b>（回 OCR 查过）。<b>标 general。</b><br><b>这一条跟前面两条是同一件事的第三种问法</b>：甘氨酸最自由、脯氨酸最受限，<b>原因都是侧链和主链的几何</b>。三条连起来，他从哪个角度问你都接得住。<br><b>顺带的加分</b>：胶原蛋白三股螺旋<b>每三个残基必须有一个甘氨酸</b>，因为只有它塞得进最拥挤的中心——<b>胶原蛋白卡上已经有</b>（卡 01 / 08 / 13 / 17 都提到）。'},
{r:'高', q:'Why is proline called a helix breaker?',
    ez:'“Breaker is just the common name for what I described. Two things break the helix. Its nitrogen has no N to H bond left. So it cannot donate the hydrogen bond the helix needs. And its five membered ring locks one backbone angle. So the chain cannot take the helical geometry. The same two reasons put proline in turns instead. It is common at a beta turn. There the chain has to change direction.”',
    ezcn:'<b>「破坏者」只是这件事的俗名，机制就是上一条那两点</b>：<b>① 氮上没有 N-H 了，供不出 α-螺旋需要的那个氢键</b>；<b>② 五元环锁死一个主链二面角，链拐不成螺旋的几何</b>。<br>⚠ <b>同样这两条也解释了它为什么常出现在 β-转角里</b>——那里恰恰需要链<b>改方向</b>。<br><b>考官可能用 breaker 这个词问，你要接得上。</b>',
 en:'“Breaker is simply the common name for what I just described. Two things break the helix. Its nitrogen has no N–H left, so it cannot donate the hydrogen bond the helix needs, and its five-membered ring locks one of the backbone angles, so the chain cannot take the helical geometry. Those same two reasons put proline into turns instead, and it is common at a <b>beta turn</b>, where the chain has to change direction.”',
 cn:'⚠ <b>2026-09-24 查出来的缺口</b>：<b>机制卡上早就有</b>（这一组里上一条，aa 卡上还有一条），<b>但「helix breaker」这个词全套卡 0 命中</b>。她贴的考官问法就是 “Why is Proline called the helix breaker?” —— <b>认不出这个词就接不上话</b>，所以单独立一条换个问法。<br><b>说的时候不要把上一条重讲一遍</b>：一句 “breaker is the common name for it” 带过，然后直接给那两个机制。'},
