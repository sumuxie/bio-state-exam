...
## 20. START-file history — everything cut from LEHNINGER_START.md on 2026-08-08

`LEHNINGER_START.md` had grown to 553 lines and sessions were dying part-way through
reading it, so it was cut to ~150. **Nothing was deleted — it is all below.** This is the
second time that file has been shortened; the first time, three silent-failure traps were
cut and existed nowhere else, and had to be recovered from git. Hence this section.

What follows is the full text of the removed sections, verbatim.
