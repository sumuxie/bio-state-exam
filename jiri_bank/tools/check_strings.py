# -*- coding: utf-8 -*-
"""Stand-in for a JS parser: verify every string literal closes.

Tracks BOTH quote styles. It was single-quote-only until data/ch6.js, which is
generated and emits JSON double-quoted strings; every apostrophe inside those
read as an unclosed single-quoted string and the checker reported a 1.4 MB file
as broken when it was fine. A checker that cries wolf stops being read.
