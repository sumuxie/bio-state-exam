...
**Corpus.** The layers run over **262** nodes (207 Czech + 52 lehninger + 3 entity), grouped
under **78** distinct `topicKey` values. Exactly 25 keys join both books — that join is what
