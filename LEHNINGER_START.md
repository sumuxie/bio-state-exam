...
**Corpus.** The layers run over **246** nodes (207 Czech + 36 lehninger + 3 entity), grouped
under **72** distinct `topicKey` values. Exactly 20 keys join both books — that join is what
