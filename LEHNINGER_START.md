...
**Corpus.** The layers run over **236** nodes (207 Czech + 26 lehninger + 3 entity), grouped
under **69** distinct `topicKey` values. Exactly 18 keys join both books — that join is what
