...
**Corpus.** The layers run over **257** nodes (207 Czech + 47 lehninger + 3 entity), grouped
under **78** distinct `topicKey` values. Exactly 21 keys join both books — that join is what
