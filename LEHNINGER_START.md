...
**Corpus.** The layers run over **237** nodes (207 Czech + 27 lehninger + 3 entity), grouped
under **70** distinct `topicKey` values. Exactly 18 keys join both books — that join is what
