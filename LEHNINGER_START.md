...
**Corpus.** The layers run over **258** nodes (207 Czech + 48 lehninger + 3 entity), grouped
under **78** distinct `topicKey` values. Exactly 22 keys join both books — that join is what
