...
**Corpus.** The layers run over **263** nodes (207 Czech + 53 lehninger + 3 entity), grouped
under **78** distinct `topicKey` values. Exactly 26 keys join both books — that join is what
