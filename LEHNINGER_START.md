...
**Corpus.** The layers run over **238** nodes (207 Czech + 28 lehninger + 3 entity), grouped
under **70** distinct `topicKey` values. Exactly 19 keys join both books — that join is what
