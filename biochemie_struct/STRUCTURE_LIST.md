...
**糖 sugars：36 个，已画 5，未画 31；其中两层都 0 命中的有 2 个。**
...
**核苷酸与碱基 nucleotides and bases：26 个，已画 0，未画 26；其中两层都 0 命中的有 1 个。**
...
**辅酶与维生素 coenzymes and vitamins：21 个，已画 0，未画 21；其中两层都 0 命中的有 0 个。**
...
**脂类 lipids：36 个，已画 0，未画 36；其中两层都 0 命中的有 0 个。**
...
**代谢中间物 metabolic intermediates：51 个，已画 0，未画 51；其中两层都 0 命中的有 0 个。**
...
**卟啉与色素 porphyrins and pigments：6 个，已画 0，未画 6；其中两层都 0 命中的有 0 个。**
...
**氨基酸衍生物 amino-acid-derived molecules：9 个，已画 0，未画 9；其中两层都 0 命中的有 0 个。**
...
| 糖 sugars | 36 | 5 | 31 | 2 |
| 核苷酸与碱基 nucleotides and bases | 26 | 0 | 26 | 1 |
| 辅酶与维生素 coenzymes and vitamins | 21 | 0 | 21 | 0 |
| 脂类 lipids | 36 | 0 | 36 | 0 |
| 代谢中间物 metabolic intermediates | 51 | 0 | 51 | 0 |
| 卟啉与色素 porphyrins and pigments | 6 | 0 | 6 | 0 |
| 氨基酸衍生物 amino-acid-derived molecules | 9 | 0 | 9 | 0 |
| **合计** | **205** | **25** | **180** | **3** |

**所以现在的进度是 25 / 205 = 12%**——但请注意这个分母是**提案**。
把 3 个两层都 0 命中的删掉，分母就变成 202，进度变成 12%。
**在你过一遍之前，这两个数都不要往外说。**

⚠️ **旧 CORE3 里那张「粗估 180–220」的表是推出来的，不是数出来的。** 本清单是逐条列出来
并逐条 grep 过的，合计 205——**与那个量级一致，但这一份可以核对，那一份不能**。
...
|---|---|---|---|---|---|---|
| 1 | `atp` ⚠️ | ATP | adenosine 5'-triphosphate | 1515 | 1176 | 核苷酸与碱基 nucleotides and bases |
| 2 | `coa` ⚠️ | 辅酶 A | coenzyme A (CoA-SH) | 1410 | 315 | 辅酶与维生素 coenzymes and vitamins |
| 3 | `nad` ⚠️ | NAD⁺ | nicotinamide adenine dinucleotide (NAD+) | 1321 | 352 | 辅酶与维生素 coenzymes and vitamins |
| 4 | `nadp` | NADP⁺ | NADP+ | 550 | 115 | 辅酶与维生素 coenzymes and vitamins |
| 5 | `acetyl-coa` ⚠️ | 乙酰辅酶 A | acetyl-CoA | 496 | 120 | 辅酶与维生素 coenzymes and vitamins |
| 6 | `pyruvate` | 丙酮酸 | pyruvate | 447 | 49 | 代谢中间物 metabolic intermediates |
| 7 | `nadh-ring` | NADH（还原的烟酰胺环） | NADH, the reduced nicotinamide ring | 427 | 157 | 辅酶与维生素 coenzymes and vitamins |
| 8 | `citrate` | 柠檬酸 | citrate | 334 | 91 | 代谢中间物 metabolic intermediates |
| 9 | `adp` | ADP | adenosine 5'-diphosphate | 313 | 129 | 核苷酸与碱基 nucleotides and bases |
| 10 | `amp` | AMP | adenosine 5'-monophosphate | 305 | 60 | 核苷酸与碱基 nucleotides and bases |
| 11 | `fad` ⚠️ | FAD | flavin adenine dinucleotide (FAD) | 232 | 63 | 辅酶与维生素 coenzymes and vitamins |
| 12 | `glycogen-branch` ⚠️ | 糖原分支点 | glycogen branch point | 223 | 72 | 糖 sugars |
| 13 | `d-galactose-open` | D-半乳糖（开链） | D-galactose, open chain | 220 | 13 | 糖 sugars |
| 14 | `chlorophyll-a` | 叶绿素 a | chlorophyll a | 213 | 1 | 卟啉与色素 porphyrins and pigments |
| 15 | `glycerol` ⚠️ | 甘油 | glycerol | 211 | 33 | 脂类 lipids |
| 16 | `oxaloacetate` | 草酰乙酸 | oxaloacetate | 205 | 49 | 代谢中间物 metabolic intermediates |
| 17 | `d-fructose-open` | D-果糖（开链） | D-fructose, open chain | 199 | 17 | 糖 sugars |
| 18 | `gtp` | GTP | guanosine 5'-triphosphate | 186 | 27 | 核苷酸与碱基 nucleotides and bases |
| 19 | `d-glyceraldehyd` ⚠️ | D-甘油醛 | D-glyceraldehyde | 181 | 2 | 糖 sugars |
| 20 | `malate` | 苹果酸 | malate | 135 | 31 | 代谢中间物 metabolic intermediates |
| 21 | `d-ribose-open` ⚠️ | D-核糖（开链） | D-ribose, open chain | 132 | 23 | 糖 sugars |
| 22 | `fumarate` | 延胡索酸（富马酸） | fumarate | 123 | 11 | 代谢中间物 metabolic intermediates |
| 23 | `cholesterol` | 胆固醇 | cholesterol | 119 | 29 | 脂类 lipids |
| 24 | `palmitate` | 软脂酸（棕榈酸） | palmitic acid (16:0) | 115 | 35 | 脂类 lipids |
| 25 | `succinyl-coa` | 琥珀酰辅酶 A | succinyl-CoA | 115 | 17 | 代谢中间物 metabolic intermediates |
| 26 | `hmg-coa` | HMG-CoA | beta-hydroxy-beta-methylglutaryl-CoA | 112 | 4 | 代谢中间物 metabolic intermediates |
| 27 | `lactate` | 乳酸 | lactate | 108 | 19 | 代谢中间物 metabolic intermediates |
| 28 | `tpp` | 焦磷酸硫胺素 | thiamine pyrophosphate (TPP) | 107 | 19 | 辅酶与维生素 coenzymes and vitamins |
| 29 | `d-ribulose` | D-核酮糖 | D-ribulose | 106 | 0 | 糖 sugars |
| 30 | `urea` | 尿素 | urea | 103 | 15 | 代谢中间物 metabolic intermediates |
| 31 | `fadh2-ring` | FADH₂（还原的异咯嗪环） | FADH2, the reduced isoalloxazine ring | 102 | 23 | 辅酶与维生素 coenzymes and vitamins |
| 32 | `malonyl-coa` | 丙二酸单酰辅酶 A | malonyl-CoA | 99 | 26 | 代谢中间物 metabolic intermediates |
| 33 | `cellulose-unit` | 纤维素重复单元 | cellulose repeat unit (beta-1,4) | 99 | 1 | 糖 sugars |
| 34 | `succinate` | 琥珀酸 | succinate | 97 | 45 | 代谢中间物 metabolic intermediates |
| 35 | `d-mannose-open` | D-甘露糖（开链） | D-mannose, open chain | 94 | 1 | 糖 sugars |
| 36 | `isocitrate` | 异柠檬酸 | isocitrate | 87 | 17 | 代谢中间物 metabolic intermediates |
| 37 | `pep` | 磷酸烯醇丙酮酸 | phosphoenolpyruvate (PEP) | 86 | 10 | 代谢中间物 metabolic intermediates |
| 38 | `d-xylulose` | D-木酮糖 | D-xylulose | 86 | 0 | 糖 sugars |
| 39 | `ceramide` | 神经酰胺 | ceramide | 86 | 0 | 脂类 lipids |
| 40 | `isoprene` | 异戊二烯 | isoprene unit | 85 | 0 | 脂类 lipids |
