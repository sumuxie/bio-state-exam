...

{
  ...
  lehNotes: [
    { kind: "conflict", node: "L-16-2-1",
      ...
      cn: "æ¬èç¹ç ATP æ»è´¦å¹¶ä¸æ¯ç°ä»£æç§ä¹¦ç»çé£ä¸ªï¼èè¿ä¸ªå·®å«å¼å¾å¨èå®è¦æ±ä½ ä¸ºè¿ä¸ªæ°å­è¾©æ¤ä¹åå¼æ¸æ¥ãæ¬èç¹ç¨çæ¯æ¯ä¸ª NADH çº¦ 3 ä¸ª ATPãæ¯ä¸ª FADH2 çº¦ 2 ä¸ªï¼äºæ¯æ¯ä¸ªä¹é°-CoA 12 ä¸ªãæ¯åå­è¡èç³ 38 ä¸ªï¼æåä¸º 8 + 6 + 24ï¼ãLehninger 16.2ï¼TABLE 16-1ï¼A p.589ï¼ç¨çæ¯å®æµçéæ´æ°å¼ï¼æ¯ä¸ª NADH çº¦ 2.5 ä¸ªãæ¯ä¸ª FADH2 çº¦ 1.5 ä¸ªï¼å¹¶æ¥åâæ¯åå­è¡èç³æå¤å¯å¾ 32 ä¸ª ATPâââå®éä¸º 30 å° 32 çèå´ï¼å ä¸ºç³é¦è§£äº§ççèè´¨ NADH ä¾å¶çµå­ç±åªç§ç©¿æ¢­æºå¶éå¥åºè´¨ï¼äº§åº 3 ä¸ªæ 5 ä¸ª ATPãæçæ°å­ä¹éä¹åå¨ï¼ææ åèªç±è½è®¡ç®æ¯çè®ºæå¤§å¼ç 34%ï¼æç»èååæ ATP çå®éä»£ä»·æ ¡æ­£åæ¥è¿ 65%ï¼èæ¬èç¹å¼ç¨ççº¦ä¸º 40%ãçç©åå­¦æ¯ä¸æ ·çï¼ä¸åçåªæ¯ P/O åå­¦è®¡éçæ¯ä¾ãå¨æ¬è¯¾ç¨éå°±ç­ 38ï¼ä½è¦è½è¯´åºçç±ã" }
  ],
