...

{
  ...
  cnNote: { topic: null, title: "激素 Hormones (笔记 p.183, unnumbered appendix topic — strong title match per the HANDOFF §11 map, not yet read)", status: "partial" },
  mustKnow: { en: "The same adrenal gland makes two chemically unrelated stress hormones from two different tissues: cortisol, a steroid from the cortex, for sustained stress, and adrenaline, an amino-acid derivative from the medulla, for short-term stress — same organ, same broad job, completely different chemistry and completely different tissue of origin. Even the table's blank cell is informative: serotonin has no single organ listed, because unlike a classical hormone it is not the product of one dedicated gland.", cn: "同一个肾上腺，用两种化学上毫不相关的激素来应对压力，而且来自两种不同的组织：皮质部分产的类固醇——皮质醇，负责持续性压力；髓质部分产的氨基酸衍生物——肾上腺素，专门负责短期压力。同一个器官，大致同一个任务，化学结构和来源组织却完全不同。就连表格里的空格都有信息量：血清素那一栏『器官』是空的，因为和经典激素不同，它不是某一个专门腺体的产物。" },
  summary: {
