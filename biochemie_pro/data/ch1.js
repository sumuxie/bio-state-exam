...

{
  ...
  points: [
    { cz: "rodiče oboru", en: "Its two 'parents' are organic chemistry (originally the chemistry of natural substances) on the chemical side, and physiology on the biological side — hence the early name 'physiological chemistry'.", cn: "本学科的两个「родители/父母」：化学一侧是有机化学（最初等同于天然产物化学），生物学一侧是生理学——因此早期也称「生理化学」。" },
