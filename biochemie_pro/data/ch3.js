  ...
  trace: [
    {
      ...
      family: "拿金属离子当搭档的酶另有名字，叫 metalloenzyme（金属酶），教材给的例子是 Zn²⁺（alcohol dehydrogenase）、Mg²⁺（phosphatase）。金属在酶里只有三种当法：它本身就是活性中心的一部分；当一座桥，把底物架到酶上；或者**稳定酶分子的空间结构**。被问到「金属在这儿起什么作用」，从这三个里挑。"
    }
  ],
  summary: {
