...

{
  ...
  mustKnow: { en: "A vitamin is a small molecule your cells cannot make but desperately need — that is the only thing defining a vitamin. Vitamin E and Q are lipophilic antioxidants living inside membranes. Vitamin A is light-activated: a photon hitting the retinoid ring sends electrons down a wire toward an opsin.", cn: "维生素是细胞无法制造但迫切需要的小分子——这是界定维生素的唯一标准。维生素E和Q是膜内脂溶性抗氧化剂。维生素A被光激活：光子击中视酯基环会向视蛋白发送电子。" },
  mustKnow: { en: "A vitamin is a small molecule your cells cannot make but desperately need — that is the only thing defining a vitamin. Vitamin E and Q are lipophilic antioxidants living inside membranes. Vitamin A is light-activated: a photon hitting the retinoid ring sends electrons down a wire toward an opsin.", cn: "维生素是细胞无法制造但迫切需要的小分子——这是界定维生素的唯一标准。维生素E和Q是膜内脂溶性抗氧化剂。维生素A被光激活：光子击中视酯基环会向视蛋白发送电子。" },
  points: [
