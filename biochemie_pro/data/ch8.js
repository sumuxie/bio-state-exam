...

{
  ...
  mustKnow: { en: "Lipids cannot be defined by structure — the 400+ different lipids span too many unrelated chemical types — so the one property that flags all of them as lipid is pure solubility: insoluble in water but soluble in organic solvents.", cn: "脂质无法按结构来定义。唯一判断某物是否为脂质的标志是纯物理性质：在水中不溶、在有机溶剂中可溶。" },
  mustKnow: { en: "Lipids cannot be defined by structure — the 400+ different lipids span too many unrelated chemical types — so the one property that flags all of them as lipid is pure solubility: insoluble in water but soluble in organic solvents.", cn: "脂质无法按结构来定义。唯一判断某物是否为脂质的标志是纯物理性质：在水中不溶、在有机溶剂中可溶。" },
  points: [
...

{
  ...
  mustKnow: { en: "Triacylglycerols are the reason animals can afford to be warm. A gram of fat stores more than twice the energy of a gram of carbohydrate.", cn: "三酯是动物能够保持温暖的原因。一克脂肪储存的能量是一克糖类的两倍多。" },
  mustKnow: { en: "Triacylglycerols are the reason animals can afford to be warm. A gram of fat stores more than twice the energy of a gram of carbohydrate.", cn: "三酯是动物能够保持温暖的原因。一克脂肪储存的能量是一克糖类的两倍多。" },
  points: [
...

{
  ...
  mustKnow: { en: "Phospholipids do two incompatible jobs at once: one end hides in water, the other in oil. That incompatibility forces them into a double layer, the only structure that buries both incompatible ends inside.", cn: "磷脂同时做两件互不相容的工作：一端躲在水中，另一端躲在油中。这种互不相容性迫使磷脂形成双分子层。" },
  mustKnow: { en: "Phospholipids do two incompatible jobs at once: one end hides in water, the other in oil. That incompatibility forces them into a double layer, the only structure that buries both incompatible ends inside.", cn: "磷脂同时做两件互不相容的工作：一端躲在水中，另一端躲在油中。这种互不相容性迫使磷脂形成双分子层。" },
  points: [
...

{
  ...
  mustKnow: { en: "Phosphatidylcholine and phosphatidylethanolamine are not just membrane scaffolding — they are also signaling molecules. A cell can strip a fatty acid or phosphate from them and trigger a cascade.", cn: "磷脂酰胆碱和磷脂酰乙醇胺不仅仅是膜的支架——它们还是信号分子。细胞可以从它们身上剥离脂肪酸或磷酸基团。" },
  mustKnow: { en: "Phosphatidylcholine and phosphatidylethanolamine are not just membrane scaffolding — they are also signaling molecules. A cell can strip a fatty acid or phosphate from them and trigger a cascade.", cn: "磷脂酰胆碱和磷脂酰乙醇胺不仅仅是膜的支架——它们还是信号分子。细胞可以从它们身上剥离脂肪酸或磷酸基团。" },
  points: [
...

{
  ...
  mustKnow: { en: "Sphingomyelins and cerebrosides build brain membranes where pure phospholipids will not do. The sphingosine backbone is more rigid than glycerol, so these lipids pack differently and stiffer.", cn: "鞘磷脂和脑苷脂在纯磷脂不足的地方构成脑膜。鞘氨醇骨架比甘油更坚硬，所以这些脂质堆积得更紧密、更硬。" },
  mustKnow: { en: "Sphingomyelins and cerebrosides build brain membranes where pure phospholipids will not do. The sphingosine backbone is more rigid than glycerol, so these lipids pack differently and stiffer.", cn: "鞘磷脂和脑苷脂在纯磷脂不足的地方构成脑膜。鞘氨醇骨架比甘油更坚硬，所以这些脂质堆积得更紧密、更硬。" },
  points: [
...

{
  ...
  mustKnow: { en: "Steroids are the opposite of fatty acids — rigid four-ring cages instead of long floppy chains. That rigidity is the whole point. The shape is the function.", cn: "类固醇是脂肪酸的对立面——坚硬的四环笼而非长长的柔软链。形状就是功能。" },
  mustKnow: { en: "Steroids are the opposite of fatty acids — rigid four-ring cages instead of long floppy chains. That rigidity is the whole point. The shape is the function.", cn: "类固醇是脂肪酸的对立面——坚硬的四环笼而非长长的柔软链。形状就是功能。" },
  points: [
...

{
  ...
  mustKnow: { en: "Cholesterol has two jobs that look opposite: it both hardens and loosens membranes depending on temperature. Cholesterol balances the membrane, which is why all cells need it.", cn: "胆固醇有两个看似相反的功能：它既硬化又松动膜，取决于温度。胆固醇平衡膜。" },
  mustKnow: { en: "Cholesterol has two jobs that look opposite: it both hardens and loosens membranes depending on temperature. Cholesterol balances the membrane, which is why all cells need it.", cn: "胆固醇有两个看似相反的功能：它既硬化又松动膜，取决于温度。胆固醇平衡膜。" },
  points: [
...

{
  ...
  mustKnow: { en: "Bile acids solve a chemical dilemma: fats do not dissolve in water. Bile acids are amphipathic, so they can surround fat droplets and hold them in an emulsion.", cn: "胆汁酸解决了一个化学难题：脂肪在水中不溶。胆汁酸具有两亲性。" },
  mustKnow: { en: "Bile acids solve a chemical dilemma: fats do not dissolve in water. Bile acids are amphipathic, so they can surround fat droplets and hold them in an emulsion.", cn: "胆汁酸解决了一个化学难题：脂肪在水中不溶。胆汁酸具有两亲性。" },
  points: [
...

{
  ...
  cnNote: { topic: "三", title: "脂质 (笔记 pp.11-16, read at topic-overview level — not yet cross-checked point-by-point against this CZ subsection)", status: "mapped" },
  mustKnow: { en: "Fatty acid synthesis across three compartments explains why certain lipid disorders affect specific organelles and why drugs take weeks to work.", cn: "脂肪酸合成分布三个区室，解释脂质紊乱症如何影响特定细胞器，药物为何需数周才见效。" },
  lehNotes: [
...

{
  ...
  cnNote: { topic: "三", title: "脂质 (笔记 pp.11-16, read at topic-overview level — not yet cross-checked point-by-point against this CZ subsection)", status: "mapped" },
  mustKnow: { en: "Step IV dehydration creates a double bond. An intermediate that looks like failure is actually the bridge to the next step.", cn: "第IV步脱水产生双键。看似失败的中间体实际是通往下步的桥梁。" },
  lehNotes: [
    { kind: "conflict", node: "L-21-1-1",
...

{
  ...
  cnNote: { topic: "三", title: "脂质 (笔记 pp.11-16, read at topic-overview level — not yet cross-checked point-by-point against this CZ subsection)", status: "mapped" },
  mustKnow: { en: "Step V reduces the double bond. Two reductions per cycle, two NADPH per two-carbon addition.", cn: "第V步还原双键。每周期两次还原，每二碳加入两个NADPH。" },
  summary: {
...

{
  ...
  cnNote: { topic: "三", title: "脂质 (笔记 pp.11-16, read at topic-overview level — not yet cross-checked point-by-point against this CZ subsection)", status: "mapped" },
  mustKnow: { en: "Basic pathway builds to 16 carbons in cytoplasm. Longer chains require mitochondrial/ER machinery. Compartmentalization is a regulatory gate.", cn: "基本途径在细胞质构建到16碳。更长需要线粒体/ER机制。区室化是调节门关。" },
  summary: {
...

{
  ...
  mustKnow: { en: "Free fatty acids must be activated to CoA thioesters before use. Activation is checkpoint: cell only activates what is needed now.", cn: "游离脂肪酸必须激活为CoA硫酯才能使用。激活是检查点：细胞只激活现在需要的。" },
  summary: {
...

{
  ...
  mustKnow: { en: "Complex lipids degraded in cytoplasm, not mitochondria. Compartmental separation from beta-oxidation allows independent control.", cn: "复合脂质在细胞质降解，非线粒体。与β-氧化区室分离允许独立控制。" },
  summary: {
...

{
  ...
  mustKnow: { en: "Free fatty acids transported to mitochondria via carnitine shuttle after activation. This second checkpoint: cell decides what gets oxidized.", cn: "游离脂肪酸激活后经肉碱穿梭运输到线粒体。第二检查点：细胞决定什么被氧化。" },
  lehNotes: [
...

{
  ...
  mustKnow: { en: "Odd-chain fatty acids produce propionyl-CoA feeding into gluconeogenesis. Even-chain only feed citric acid cycle.", cn: "奇链脂肪酸产生丙二酰-CoA进入糖异生。偶链只进入柠檬酸循环。" },
  lehNotes: [
...

{
  ...
  mustKnow: { en: "Ketone bodies form when acetyl-CoA exceeds citric acid cycle capacity. Ketones are glucose alternative when glucose scarce, not disease sign.", cn: "乙酰-CoA超过柠檬酸循环容量时酮体形成。酮体是葡萄糖替代，非病症标志。" },
  summary: {
...

{
  ...
  mustKnow: { en: "Cholesterol degraded to bile acids in liver, stored in gallbladder. Recycled 6-8 times daily via reabsorption. Regulated at synthesis not excretion.", cn: "胆固醇在肝脏降解为胆汁酸，储存在胆囊。每日回收6-8次。于合成处调节而非排泄。" },
  summary: {
...

{
  ...
  mustKnow: { en: "Bile acids have rigid steroid core making perfect detergents. Their rigidity perfect for emulsification in intestine where soft chains break.", cn: "胆汁酸有坚硬类固醇核心成完美洗涤剂。刚硬性在肠道完美乳化处柔软链断裂。" },
  summary: {
...

{
  ...
  mustKnow: { en: "Phospholipid synthesis uses CDP-intermediates with branching routes. Each branch point is decision where cell controls which lipids to make.", cn: "磷脂合成用CDP中间体有分支路线。每分支是细胞控制制造哪些脂质的决策点。" },
  summary: {
...

{
  ...
  mustKnow: { en: "Sphingolipid synthesis from ceramide adding different head groups. Same backbone, different heads, different functions.", cn: "鞘脂合成从神经酰胺添加不同头基团。同一骨架，不同头，不同功能。" },
  summary: {
...

{
  ...
  mustKnow: { en: "Membrane lipid asymmetry maintained by ATP-dependent flippases. Asymmetry is information: cell reads its own lipids, knows which face outside.", cn: "膜脂质不对称由ATP依赖翻转酶维持。不对称是信息：细胞读自己脂质，知道哪面在外。" },
  summary: {
...

{
  ...
  mustKnow: { en: "Liver makes 80 percent of body cholesterol. High diet drops synthesis via feedback. Statins block the 80 percent, body cannot substitute with diet.", cn: "肝脏制造80%体胆固醇。高饮食经反馈降低合成。他汀阻断80%，身体无法用饮食替代。" },
  summary: {
...

{
  ...
  mustKnow: { en: "HDL and LDL are lipoproteins not lipids. Apoprotein is address label. LDL carries cholesterol to cells, HDL back to liver.", cn: "HDL和LDL是脂蛋白非脂质。载脂蛋白是地址标签。LDL携带到细胞，HDL返回肝脏。" },
  summary: {
...

{
  ...
  mustKnow: { en: "Lipoproteins remodeled in circulation: apoprotein C moves, cholesteryl esters shuffled. Particles constantly traded like market not factory.", cn: "脂蛋白在循环重建：载脂蛋白C移动，胆固醇酯转移。颗粒如市场非工厂不断交易。" },
  summary: {
